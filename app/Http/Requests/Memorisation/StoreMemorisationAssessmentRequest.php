...
class StoreMemorisationAssessmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'recognition_words.*.raw_word' => ['sometimes', 'nullable', 'string', 'max:120'],
            'recognition_words.*.rawWord' => ['sometimes', 'nullable', 'string', 'max:120'],
            'recognition_words.*.display' => ['sometimes', 'nullable', 'string', 'max:120'],
            'recognition_words.*.confidence' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1'],
            'recognition_words.*.token' => ['sometimes', 'nullable', 'string', 'max:160'],
            'recognition_words.*.speechmatics_token' => ['sometimes', 'nullable', 'string', 'max:160'],
            'recognition_words.*.speechmaticsToken' => ['sometimes', 'nullable', 'string', 'max:160'],
            'recognition_words.*.provider' => ['sometimes', 'nullable', 'string', 'max:40'],
            'recognition_words.*.segment_id' => ['sometimes', 'nullable', 'string', 'max:160'],
            ...
            'audio_quality_metrics.rms' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1'],
            'audio_quality_metrics.peak' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1'],
            'audio_quality_metrics.clipping_ratio' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1'],
            'audio_quality_metrics.speech_ratio' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1'],
            'audio_quality_metrics.snr_db' => ['sometimes', 'nullable', 'numeric', 'min:-100', 'max:100'],
            'audio_quality_metrics.complete' => ['sometimes', 'nullable', 'boolean'],
            'audio_quality_metrics.broken' => ['sometimes', 'nullable', 'boolean'],
            'alignment_lifecycle' => ['sometimes', 'nullable', 'string', 'max:32'],
