...
class NextSessionRecommendationService
{
    ...
    private function defaultReasonText(
        ...
        return match ($code) {
            ...
            RecommendationReasonCode::AudioDependency => 'You relied on replay often. This plan leans on quieter recall with lighter audio support.',
            RecommendationReasonCode::SpokenHesitation => 'Your spoken recall hesitated. This plan uses short phrases, slower playback, and AI Recite.',
