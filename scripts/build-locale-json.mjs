...
set('memorisation.meta.completedTitle', 'This Set is complete.', 'Cette plage est terminée.', 'اكتمل هذا النطاق.')
set('memorisation.meta.forwardTitle', 'You made Progress on this Set.', 'Cette plage a avancé.', 'تقدم هذا النطاق.')
set('memorisation.meta.studiedTitle', 'This is how you studied.', 'Voici comment vous avez étudié.', 'هكذا درست.')
set('memorisation.meta.advanceTitle', 'Advance Progress, or reinforce this Set.', 'Avancer ou renforcer.', 'تقدم أو عزّز.')
set('memorisation.meta.continueTitle', 'Continue this Set, or begin again.', 'Continuer ou recommencer.', 'تابع أو ابدأ من جديد.')
set('memorisation.summary.default', 'You can start a new Set, save this one, or repeat it now.', 'Vous pouvez démarrer une nouvelle plage, enregistrer ou répéter.', 'يمكنك بدء نطاق جديد أو حفظ هذا أو تكراره الآن.')
