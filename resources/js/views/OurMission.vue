...
.mission-page::before {
  ...
  animation: missionFloat 10s ease-in-out infinite;
}
...
.mission-page::after {
  ...
  width: 260px;
  height: 260px;
  background: radial-gradient(circle, color-mix(in srgb, var(--accent-strong) 10%, transparent), transparent 68%);
...
.mission-step,
.mission-band {
  animation: missionReveal 0.7s ease both;
}
