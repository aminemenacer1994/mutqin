    ...
    <div class="auth-panel">
        ...
        <form method="POST" action="{{ route('password.update') }}" class="auth-form">
            ...
            <div class="auth-field">
                ...
                @error('email')
                    <span id="newPasswordEmailError" class="invalid-feedback" role="alert">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="auth-field">
                ...
                <div class="auth-password-wrap">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" @if($errors->has('password')) aria-invalid="true" aria-describedby="newPasswordError" @endif>
                    <button type="button" class="auth-password-toggle" data-password-toggle="password" aria-label="{{ __('ui.show_password') }}">
                        <i class="bi bi-eye" aria-hidden="true"></i>
                    </button>
                </div>
                @error('password')
                    <span id="newPasswordError" class="invalid-feedback" role="alert">{{ $message }}</span>
                @enderror
            </div>
