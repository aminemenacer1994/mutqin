...
<head>
    ...
    <meta name="description" content="Mutqin - AI-powered Quran memorization using chaining, anchor, blur & focus modes. Track sessions, goals, and get AI feedback on memorization & recitation.">
    <title>Mutqin · AI Quran Memorization • Anchor • Chaining • Smart Revision</title>
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext x='50' y='80' font-size='80' text-anchor='middle' fill='%23c6904b'%3Eم%3C/text%3E%3C/svg%3E">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,300;400;500;600;700;800&family=Amiri:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet">
...
<body>
    ...
    <nav class="app-navbar">
        <div class="navbar-shell">
            ...
            <!-- Horizontal row nav (desktop) -->
            <div class="nav-links-desktop">
                <a class="nav-link" href="#features">Features</a>
                <a class="nav-link" href="#techniques">Memorization Techniques</a>
            ...
            <div class="app-navbar-actions">
                ...
                <a href="#" class="btn-primary"><i class="bi bi-person-plus"></i> Sign Up</a>
            </div>
        </div>
    </nav>
    ...
    <main class="shell">
        ...
        <div style="background: var(--surface-card); border-radius: var(--radius-lg); padding: 2rem; margin: 1rem 0; text-align: center; border: 1px solid var(--border);">
            <div class="mode-switch">
                <button class="mode-btn active">📚 Stacked Mode (line-by-line)</button>
                <button class="mode-btn">🕋 Mushaf Mode (full page)</button>
            </div>
    ...
    <script>
        // Mode switcher visual toggle
        document.querySelectorAll('.mode-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                document.querySelectorAll('.mode-btn').forEach(b => b.classList.remove('active'));
                this.classList.add('active');
                // Here you would trigger actual mode change in a real app
            });
        });
        ...
        // Simple theme toggle (light/dark) - optional enhancement
