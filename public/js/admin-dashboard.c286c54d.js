...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
          ...
          tooltip: {
            ...
            callbacks: {
              title: function title(items) {
                ...
                return _this3.tooltipDate(point.date);
              },
  ...
  methods: {
    ...
    drawerItemTitle: function drawerItemTitle(item) {
      if (this.drawerMode === 'users') return item.name || item.email;
    ...
    drawerItemMeta: function drawerItemMeta(item) {
      if (this.drawerMode === 'users') {
        var _item$memorised_ayahs, _item$sessions_comple;
        return [item.email, "".concat(this.t('admin.col_memorised'), ": ").concat((_item$memorised_ayahs = item.memorised_ayahs) !== null && _item$memorised_ayahs !== void 0 ? _item$memorised_ayahs : 0), "".concat(this.t('admin.col_sessions'), ": ").concat((_item$sessions_comple = item.sessions_completed) !== null && _item$sessions_comple !== void 0 ? _item$sessions_comple : 0), item.current_surah_name, this.subscriptionLabel(item.subscription_status)].filter(Boolean).join(' · ');
      }
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              return _context.a(2);
            case 1:
              _this6.drawerMode = 'user';
              _this6.userDetail = null;
              _this6.userDetailError = false;
              _this6.userDetailLoading = true;
              requestId = ++_this6.userDetailRequestId;
              _context.p = 2;
              _context.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUser(id);
            case 3:
              detail = _context.v;
              if (!(requestId !== _this6.userDetailRequestId)) {
                _context.n = 4;
                break;
              }
              return _context.a(2);
            case 4:
              _this6.userDetail = detail;
              _context.n = 7;
              break;
            case 5:
              _context.p = 5;
              _t = _context.v;
              console.error('Admin user detail failed', _t);
              if (!(requestId !== _this6.userDetailRequestId)) {
                _context.n = 6;
                break;
              }
              return _context.a(2);
            case 6:
              _this6.userDetailError = true;
            case 7:
              _context.p = 7;
              if (requestId === _this6.userDetailRequestId) _this6.userDetailLoading = false;
              return _context.f(7);
            case 8:
              return _context.a(2);
          }
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 12:
              _context2.p = 12;
              _t2 = _context2.v;
              console.error('Admin drawer fetch failed', _t2);
              if (!(requestId !== _this7.drawerRequestId)) {
                _context2.n = 13;
                break;
              }
    ...
    onUserSearch: function onUserSearch() {
      var _this8 = this;
      if (this.userSearchTimer) clearTimeout(this.userSearchTimer);
      this.userSearchTimer = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var requestId, items, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              if (!(_this8.drawerMode !== 'users')) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              requestId = ++_this8.drawerRequestId;
              _this8.drawerLoading = true;
              _context3.p = 2;
              _context3.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                q: _this8.userSearch
            ...
            case 3:
              items = _context3.v;
              if (!(requestId !== _this8.drawerRequestId)) {
                _context3.n = 4;
                break;
              }
              return _context3.a(2);
            case 4:
              _this8.drawerItems = items;
              _this8.drawerError = false;
              _context3.n = 7;
              break;
            case 5:
              _context3.p = 5;
              ...
              return _context3.a(2);
            case 6:
              _this8.drawerError = true;
            case 7:
              _context3.p = 7;
              if (requestId === _this8.drawerRequestId) _this8.drawerLoading = false;
    ...
    resolveContact: function resolveContact(item) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var fromDrawer, _this9$data, _this9$data2, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              fromDrawer = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : false;
            ...
            case 1:
              _this9.resolvingId = item.id;
              _context4.p = 2;
              _context4.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.resolveContact(item.id);
            case 3:
              if ((_this9$data = _this9.data) !== null && _this9$data !== void 0 && (_this9$data = _this9$data.contacts) !== null && _this9$data !== void 0 && _this9$data.items) {
                _this9.data.contacts.items = _this9.data.contacts.items.filter(function (row) {
                  return row.id !== item.id;
                });
                _this9.data.contacts.pending_total = Math.max(0, Number(_this9.data.contacts.pending_total || 1) - 1);
              }
              if ((_this9$data2 = _this9.data) !== null && _this9$data2 !== void 0 && (_this9$data2 = _this9$data2.snapshot) !== null && _this9$data2 !== void 0 && _this9$data2.pending_contacts) {
                _this9.data.snapshot.pending_contacts.value = Math.max(0, Number(_this9.data.snapshot.pending_contacts.value || 1) - 1);
              }
              if (fromDrawer) _this9.drawerItems = _this9.drawerItems.filter(function (row) {
                return row.id !== item.id;
              });
              _context4.n = 5;
              break;
            case 4:
              _context4.p = 4;
              _t4 = _context4.v;
              console.error('Resolve contact failed', _t4);
            case 5:
              _context4.p = 5;
              _this9.resolvingId = null;
    ...
    fetchDashboard: function fetchDashboard() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var days, options, _options$quiet, quiet, _options$initial, initial, _options$force, force, safeDays, requestId, _sanitized$chart, _sanitized$chart2, payload, sanitized, _t5;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              days = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : _this0.chartDays;
              ...
              requestId = ++_this0.dashboardRequestId;
              if (!quiet) _this0.loading = true;
              _context5.p = 1;
              _context5.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getDashboard(safeDays);
            case 2:
              payload = _context5.v;
              if (!(requestId !== _this0.dashboardRequestId)) {
                _context5.n = 3;
                break;
              }
              return _context5.a(2);
            case 3:
              sanitized = _this0.sanitizePayload(payload);
              if (sanitized) {
                _context5.n = 4;
                break;
              }
            ...
            case 4:
              _this0.data = sanitized;
              _this0.error = false;
              _this0.chartDays = (sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30 ? sanitized.chart.days : safeDays;
              _this0.chartReady = false;
              _context5.n = 5;
              return _this0.$nextTick();
            case 5:
              if (requestId === _this0.dashboardRequestId) _this0.chartReady = true;
              _context5.n = 8;
              break;
            case 6:
              _context5.p = 6;
              _t5 = _context5.v;
              console.error('Admin dashboard fetch failed', _t5);
              if (!(requestId !== _this0.dashboardRequestId)) {
                _context5.n = 7;
                break;
              }
              return _context5.a(2);
            case 7:
              if (initial || force || !_this0.data) {
                _this0.error = true;
                _this0.data = null;
              }
              _this0.chartReady = true;
            case 8:
              _context5.p = 8;
              if (requestId === _this0.dashboardRequestId) _this0.loading = false;
              return _context5.f(8);
            case 9:
              return _context5.a(2);
          }
        }, _callee5, null, [[1, 6, 8, 9]]);
      }))();
    }
  }
});
...
var _hoisted_15 = {
  ...
  "aria-labelledby": "admin-learners-heading"
};
var _hoisted_16 = {
  "class": "admin-panel__head"
};
var _hoisted_17 = {
  id: "admin-learners-heading"
};
var _hoisted_18 = {
...
var _hoisted_20 = {
  key: 1,
  "class": "admin-learners"
};
var _hoisted_21 = ["onClick"];
var _hoisted_22 = {
  "class": "admin-learner__who"
};
var _hoisted_23 = {
  "class": "admin-learner__stats"
};
var _hoisted_24 = {
  "class": "admin-pill"
};
var _hoisted_25 = {
  "class": "admin-learner__stat"
};
var _hoisted_26 = {
  "class": "admin-learner__stat"
};
var _hoisted_27 = ["datetime"];
var _hoisted_28 = {
  "class": "admin-split admin-reveal",
  style: {
    "--admin-delay": "60ms"
  }
};
...
var _hoisted_46 = ["disabled", "onClick"];
var _hoisted_47 = ["data-type"];
var _hoisted_48 = {
...
var _hoisted_56 = ["aria-pressed", "disabled"];
var _hoisted_57 = ["aria-pressed", "disabled"];
var _hoisted_58 = {
  key: 0,
...
var _hoisted_60 = ["aria-labelledby"];
var _hoisted_61 = ["aria-label"];
var _hoisted_62 = {
...
var _hoisted_94 = ["datetime"];
var _hoisted_95 = {
  key: 0,
  "class": "admin-user__snippet"
};
var _hoisted_96 = ["placeholder"];
...
var _hoisted_113 = ["datetime"];
var _hoisted_114 = ["disabled", "onClick"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$data$learners, _$data$data$contacts, _$data$data$chart, _$data$userDetail$use, _$data$userDetail$use2, _$data$userDetail$use3, _$data$userDetail$use4, _$data$userDetail$use5, _$data$userDetail$use6, _$data$userDetail$use7, _$data$userDetail$sur, _$data$userDetail$rec, _$data$userDetail$rec2, _$data$userDetail$rec3;
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.eyebrow')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.greetingText), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "aria-hidden": "true"
  }, null, 2 /* CLASS */)], 8 /* PROPS */, _hoisted_8)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
    "class": "admin-reveal",
    style: {
      "--admin-delay": "20ms"
    },
    "aria-label": _ctx.t('admin.snapshot_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.snapshotCards, function (metric) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: metric.key,
      type: "button",
      "class": "admin-kpi",
      onClick: function onClick($event) {
        return $options.openDrawer(metric.drawer);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.value), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_13, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.label), 1 /* TEXT */), metric.hint ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.hint), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_11);
  }), 128 /* KEYED_FRAGMENT */))])], 8 /* PROPS */, _hoisted_9), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $options.openDrawer('users');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_users')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_hint')), 1 /* TEXT */), !((_$data$data$learners = $data.data.learners) !== null && _$data$data$learners !== void 0 && _$data$data$learners.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_20, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.learners, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.email), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_24, [row.current_surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.current_surah_name) + " ", 1 /* TEXT */), row.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
      ...
      n: row.current_ayah
    })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 1
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.not_started')), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_25, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("em", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.memorised_ayahs), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("em", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_sessions')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.sessions_completed), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-learner__time",
      datetime: row.last_activity_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.last_activity_at) || '—'), 9 /* TEXT, PROPS */, _hoisted_27), _cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      "class": "bi bi-chevron-right admin-learner__chev",
      "aria-hidden": "true"
    }, null, -1 /* CACHED */))])], 8 /* PROPS */, _hoisted_21)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_29, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_30, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_title')), 1 /* TEXT */), $options.contactInboxUrl ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "admin-link",
    href: $options.contactInboxUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_contacts')), 9 /* TEXT, PROPS */, _hoisted_32)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), !((_$data$data$contacts = $data.data.contacts) !== null && _$data$data$contacts !== void 0 && (_$data$data$contacts = _$data$data$contacts.items) !== null && _$data$data$contacts !== void 0 && _$data$data$contacts.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_33, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_34, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.contacts.items, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id,
      "class": "admin-list__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_35, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.subject || _ctx.t('admin.contact_no_subject')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_37, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.email), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-list__time",
      datetime: item.created_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.created_at)), 9 /* TEXT, PROPS */, _hoisted_39), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_40)])]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_41, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_42, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_43, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[3] || (_cache[3] = function ($event) {
      return $options.openDrawer('activity');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_activity')), 1 /* TEXT */)]), !$options.previewActivity.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_44, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_45, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.previewActivity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      ...
      "class": "admin-type",
      "data-type": item.type
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item)), 9 /* TEXT, PROPS */, _hoisted_47), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_48, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_49, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_50, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-feed__time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_51)], 8 /* PROPS */, _hoisted_46)]);
  }), 128 /* KEYED_FRAGMENT */))]))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_52, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_53, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_54, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-range",
    role: "group",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_7')), 11 /* TEXT, CLASS, PROPS */, _hoisted_56), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-btn admin-btn--ghost admin-btn--sm", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_30')), 11 /* TEXT, CLASS, PROPS */, _hoisted_57)], 8 /* PROPS */, _hoisted_55)]), $options.chartTotals ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_58, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_total_sessions', {
  ...
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$data$chart = $data.data.chart) !== null && _$data$data$chart !== void 0 && _$data$data$chart.is_empty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_empty')), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 2,
  ...
  }, null, 8 /* PROPS */, _hoisted_61), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-drawer", {
      'admin-drawer--wide': $data.drawerMode === 'user'
    }]),
    tabindex: "-1"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_62, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", {
    id: $options.drawerTitleId,
    "class": "admin-drawer__title"
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerTitle), 9 /* TEXT, PROPS */, _hoisted_63), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-icon-btn",
    "aria-label": _ctx.t('admin.drawer_close'),
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_64)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_65, [$data.drawerMode === 'user' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [$data.userDetailLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_66, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.userDetailError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_67, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : $data.userDetail ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_68, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_69, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(((_$data$userDetail$use = $data.userDetail.user) === null || _$data$userDetail$use === void 0 ? void 0 : _$data$userDetail$use.name) || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$userDetail$use2 = $data.userDetail.user) === null || _$data$userDetail$use2 === void 0 ? void 0 : _$data$userDetail$use2.email), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_71, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.authLabel((_$data$userDetail$use3 = $data.userDetail.user) === null || _$data$userDetail$use3 === void 0 ? void 0 : _$data$userDetail$use3.auth_provider)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_72, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel((_$data$userDetail$use4 = $data.userDetail.user) === null || _$data$userDetail$use4 === void 0 ? void 0 : _$data$userDetail$use4.subscription_status)), 1 /* TEXT */), (_$data$userDetail$use5 = $data.userDetail.user) !== null && _$data$userDetail$use5 !== void 0 && _$data$userDetail$use5.locale ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_73, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.userDetail.user.locale), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$userDetail$use6 = $data.userDetail.user) !== null && _$data$userDetail$use6 !== void 0 && _$data$userDetail$use6.created_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_74, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.joined', {
    date: $options.formatAbsoluteDate($data.userDetail.user.created_at)
  })), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_75, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.userStatCards, function (stat) {
  ...
  }), 128 /* KEYED_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_76, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_position')), 1 /* TEXT */), (_$data$userDetail$use7 = $data.userDetail.user) !== null && _$data$userDetail$use7 !== void 0 && _$data$userDetail$use7.current_surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.userDetail.user.current_surah_name) + " ", 1 /* TEXT */), $data.userDetail.user.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ayah_n', {
    ...
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative($data.userDetail.user.last_activity_at)), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_78, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.not_started')), 1 /* TEXT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_79, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs')), 1 /* TEXT */), !((_$data$userDetail$sur = $data.userDetail.surah_progress) !== null && _$data$userDetail$sur !== void 0 && _$data$userDetail$sur.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_80, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_81, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.surah_progress, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
  ...
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_82, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions')), 1 /* TEXT */), !((_$data$userDetail$rec = $data.userDetail.recent_sessions) !== null && _$data$userDetail$rec !== void 0 && _$data$userDetail$rec.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_83, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_84, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_sessions, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_85)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_86, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai')), 1 /* TEXT */), !((_$data$userDetail$rec2 = $data.userDetail.recent_ai_checks) !== null && _$data$userDetail$rec2 !== void 0 && _$data$userDetail$rec2.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_87, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_88, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_ai_checks, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
      ...
      datetime: row.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_89)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_90, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes')), 1 /* TEXT */), !((_$data$userDetail$rec3 = $data.userDetail.recent_notes) !== null && _$data$userDetail$rec3 !== void 0 && _$data$userDetail$rec3.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_91, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_92, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_notes, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id,
      "class": "admin-mini-list__stack"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_93, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      datetime: row.updated_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.updated_at)), 9 /* TEXT, PROPS */, _hoisted_94)]), row.snippet ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_95, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.snippet), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
    ...
    key: 1
  }, [$data.drawerMode === 'users' ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
    key: 0,
    "onUpdate:modelValue": _cache[8] || (_cache[8] = function ($event) {
      return $data.userSearch = $event;
    }),
    type: "search",
    "class": "admin-drawer__search",
    placeholder: _ctx.t('admin.users_search'),
    onInput: _cache[9] || (_cache[9] = function () {
      return $options.onUserSearch && $options.onUserSearch.apply($options, arguments);
    })
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_96)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.userSearch, void 0, {
    trim: true
  }]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 1,
    "class": "admin-filters",
    role: "group",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_98);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_97)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_99, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_100, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : !$options.filteredDrawerItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_101, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerEmptyMessage), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_102, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.filteredDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_104, [$data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      key: 0,
      "class": "admin-type",
      "data-type": item.type
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item)), 9 /* TEXT, PROPS */, _hoisted_105)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_106, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemTitle(item)), 1 /* TEXT */), $options.drawerItemMeta(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_107, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemMeta(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $options.drawerItemTime(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("time", {
      key: 0,
      "class": "admin-drawer__row-time",
      datetime: $options.drawerItemTime(item)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate($options.drawerItemTime(item))), 9 /* TEXT, PROPS */, _hoisted_108)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_103)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 1
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_109, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_110, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemTitle(item)), 1 /* TEXT */), $options.drawerItemMeta(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_111, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemMeta(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_112, [$options.drawerItemTime(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("time", {
      key: 0,
      "class": "admin-drawer__row-time",
      datetime: $options.drawerItemTime(item)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate($options.drawerItemTime(item))), 9 /* TEXT, PROPS */, _hoisted_113)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), item.status === 'pending' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 1,
      type: "button",
      "class": "admin-btn admin-btn--ghost admin-btn--sm",
      disabled: $data.resolvingId === item.id,
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_114)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 64 /* STABLE_FRAGMENT */))]);
  }), 128 /* KEYED_FRAGMENT */))]))], 64 /* STABLE_FRAGMENT */))])], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_60)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
}
