...
chart_js__WEBPACK_IMPORTED_MODULE_2__.Chart.register(chart_js__WEBPACK_IMPORTED_MODULE_2__.CategoryScale, chart_js__WEBPACK_IMPORTED_MODULE_2__.LinearScale, chart_js__WEBPACK_IMPORTED_MODULE_2__.PointElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.LineElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.Filler, chart_js__WEBPACK_IMPORTED_MODULE_2__.Tooltip, chart_js__WEBPACK_IMPORTED_MODULE_2__.Legend);
var METRIC_META = [{
  key: 'users_total',
  labelKey: 'metric_users',
  action: 'users'
}, {
  key: 'active_users',
  ...
  labelKey: 'metric_contacts',
  action: 'contacts'
}];
var DRAWER_TITLES = {
  sessions: 'drawer_sessions_title',
  contacts: 'drawer_contacts_title',
  activity: 'drawer_activity_title',
  user: 'drawer_user_title',
  create: 'drawer_create_title'
};
var DRAWER_EMPTY = {
  sessions: 'drawer_sessions_empty',
  contacts: 'drawer_contacts_empty',
  activity: 'drawer_activity_empty'
};
var emptyUserForm = function emptyUserForm() {
  return {
    name: '',
    email: '',
    password: '',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'AdminDashboard',
  components: {
    Line: vue_chartjs__WEBPACK_IMPORTED_MODULE_3__.Line
  },
  props: {
    auth: {
      type: Object,
  ...
  data: function data() {
    ...
    return {
      ...
      loading: !initial,
      error: false,
      chartDays: (initial === null || initial === void 0 || (_initial$chart = initial.chart) === null || _initial$chart === void 0 ? void 0 : _initial$chart.days) === 30 ? 30 : 7,
      chartReady: true,
      reduceMotion: false,
      darkTheme: false,
      themeObserver: null,
  ...
  computed: {
    ...
    greetingText: function greetingText() {
      var _this$data2, _this$auth3;
      var name = ((_this$data2 = this.data) === null || _this$data2 === void 0 || (_this$data2 = _this$data2.welcome) === null || _this$data2 === void 0 ? void 0 : _this$data2.first_name) || ((_this$auth3 = this.auth) === null || _this$auth3 === void 0 ? void 0 : _this$auth3.first_name) || this.t('admin.dear_friend');
      return this.t('admin.greeting', {
        name: name
      });
    },
    snapshotCards: function snapshotCards() {
      ...
      return METRIC_META.map(function (meta) {
        var row = snapshot[meta.key] || {};
        var value = Number(row.value || 0);
        var hint = '';
        if (meta.key === 'users_total' && Number(row.delta_7d || 0) > 0) {
          hint = _this.t('admin.metric_users_hint', {
            n: Number(row.delta_7d)
          });
        }
        return {
          key: meta.key,
          value: value,
          label: _this.t("admin.".concat(meta.labelKey)),
          hint: hint,
          action: meta.action
        };
      });
    },
    previewActivity: function previewActivity() {
      var _this$data4;
      var items = Array.isArray((_this$data4 = this.data) === null || _this$data4 === void 0 ? void 0 : _this$data4.activity) ? this.data.activity : [];
      return items.slice(0, 5);
    },
    chartTotals: function chartTotals() {
      var _this$data5, _this$data6;
      var totals = (_this$data5 = this.data) === null || _this$data5 === void 0 || (_this$data5 = _this$data5.chart) === null || _this$data5 === void 0 ? void 0 : _this$data5.totals;
      if (!totals || (_this$data6 = this.data) !== null && _this$data6 !== void 0 && (_this$data6 = _this$data6.chart) !== null && _this$data6 !== void 0 && _this$data6.is_empty) return null;
      return {
        sessions: Number(totals.sessions || 0),
        ai_checks: Number(totals.ai_checks || 0),
        ayahs: Number(totals.ayahs || 0),
        new_users: Number(totals.new_users || 0)
      };
    },
    chartInstanceKey: function chartInstanceKey() {
      var _this$data7, _points, _points$;
      var points = ((_this$data7 = this.data) === null || _this$data7 === void 0 || (_this$data7 = _this$data7.chart) === null || _this$data7 === void 0 ? void 0 : _this$data7.points) || [];
      var last = points.length ? (_points = points[points.length - 1]) === null || _points === void 0 ? void 0 : _points.date : 'y';
      return "admin-chart-".concat(this.chartDays, "-").concat(points.length, "-").concat(((_points$ = points[0]) === null || _points$ === void 0 ? void 0 : _points$.date) || 'x', "-").concat(last || 'y');
    },
    chartPalette: function chartPalette() {
      if (this.darkTheme) {
        return {
          sessions: '#8FA37A',
          sessionsFill: 'rgba(143, 163, 122, 0.22)',
          ai: '#D48462',
          aiFill: 'rgba(212, 132, 98, 0.16)',
          muted: '#c9b8a8',
          ink: '#f0e7dc',
          tooltipBg: '#221e1a',
      ...
      return {
        sessions: '#5C6B4A',
        sessionsFill: 'rgba(92, 107, 74, 0.16)',
        ai: '#C46B4A',
        aiFill: 'rgba(196, 107, 74, 0.12)',
        muted: '#6d6258',
        ink: '#3c3530',
        tooltipBg: '#f7f1ea',
    ...
    chartData: function chartData() {
      var _this$data8,
        _this2 = this;
      var points = ((_this$data8 = this.data) === null || _this$data8 === void 0 || (_this$data8 = _this$data8.chart) === null || _this$data8 === void 0 ? void 0 : _this$data8.points) || [];
      ...
      return {
        ...
        datasets: [{
          label: this.t('admin.chart_sessions'),
          data: points.map(function (point) {
            var _ref, _point$primary;
            return Number((_ref = (_point$primary = point.primary) !== null && _point$primary !== void 0 ? _point$primary : point.sessions_completed) !== null && _ref !== void 0 ? _ref : 0);
          }),
          borderColor: palette.sessions,
          backgroundColor: palette.sessionsFill,
          fill: true,
          tension: 0.35,
          pointRadius: points.length <= 8 ? 3.5 : 0,
          pointHoverRadius: 5,
          borderWidth: 2.25
        }, {
          label: this.t('admin.chart_ai'),
          data: points.map(function (point) {
            var _ref2, _point$secondary;
            return Number((_ref2 = (_point$secondary = point.secondary) !== null && _point$secondary !== void 0 ? _point$secondary : point.ai_checks) !== null && _ref2 !== void 0 ? _ref2 : 0);
          }),
          borderColor: palette.ai,
          backgroundColor: palette.aiFill,
          fill: true,
          tension: 0.35,
    ...
    chartOptions: function chartOptions() {
      var _this$data9,
        _this3 = this;
      var points = ((_this$data9 = this.data) === null || _this$data9 === void 0 || (_this$data9 = _this$data9.chart) === null || _this$data9 === void 0 ? void 0 : _this$data9.points) || [];
      var palette = this.chartPalette;
      return {
        responsive: true,
          ...
          tooltip: {
            ...
            callbacks: {
              title: function title(items) {
                ...
                return _this3.tooltipDate((points[index] || {}).date);
              },
              label: function label(item) {
                return "".concat(item.dataset.label, ": ").concat(item.parsed.y);
              },
              afterBody: function afterBody(items) {
                var _items$0$dataIndex2, _items$2;
                var index = (_items$0$dataIndex2 = items === null || items === void 0 || (_items$2 = items[0]) === null || _items$2 === void 0 ? void 0 : _items$2.dataIndex) !== null && _items$0$dataIndex2 !== void 0 ? _items$0$dataIndex2 : 0;
                var point = points[index] || {};
                var extras = [];
                if (Number(point.ayahs_practised || 0) > 0) {
                  extras.push(_this3.t('admin.chart_tooltip_ayahs', {
                    n: Number(point.ayahs_practised)
                  }));
                }
                if (Number(point.new_users || 0) > 0) {
                  extras.push(_this3.t('admin.chart_tooltip_users', {
                    n: Number(point.new_users)
                  }));
                }
                return extras;
              }
    ...
    drawerTitleId: function drawerTitleId() {
      return 'admin-drawer-title';
    },
    drawerTitle: function drawerTitle() {
      if (this.drawerMode === 'user') {
        var _this$userDetail, _this$userDetail2;
        return ((_this$userDetail = this.userDetail) === null || _this$userDetail === void 0 || (_this$userDetail = _this$userDetail.user) === null || _this$userDetail === void 0 ? void 0 : _this$userDetail.name) || ((_this$userDetail2 = this.userDetail) === null || _this$userDetail2 === void 0 || (_this$userDetail2 = _this$userDetail2.user) === null || _this$userDetail2 === void 0 ? void 0 : _this$userDetail2.email) || this.t('admin.drawer_user_title');
      }
      var key = DRAWER_TITLES[this.drawerMode];
      return key ? this.t("admin.".concat(key)) : '';
    },
    ...
    filteredDrawerItems: function filteredDrawerItems() {
      var _this4 = this;
      if (this.drawerMode !== 'activity' || this.activityFilter === 'all') return this.drawerItems;
      return this.drawerItems.filter(function (item) {
        return item.type === _this4.activityFilter;
      });
    },
    userStatCards: function userStatCards() {
      var _this$userDetail3;
      var stats = ((_this$userDetail3 = this.userDetail) === null || _this$userDetail3 === void 0 ? void 0 : _this$userDetail3.stats) || {};
      return [{
        key: 'memorised',
        value: Number(stats.memorised_ayahs || 0),
        label: this.t('admin.col_memorised')
      }, {
        key: 'learning',
        value: Number(stats.learning_ayahs || 0),
        label: this.t('admin.col_learning')
      }, {
        key: 'sessions',
        value: Number(stats.sessions_completed || 0),
        label: this.t('admin.col_sessions')
      }, {
        key: 'ai',
        value: Number(stats.ai_checks || 0),
        label: this.t('admin.metric_ai')
      }, {
        key: 'accuracy',
        value: stats.avg_ai_accuracy != null ? this.t('admin.accuracy', {
          n: stats.avg_ai_accuracy
        }) : '—',
        label: this.t('admin.ai_avg')
      }, {
        key: 'notes',
        value: Number(stats.notes || 0),
        label: this.t('admin.metric_notes')
      }];
    }
  },
  mounted: function mounted() {
    ...
    if (!this.data) this.fetchDashboard(this.chartDays, {
      initial: true
    });else this.fetchDashboard(this.chartDays, {
      quiet: true
    });
    this.loadDirectory();
  ...
  methods: {
    ...
    onKpiClick: function onKpiClick(metric) {
      if (metric.action === 'users') {
        var el = document.getElementById('admin-users-heading');
    ...
    authLabel: function authLabel(key) {
      return key === 'google' ? this.t('admin.auth_google') : this.t('admin.auth_email');
    },
    ...
    activityTitle: function activityTitle(item) {
      ...
      if (item.type === 'user_joined') {
        return item.user_name || item.user_email || this.t('admin.activity_type_user');
      }
      var who = item.user_name || item.user_email || '';
      var place = [item.surah_name, this.formatItemRange(item)].filter(Boolean).join(' · ');
      if (who && place) return "".concat(who, " \xB7 ").concat(place);
      return who || place || item.title || this.t('admin.activity_fallback');
    },
    activityOutcome: function activityOutcome(item) {
      if (!item) return '';
      var key = String(item.outcome_key || '').toLowerCase();
      var params = item.outcome_params || {};
      ...
      if (key === 'ai_check') return this.t('admin.activity_type_ai');
    ...
    sessionLine: function sessionLine(row) {
      ...
      return [place, status].filter(Boolean).join(' · ') || status;
    },
    ...
    formatItemRange: function formatItemRange(item) {
      ...
      if (start > 0) return this.t('admin.ayah_n', {
        n: start
      });
      return '';
    },
    ...
    formatActivityDate: function formatActivityDate(value) {
      ...
      return days < 8 ? this.formatRelative(value) : this.formatAbsoluteDate(date);
    },
    ...
    syncTheme: function syncTheme() {
      this.darkTheme = typeof document !== 'undefined' && document.documentElement.getAttribute('data-theme') === 'dark';
    },
    ...
    loadDirectory: function loadDirectory() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var q, requestId, users, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              q = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this6.directorySearch;
              requestId = ++_this6.directoryRequestId;
              _this6.directoryLoading = true;
              _this6.directoryError = false;
              _context.p = 1;
              _context.n = 2;
            ...
            case 2:
              users = _context.v;
              if (!(requestId !== _this6.directoryRequestId)) {
                _context.n = 3;
                break;
              }
              return _context.a(2);
            case 3:
              _this6.directoryUsers = Array.isArray(users) ? users : [];
              _context.n = 6;
              break;
            case 4:
              _context.p = 4;
              _t = _context.v;
              console.error('Admin directory failed', _t);
              if (!(requestId !== _this6.directoryRequestId)) {
                _context.n = 5;
                break;
              }
              return _context.a(2);
            case 5:
              _this6.directoryError = true;
            case 6:
              _context.p = 6;
              if (requestId === _this6.directoryRequestId) _this6.directoryLoading = false;
              return _context.f(6);
            case 7:
              return _context.a(2);
          }
    ...
    onDirectorySearch: function onDirectorySearch() {
      var _this7 = this;
      if (this.directorySearchTimer) clearTimeout(this.directorySearchTimer);
      this.directorySearchTimer = setTimeout(function () {
        return _this7.loadDirectory(_this7.directorySearch);
      }, 250);
    },
    openCreateUser: function openCreateUser() {
    ...
    startEditUser: function startEditUser() {
      var _this$userDetail4;
      var user = ((_this$userDetail4 = this.userDetail) === null || _this$userDetail4 === void 0 ? void 0 : _this$userDetail4.user) || {};
      this.userTab = 'edit';
      this.userForm = {
        name: user.name || '',
        email: user.email || '',
    ...
    submitCreateUser: function submitCreateUser() {
      var _this8 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              _this8.formSaving = true;
              _this8.formError = '';
              _context2.p = 1;
              _context2.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.createUser(_objectSpread({}, _this8.userForm));
            case 2:
              created = _context2.v;
              _context2.n = 3;
              return _this8.loadDirectory();
            case 3:
              _this8.fetchDashboard(_this8.chartDays, {
                quiet: true
              });
              ...
              _context2.n = 4;
              return _this8.openUserDetail(created.id);
            case 4:
              _context2.n = 6;
              break;
            case 5:
            ...
            case 7:
              _context2.p = 7;
              _t2 = _context2.v;
              _this8.formError = _this8.formErrorFrom(_t2);
            case 8:
              _context2.p = 8;
              _this8.formSaving = false;
    ...
    submitUpdateUser: function submitUpdateUser() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var payload, result, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              if (_this9.selectedUserId) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              _this9.formSaving = true;
              _this9.formError = '';
              _context3.p = 2;
              payload = {
                name: _this9.userForm.name,
                email: _this9.userForm.email,
                locale: _this9.userForm.locale,
                subscription_status: _this9.userForm.subscription_status
              };
              if (_this9.userForm.password) payload.password = _this9.userForm.password;
              _context3.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.updateUser(_this9.selectedUserId, payload);
            case 3:
              result = _context3.v;
              if (result !== null && result !== void 0 && result.detail) _this9.userDetail = result.detail;
              _context3.n = 4;
              return _this9.loadDirectory();
            case 4:
              _this9.fetchDashboard(_this9.chartDays, {
                quiet: true
              });
              _this9.userTab = 'overview';
              _this9.userForm.password = '';
              _context3.n = 6;
              break;
            case 5:
              _context3.p = 5;
              _t3 = _context3.v;
              _this9.formError = _this9.formErrorFrom(_t3);
            case 6:
              _context3.p = 6;
              _this9.formSaving = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              if (!(!_this0.selectedUserId || _this0.isSelfSelected)) {
                _context4.n = 1;
                break;
              }
              return _context4.a(2);
            case 1:
              if (window.confirm(_this0.t('admin.delete_user_confirm'))) {
                _context4.n = 2;
                break;
              }
              return _context4.a(2);
            case 2:
              _this0.deletingUser = true;
              _context4.p = 3;
              _context4.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteUser(_this0.selectedUserId);
            case 4:
              _this0.closeDrawer();
              _context4.n = 5;
              return _this0.loadDirectory();
            case 5:
              _this0.fetchDashboard(_this0.chartDays, {
                quiet: true
              });
              _context4.n = 7;
              break;
            case 6:
              _context4.p = 6;
              _t4 = _context4.v;
              _this0.formError = _this0.formErrorFrom(_t4);
              _this0.userTab = 'edit';
            case 7:
              _context4.p = 7;
              _this0.deletingUser = false;
    ...
    deleteNote: function deleteNote(row) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var _this1$userDetail, _this1$userDetail2, _t5;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 1:
              if (window.confirm(_this1.t('admin.delete_note_confirm'))) {
                _context5.n = 2;
                break;
              }
              return _context5.a(2);
            case 2:
              _this1.deletingNoteId = row.id;
              _context5.p = 3;
              _context5.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteNote(row.id);
            case 4:
              if ((_this1$userDetail = _this1.userDetail) !== null && _this1$userDetail !== void 0 && _this1$userDetail.recent_notes) {
                _this1.userDetail.recent_notes = _this1.userDetail.recent_notes.filter(function (n) {
                  return n.id !== row.id;
                });
              }
              if ((_this1$userDetail2 = _this1.userDetail) !== null && _this1$userDetail2 !== void 0 && _this1$userDetail2.stats) {
                _this1.userDetail.stats.notes = Math.max(0, Number(_this1.userDetail.stats.notes || 1) - 1);
              }
              _context5.n = 6;
              break;
            case 5:
              _context5.p = 5;
              _t5 = _context5.v;
              console.error('Delete note failed', _t5);
            case 6:
              _context5.p = 6;
              _this1.deletingNoteId = null;
    ...
    drawerItemKey: function drawerItemKey(item) {
      return item.id || "".concat(item.email || item.user_email, "-").concat(item.occurred_at || item.created_at);
    },
    drawerItemTitle: function drawerItemTitle(item) {
      if (this.drawerMode === 'contacts') return item.subject || this.t('admin.contact_no_subject');
      if (this.drawerMode === 'activity') return this.activityTitle(item);
      var who = item.user_name || item.user_email || '';
      var place = [item.surah_name, this.formatItemRange(item)].filter(Boolean).join(' · ');
      return [who, place].filter(Boolean).join(' · ') || String(item.id || '');
    },
    drawerItemMeta: function drawerItemMeta(item) {
      if (this.drawerMode === 'contacts') return "".concat(item.name, " \xB7 ").concat(item.email);
      if (this.drawerMode === 'sessions') {
        return item.status === 'ended_early' ? this.t('admin.outcome_session_ended_early') : this.t('admin.outcome_session_completed');
      }
      if (this.drawerMode === 'activity') return this.activityOutcome(item);
      return '';
    },
    drawerItemTime: function drawerItemTime(item) {
      return item.occurred_at || item.last_activity_at || item.updated_at || item.created_at || null;
    },
    onDrawerItemClick: function onDrawerItemClick(item) {
      if (this.drawerMode === 'contacts') return;
      var userId = item.user_id;
      if (userId) this.openUserDetail(userId);
    },
    openUserDetail: function openUserDetail(userId) {
      var _this10 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var id, requestId, detail, _t6;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              _this10.drawerMode = 'user';
              _this10.selectedUserId = id;
              _this10.userTab = 'overview';
              _this10.userDetail = null;
              _this10.userDetailError = false;
              _this10.userDetailLoading = true;
              _this10.formError = '';
              requestId = ++_this10.userDetailRequestId;
              _context6.p = 2;
              _context6.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUser(id);
            case 3:
              detail = _context6.v;
              if (!(requestId !== _this10.userDetailRequestId)) {
                _context6.n = 4;
                break;
              }
              return _context6.a(2);
            case 4:
              _this10.userDetail = detail;
              _context6.n = 7;
              break;
            case 5:
              _context6.p = 5;
              _t6 = _context6.v;
              console.error('Admin user detail failed', _t6);
              if (!(requestId !== _this10.userDetailRequestId)) {
                _context6.n = 6;
                break;
              }
              return _context6.a(2);
            case 6:
              _this10.userDetailError = true;
            case 7:
              _context6.p = 7;
              if (requestId === _this10.userDetailRequestId) _this10.userDetailLoading = false;
              return _context6.f(7);
            case 8:
              return _context6.a(2);
          }
        }, _callee6, null, [[2, 5, 7, 8]]);
      }))();
    },
    openDrawer: function openDrawer(mode) {
      var _this11 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        var requestId, items, _t7;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 1:
              _this11.drawerMode = mode;
              _this11.drawerItems = [];
              _this11.drawerError = false;
              _this11.drawerLoading = true;
              _this11.activityFilter = 'all';
              _this11.userDetail = null;
              _this11.selectedUserId = null;
              requestId = ++_this11.drawerRequestId;
              _context7.p = 2;
              items = [];
              if (!(mode === 'sessions')) {
                _context7.n = 4;
              ...
              _context7.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getSessions();
            case 3:
              items = _context7.v;
              _context7.n = 8;
              break;
            ...
            case 6:
              ...
              _context7.n = 7;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getActivity(80);
            case 7:
              items = _context7.v;
            case 8:
              if (!(requestId !== _this11.drawerRequestId)) {
                _context7.n = 9;
                break;
              }
              return _context7.a(2);
            case 9:
              _this11.drawerItems = Array.isArray(items) ? items : [];
              _context7.n = 12;
              break;
            case 10:
              _context7.p = 10;
              _t7 = _context7.v;
              console.error('Admin drawer fetch failed', _t7);
              if (!(requestId !== _this11.drawerRequestId)) {
                _context7.n = 11;
                break;
              }
              return _context7.a(2);
            case 11:
              _this11.drawerError = true;
              _this11.drawerItems = [];
            case 12:
              _context7.p = 12;
              if (requestId === _this11.drawerRequestId) _this11.drawerLoading = false;
    ...
    resolveContact: function resolveContact(item) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var fromDrawer, _this12$data, _this12$data2, _t8;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              fromDrawer = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : false;
            ...
            case 1:
              _this12.resolvingId = item.id;
              _context8.p = 2;
              _context8.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.resolveContact(item.id);
            case 3:
              if ((_this12$data = _this12.data) !== null && _this12$data !== void 0 && (_this12$data = _this12$data.contacts) !== null && _this12$data !== void 0 && _this12$data.items) {
                _this12.data.contacts.items = _this12.data.contacts.items.filter(function (row) {
                  return row.id !== item.id;
                });
                _this12.data.contacts.pending_total = Math.max(0, Number(_this12.data.contacts.pending_total || 1) - 1);
              }
              if ((_this12$data2 = _this12.data) !== null && _this12$data2 !== void 0 && (_this12$data2 = _this12$data2.snapshot) !== null && _this12$data2 !== void 0 && _this12$data2.pending_contacts) {
                _this12.data.snapshot.pending_contacts.value = Math.max(0, Number(_this12.data.snapshot.pending_contacts.value || 1) - 1);
              }
              if (fromDrawer) _this12.drawerItems = _this12.drawerItems.filter(function (row) {
                return row.id !== item.id;
              });
              _context8.n = 5;
              break;
            case 4:
              _context8.p = 4;
              _t8 = _context8.v;
              console.error('Resolve contact failed', _t8);
            case 5:
              _context8.p = 5;
              _this12.resolvingId = null;
    ...
    deleteContact: function deleteContact(item) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        var fromDrawer, _this13$data, _this13$data2, _t9;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              fromDrawer = _arguments3.length > 1 && _arguments3[1] !== undefined ? _arguments3[1] : false;
              if (item !== null && item !== void 0 && item.id) {
                _context9.n = 1;
                break;
              }
            ...
            case 1:
              if (window.confirm(_this13.t('admin.delete_contact_confirm'))) {
                _context9.n = 2;
                break;
              }
              return _context9.a(2);
            case 2:
              _this13.deletingContactId = item.id;
              _context9.p = 3;
              _context9.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteContact(item.id);
            case 4:
              if ((_this13$data = _this13.data) !== null && _this13$data !== void 0 && (_this13$data = _this13$data.contacts) !== null && _this13$data !== void 0 && _this13$data.items) {
                _this13.data.contacts.items = _this13.data.contacts.items.filter(function (row) {
                  return row.id !== item.id;
                });
              }
              if (item.status === 'pending' && (_this13$data2 = _this13.data) !== null && _this13$data2 !== void 0 && (_this13$data2 = _this13$data2.snapshot) !== null && _this13$data2 !== void 0 && _this13$data2.pending_contacts) {
                _this13.data.snapshot.pending_contacts.value = Math.max(0, Number(_this13.data.snapshot.pending_contacts.value || 1) - 1);
              }
              if (fromDrawer) _this13.drawerItems = _this13.drawerItems.filter(function (row) {
                return row.id !== item.id;
              });
              _context9.n = 6;
              break;
            case 5:
              _context9.p = 5;
              _t9 = _context9.v;
              console.error('Delete contact failed', _t9);
            case 6:
              _context9.p = 6;
              _this13.deletingContactId = null;
    ...
    setChartDays: function setChartDays(days) {
      ...
      if (next === this.chartDays && ((_this$data0 = this.data) === null || _this$data0 === void 0 || (_this$data0 = _this$data0.chart) === null || _this$data0 === void 0 ? void 0 : _this$data0.days) === next && !this.loading) return;
      this.chartDays = next;
    ...
    fetchDashboard: function fetchDashboard() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var days, options, _options$quiet, quiet, _options$initial, initial, _options$force, force, safeDays, requestId, _sanitized$chart, _sanitized$chart2, payload, sanitized, _t0;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            case 0:
              days = _arguments4.length > 0 && _arguments4[0] !== undefined ? _arguments4[0] : _this14.chartDays;
              ...
              requestId = ++_this14.dashboardRequestId;
              if (!quiet) _this14.loading = true;
              _context0.p = 1;
              _context0.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getDashboard(safeDays);
            case 2:
              payload = _context0.v;
              if (!(requestId !== _this14.dashboardRequestId)) {
                _context0.n = 3;
                break;
              }
              return _context0.a(2);
            case 3:
              sanitized = _this14.sanitizePayload(payload);
              if (sanitized) {
                _context0.n = 4;
                break;
              }
              throw new Error('Admin dashboard payload owner mismatch');
            case 4:
              _this14.data = sanitized;
              _this14.error = false;
              _this14.chartDays = (sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30 ? sanitized.chart.days : safeDays;
              _this14.chartReady = false;
              _context0.n = 5;
              return _this14.$nextTick();
            case 5:
              if (requestId === _this14.dashboardRequestId) _this14.chartReady = true;
              _context0.n = 8;
              break;
            case 6:
              _context0.p = 6;
              _t0 = _context0.v;
              console.error('Admin dashboard fetch failed', _t0);
              if (!(requestId !== _this14.dashboardRequestId)) {
                _context0.n = 7;
                break;
              }
              return _context0.a(2);
            case 7:
              if (initial || force || !_this14.data) {
                _this14.error = true;
                _this14.data = null;
              }
              _this14.chartReady = true;
            case 8:
              _context0.p = 8;
              if (requestId === _this14.dashboardRequestId) _this14.loading = false;
...
var _hoisted_5 = {
  "class": "admin-hero admin-reveal"
};
var _hoisted_6 = {
  "class": "admin-hero__copy"
};
var _hoisted_7 = {
  "class": "admin-eyebrow"
};
var _hoisted_8 = {
  "class": "admin-hero__sub"
};
var _hoisted_9 = {
...
var _hoisted_16 = {
  key: 0,
  "class": "admin-kpi__hint"
};
var _hoisted_17 = {
  "class": "admin-workspace admin-reveal",
  style: {
    "--admin-delay": "40ms"
  }
};
var _hoisted_18 = {
  "class": "admin-panel admin-panel--primary",
...
var _hoisted_30 = {
  "class": "admin-user-row__who"
};
var _hoisted_31 = {
  "class": "admin-user-row__meta"
};
var _hoisted_32 = {
  "class": "admin-pill"
};
var _hoisted_33 = {
  "class": "admin-user-row__stat"
};
var _hoisted_34 = {
  "class": "admin-user-row__stat"
};
var _hoisted_35 = ["datetime"];
var _hoisted_36 = {
  "class": "admin-ops"
};
var _hoisted_37 = {
  "class": "admin-panel",
  "aria-labelledby": "admin-contacts-heading"
};
var _hoisted_38 = {
  "class": "admin-panel__head"
};
var _hoisted_39 = {
  id: "admin-contacts-heading"
};
...
var _hoisted_54 = ["disabled", "onClick"];
var _hoisted_55 = ["data-type"];
var _hoisted_56 = {
  "class": "admin-feed__main"
};
var _hoisted_57 = {
  "class": "admin-feed__title"
};
var _hoisted_58 = {
  key: 0,
  "class": "admin-feed__meta"
};
var _hoisted_59 = ["datetime"];
var _hoisted_60 = {
  "class": "admin-panel admin-reveal",
  style: {
    "--admin-delay": "70ms"
  },
  "aria-labelledby": "admin-chart-heading"
};
var _hoisted_61 = {
  "class": "admin-panel__head admin-panel__head--chart"
};
var _hoisted_62 = {
  id: "admin-chart-heading"
};
var _hoisted_63 = ["aria-label"];
var _hoisted_64 = ["aria-pressed", "disabled"];
var _hoisted_65 = ["aria-pressed", "disabled"];
var _hoisted_66 = {
  key: 0,
  "class": "admin-chart__totals"
};
var _hoisted_67 = {
  key: 1,
  "class": "admin-chart__empty"
};
...
var _hoisted_91 = {
  "class": "admin-user__profile"
};
var _hoisted_92 = {
  "class": "admin-user__tags"
};
var _hoisted_93 = {
  "class": "admin-pill"
};
...
var _hoisted_97 = {
  "class": "admin-user__kpis"
};
var _hoisted_98 = {
  "class": "admin-user__block"
};
var _hoisted_99 = {
  key: 0,
  "class": "admin-user__copy"
};
var _hoisted_100 = {
  key: 1,
  "class": "admin-user__copy admin-user__copy--muted"
};
var _hoisted_101 = {
  "class": "admin-user__block"
};
...
var _hoisted_115 = {
  "class": "admin-mini-list__top"
};
var _hoisted_116 = ["disabled", "onClick"];
var _hoisted_117 = {
  key: 0,
  "class": "admin-user__snippet"
};
...
var _hoisted_123 = {
  key: 4,
  "class": "admin-drawer__list"
};
var _hoisted_124 = ["onClick"];
var _hoisted_125 = {
  "class": "admin-drawer__row-main"
};
var _hoisted_126 = ["data-type"];
var _hoisted_127 = {
  "class": "admin-drawer__row-title"
};
var _hoisted_128 = {
  key: 1,
  "class": "admin-drawer__row-meta"
};
var _hoisted_129 = ["datetime"];
var _hoisted_130 = {
  "class": "admin-drawer__row-main"
};
var _hoisted_131 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$data$contacts, _$data$data$chart, _$data$userDetail$use, _$data$userDetail$use2, _$data$userDetail$use3, _$data$userDetail$use4, _$data$userDetail$use5, _$data$userDetail$use6, _$data$userDetail$use7, _$data$userDetail$sur, _$data$userDetail$rec, _$data$userDetail$rec2, _$data$userDetail$rec3;
  var _component_Line = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("Line");
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[28] || (_cache[28] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-spinner",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.loading')), 1 /* TEXT */)])) : $data.error && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.load_error')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn",
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return $options.reload(true);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.retry')), 1 /* TEXT */)])) : $data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.eyebrow')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.greetingText), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.supporting_message')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--primary",
    onClick: _cache[1] || (_cache[1] = function () {
      return $options.openCreateUser && $options.openCreateUser.apply($options, arguments);
    })
  }, [_cache[29] || (_cache[29] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-person-plus",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.add_user')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "aria-hidden": "true"
  }, null, 2 /* CLASS */)], 8 /* PROPS */, _hoisted_10)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
    "class": "admin-reveal",
    style: {
      "--admin-delay": "20ms"
    },
    "aria-label": _ctx.t('admin.snapshot_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.snapshotCards, function (metric) {
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.value), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_15, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.label), 1 /* TEXT */), metric.hint ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.hint), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_13);
  }), 128 /* KEYED_FRAGMENT */))])], 8 /* PROPS */, _hoisted_11), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_hint')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_count', {
    n: $data.directoryUsers.length
    ...
    "onUpdate:modelValue": _cache[3] || (_cache[3] = function ($event) {
      return $data.directorySearch = $event;
    }),
    type: "search",
    "class": "admin-toolbar__search",
    placeholder: _ctx.t('admin.users_search'),
    onInput: _cache[4] || (_cache[4] = function () {
      return $options.onDirectorySearch && $options.onDirectorySearch.apply($options, arguments);
    })
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_24), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.directorySearch, void 0, {
    trim: true
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.add_user')), 1 /* TEXT */)]), $data.directoryLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_25, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.directoryError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_26, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : !$data.directoryUsers.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_27, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_28, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.directoryUsers, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-user-row", {
        'is-active': $data.selectedUserId === row.id
      }]),
      onClick: function onClick($event) {
        return $options.openUserDetail(row.id);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_30, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.email), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(row.subscription_status)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("em", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.memorised_ayahs), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("em", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_sessions')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.sessions_completed), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      datetime: row.last_activity_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.last_activity_at) || '—'), 9 /* TEXT, PROPS */, _hoisted_35)])], 10 /* CLASS, PROPS */, _hoisted_29)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_36, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_37, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_39, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_title')), 1 /* TEXT */), $options.contactInboxUrl ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "admin-link",
    href: $options.contactInboxUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_contacts')), 9 /* TEXT, PROPS */, _hoisted_40)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), !((_$data$data$contacts = $data.data.contacts) !== null && _$data$data$contacts !== void 0 && (_$data$data$contacts = _$data$data$contacts.items) !== null && _$data$data$contacts !== void 0 && _$data$data$contacts.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_41, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_42, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.contacts.items, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id,
      "class": "admin-list__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_43, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_44, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.subject || _ctx.t('admin.contact_no_subject')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_45, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.email), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_46, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-btn admin-btn--ghost admin-btn--sm",
      disabled: $data.resolvingId === item.id,
      onClick: function onClick($event) {
        return $options.resolveContact(item);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_47), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-btn admin-btn--danger admin-btn--sm",
      disabled: $data.deletingContactId === item.id,
      onClick: function onClick($event) {
        return $options.deleteContact(item);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_48)])]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_49, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_50, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_51, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[6] || (_cache[6] = function ($event) {
      return $options.openDrawer('activity');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_activity')), 1 /* TEXT */)]), !$options.previewActivity.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_52, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_53, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.previewActivity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id || "".concat(item.type, "-").concat(index)
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-feed__row",
      disabled: !item.user_id,
      onClick: function onClick($event) {
        return item.user_id && $options.openUserDetail(item.user_id);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": "admin-type",
      "data-type": item.type
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item)), 9 /* TEXT, PROPS */, _hoisted_55), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_56, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_57, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-feed__time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_59)], 8 /* PROPS */, _hoisted_54)]);
  }), 128 /* KEYED_FRAGMENT */))]))])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_61, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_62, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-range",
    role: "group",
    "aria-label": _ctx.t('admin.chart_range')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_7')), 11 /* TEXT, CLASS, PROPS */, _hoisted_64), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-btn admin-btn--ghost admin-btn--sm", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_30')), 11 /* TEXT, CLASS, PROPS */, _hoisted_65)], 8 /* PROPS */, _hoisted_63)]), $options.chartTotals ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_66, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_total_sessions', {
    n: $options.chartTotals.sessions
  })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_total_ai', {
    n: $options.chartTotals.ai_checks
  })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_total_ayahs', {
    n: $options.chartTotals.ayahs
  })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_total_users', {
    n: $options.chartTotals.new_users
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$data$chart = $data.data.chart) !== null && _$data$data$chart !== void 0 && _$data$data$chart.is_empty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_67, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_empty')), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 2,
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-chart__wrap", {
      'is-loading': $data.loading
    }])
  }, [$data.chartReady ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_Line, {
    key: $options.chartInstanceKey,
    data: $options.chartData,
    options: $options.chartOptions,
    "aria-label": _ctx.t('admin.chart_aria')
  }, null, 8 /* PROPS */, ["data", "options", "aria-label"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */))])], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $options.drawerOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
  ...
  }, null, 8 /* PROPS */, _hoisted_69), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-drawer", {
      'admin-drawer--wide': $data.drawerMode === 'user' || $data.drawerMode === 'create'
    }]),
    tabindex: "-1"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", {
    id: $options.drawerTitleId,
    "class": "admin-drawer__title"
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerTitle), 9 /* TEXT, PROPS */, _hoisted_71), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-icon-btn",
    "aria-label": _ctx.t('admin.drawer_close'),
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_72)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_73, [$data.drawerMode === 'create' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    key: 0,
    "class": "admin-form",
    onSubmit: _cache[17] || (_cache[17] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
      return $options.submitCreateUser && $options.submitCreateUser.apply($options, arguments);
    }, ["prevent"]))
    ...
    required: "",
    maxlength: "120"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.userForm.name, void 0, {
    trim: true
    ...
    required: "",
    maxlength: "255"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.userForm.email, void 0, {
    trim: true
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.userForm.password]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_locale')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[14] || (_cache[14] = function ($event) {
      return $data.userForm.locale = $event;
    })
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: loc,
      value: loc
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(loc), 9 /* TEXT, PROPS */, _hoisted_74);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.userForm.locale]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_subscription')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[15] || (_cache[15] = function ($event) {
      return $data.userForm.subscription_status = $event;
    })
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_75);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.userForm.subscription_status]])]), $data.formError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_76, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formSaving ? _ctx.t('admin.saving') : _ctx.t('admin.create_user')), 9 /* TEXT, PROPS */, _hoisted_78)])], 32 /* NEED_HYDRATION */)) : $data.drawerMode === 'user' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [$data.userDetailLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_79, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.userDetailError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_80, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : $data.userDetail ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_81, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_82, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-tabs__btn", {
      'is-active': $data.userTab === 'overview'
    }]),
    onClick: _cache[18] || (_cache[18] = function ($event) {
      return $data.userTab = 'overview';
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.tab_overview')), 3 /* TEXT, CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-tabs__btn", {
      'is-active': $data.userTab === 'edit'
    }]),
    onClick: _cache[19] || (_cache[19] = function () {
      return $options.startEditUser && $options.startEditUser.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.tab_edit')), 3 /* TEXT, CLASS */)]), $data.userTab === 'edit' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
    "class": "admin-form",
    onSubmit: _cache[26] || (_cache[26] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
      return $options.submitUpdateUser && $options.submitUpdateUser.apply($options, arguments);
    }, ["prevent"]))
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_name')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    ...
    trim: true
  }]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_password_optional')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: loc,
      value: loc
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(loc), 9 /* TEXT, PROPS */, _hoisted_83);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.userForm.locale]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_subscription')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_84);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.userForm.subscription_status]])]), $data.formError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_85, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_86, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--ghost",
    ...
    "class": "admin-btn admin-btn--primary",
    disabled: $data.formSaving
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formSaving ? _ctx.t('admin.saving') : _ctx.t('admin.save_user')), 9 /* TEXT, PROPS */, _hoisted_87)])], 32 /* NEED_HYDRATION */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_88, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.danger_zone')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user_help')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user')), 9 /* TEXT, PROPS */, _hoisted_89), $options.isSelfSelected ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_90, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_self_blocked')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_91, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(((_$data$userDetail$use = $data.userDetail.user) === null || _$data$userDetail$use === void 0 ? void 0 : _$data$userDetail$use.name) || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$userDetail$use2 = $data.userDetail.user) === null || _$data$userDetail$use2 === void 0 ? void 0 : _$data$userDetail$use2.email), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_92, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_93, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.authLabel((_$data$userDetail$use3 = $data.userDetail.user) === null || _$data$userDetail$use3 === void 0 ? void 0 : _$data$userDetail$use3.auth_provider)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_94, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel((_$data$userDetail$use4 = $data.userDetail.user) === null || _$data$userDetail$use4 === void 0 ? void 0 : _$data$userDetail$use4.subscription_status)), 1 /* TEXT */), (_$data$userDetail$use5 = $data.userDetail.user) !== null && _$data$userDetail$use5 !== void 0 && _$data$userDetail$use5.locale ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_95, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.userDetail.user.locale), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$userDetail$use6 = $data.userDetail.user) !== null && _$data$userDetail$use6 !== void 0 && _$data$userDetail$use6.created_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_96, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.joined', {
    date: $options.formatAbsoluteDate($data.userDetail.user.created_at)
  })), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_97, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.userStatCards, function (stat) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: stat.key,
      "class": "admin-user__kpi"
  ...
  }), 128 /* KEYED_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_98, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_position')), 1 /* TEXT */), (_$data$userDetail$use7 = $data.userDetail.user) !== null && _$data$userDetail$use7 !== void 0 && _$data$userDetail$use7.current_surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_99, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.userDetail.user.current_surah_name) + " ", 1 /* TEXT */), $data.userDetail.user.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
    ...
    n: $data.userDetail.user.current_ayah
  })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.userDetail.user.last_activity_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative($data.userDetail.user.last_activity_at)), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_100, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.not_started')), 1 /* TEXT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_101, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs')), 1 /* TEXT */), !((_$data$userDetail$sur = $data.userDetail.surah_progress) !== null && _$data$userDetail$sur !== void 0 && _$data$userDetail$sur.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_102, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_103, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.surah_progress, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.surah_number
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.surah_name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surah_stats', {
      memorised: row.memorised,
      learning: row.in_progress
    })), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_104, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions')), 1 /* TEXT */), !((_$data$userDetail$rec = $data.userDetail.recent_sessions) !== null && _$data$userDetail$rec !== void 0 && _$data$userDetail$rec.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_105, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_106, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_sessions, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.sessionLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      datetime: row.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_107)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_108, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai')), 1 /* TEXT */), !((_$data$userDetail$rec2 = $data.userDetail.recent_ai_checks) !== null && _$data$userDetail$rec2 !== void 0 && _$data$userDetail$rec2.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_109, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_110, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_ai_checks, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.aiLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      datetime: row.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_111)]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_112, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes')), 1 /* TEXT */), !((_$data$userDetail$rec3 = $data.userDetail.recent_notes) !== null && _$data$userDetail$rec3 !== void 0 && _$data$userDetail$rec3.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_113, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_114, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.userDetail.recent_notes, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id,
      "class": "admin-mini-list__stack"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_115, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-link",
      disabled: $data.deletingNoteId === row.id,
      onClick: function onClick($event) {
        return $options.deleteNote(row);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_116)]), row.snippet ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_117, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.snippet), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
  }), 128 /* KEYED_FRAGMENT */))]))])], 64 /* STABLE_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 2
  }, [$data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    "class": "admin-filters",
    role: "group",
    "aria-label": _ctx.t('admin.activity_filter')
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_119);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_118)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_120, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_121, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : !$options.filteredDrawerItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_122, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerEmptyMessage), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_123, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.filteredDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: $options.drawerItemKey(item),
      "class": "admin-drawer__row"
    }, [$data.drawerMode !== 'contacts' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 0,
      type: "button",
      "class": "admin-drawer__hit",
      onClick: function onClick($event) {
        return $options.onDrawerItemClick(item);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_125, [$data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      key: 0,
      "class": "admin-type",
      "data-type": item.type
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item)), 9 /* TEXT, PROPS */, _hoisted_126)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_127, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemTitle(item)), 1 /* TEXT */), $options.drawerItemMeta(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_128, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemMeta(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $options.drawerItemTime(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("time", {
      key: 0,
      "class": "admin-drawer__row-time",
      datetime: $options.drawerItemTime(item)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate($options.drawerItemTime(item))), 9 /* TEXT, PROPS */, _hoisted_129)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_124)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 1
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_130, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_131, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemTitle(item)), 1 /* TEXT */), $options.drawerItemMeta(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_132, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemMeta(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_133, [item.status === 'pending' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 0,
      type: "button",
      "class": "admin-btn admin-btn--ghost admin-btn--sm",
      disabled: $data.resolvingId === item.id,
      onClick: function onClick($event) {
        return $options.resolveContact(item, true);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_134)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-btn admin-btn--danger admin-btn--sm",
      disabled: $data.deletingContactId === item.id,
      onClick: function onClick($event) {
        return $options.deleteContact(item, true);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_135)])], 64 /* STABLE_FRAGMENT */))]);
  }), 128 /* KEYED_FRAGMENT */))]))], 64 /* STABLE_FRAGMENT */))])], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_68)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
}
...
var adminApi = {
  ...
  getUsers: function getUsers() {
    var _arguments2 = arguments;
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var _ref, _ref$limit, limit, _ref$q, q, _yield$withRetry2, data;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _ref = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : {}, _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 100 : _ref$limit, _ref$q = _ref.q, q = _ref$q === void 0 ? '' : _ref$q;
            _context2.n = 1;
            return (0,_learning__WEBPACK_IMPORTED_MODULE_0__.withRetry)(function () {
          ...
          case 1:
            ...
            return _context2.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.users) ? data.users : []);
        }
      }, _callee2);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          ...
          case 1:
            _yield$withRetry3 = _context3.v;
            data = _yield$withRetry3.data;
            return _context3.a(2, data && _typeof(data) === 'object' ? data : null);
        }
      }, _callee3);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          ...
          case 1:
            _yield$http$post = _context4.v;
            data = _yield$http$post.data;
            return _context4.a(2, (data === null || data === void 0 ? void 0 : data.user) || null);
        }
      }, _callee4);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          ...
          case 1:
            _yield$http$patch = _context5.v;
            data = _yield$http$patch.data;
            return _context5.a(2, data && _typeof(data) === 'object' ? data : null);
        }
      }, _callee5);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          ...
          case 1:
            _yield$http$delete = _context6.v;
            data = _yield$http$delete.data;
            return _context6.a(2, !!(data !== null && data !== void 0 && data.deleted));
        }
      }, _callee6);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
      ...
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.n) {
          ...
          case 1:
            _yield$http$delete2 = _context7.v;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
      ...
      return _regenerator().w(function (_context8) {
        while (1) switch (_context8.n) {
          ...
          case 1:
            _yield$withRetry4 = _context8.v;
            data = _yield$withRetry4.data;
            return _context8.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.activity) ? data.activity : []);
        }
      }, _callee8);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.n) {
          ...
          case 1:
            _yield$withRetry5 = _context9.v;
            data = _yield$withRetry5.data;
            return _context9.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.sessions) ? data.sessions : []);
        }
      }, _callee9);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
      ...
      return _regenerator().w(function (_context0) {
        while (1) switch (_context0.n) {
          ...
          case 1:
            _yield$withRetry6 = _context0.v;
            data = _yield$withRetry6.data;
            return _context0.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.attempts) ? data.attempts : []);
        }
      }, _callee0);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
      ...
      return _regenerator().w(function (_context1) {
        while (1) switch (_context1.n) {
          ...
          case 1:
            _yield$withRetry7 = _context1.v;
            data = _yield$withRetry7.data;
            return _context1.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.notes) ? data.notes : []);
        }
      }, _callee1);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
      ...
      return _regenerator().w(function (_context10) {
        while (1) switch (_context10.n) {
          ...
          case 1:
            _yield$withRetry8 = _context10.v;
            data = _yield$withRetry8.data;
            return _context10.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.contacts) ? data.contacts : []);
        }
      }, _callee10);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
      ...
      return _regenerator().w(function (_context11) {
        while (1) switch (_context11.n) {
          ...
          case 1:
            _yield$http$patch2 = _context11.v;
            data = _yield$http$patch2.data;
            return _context11.a(2, (data === null || data === void 0 ? void 0 : data.contact) || null);
        }
      }, _callee11);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
      ...
      return _regenerator().w(function (_context12) {
        while (1) switch (_context12.n) {
          ...
          case 1:
            _yield$http$delete3 = _context12.v;
            data = _yield$http$delete3.data;
            return _context12.a(2, !!(data !== null && data !== void 0 && data.deleted));
        }
      }, _callee12);
    }))();
  }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Super Admin ops shell — focused oversight layout. */\n.admin-dashboard {\n  --dash-cream: #f2ebe3;\n  --dash-sand: #e8ded1;\n  --dash-ink: #3c3530;\n  --dash-muted: #6d6258;\n  --dash-line: rgba(60, 53, 48, 0.14);\n  --dash-soft: #faf6f1;\n  --dash-card: #fffdfb;\n  --dash-shadow: 0 1px 2px rgba(60, 53, 48, 0.05), 0 10px 24px rgba(60, 53, 48, 0.07);\n  --dash-shadow-soft: 0 1px 2px rgba(60, 53, 48, 0.04), 0 6px 14px rgba(60, 53, 48, 0.05);\n  --dash-ease: var(--ease-out, cubic-bezier(0.22, 1, 0.36, 1));\n  --dash-radius: 16px;\n  --dash-radius-sm: 12px;\n  --dash-font: var(--font-ui, \"Avenir Next\", \"Segoe UI\", sans-serif);\n  --dash-serif: \"Iowan Old Style\", \"Palatino Linotype\", Palatino, Georgia, \"Times New Roman\", serif;\n  --admin-accent: #5c6b4a;\n  --admin-accent-soft: color-mix(in srgb, var(--admin-accent) 14%, var(--dash-soft));\n  padding: 1rem 0 2.5rem;\n  color: var(--dash-ink);\n  font-family: var(--dash-font);\n  font-size: 0.92rem;\n  font-weight: 400;\n  line-height: 1.45;\n  background:\n    radial-gradient(70% 40% at 92% 0%, color-mix(in srgb, var(--admin-accent) 10%, transparent), transparent 62%),\n    radial-gradient(80% 45% at 8% 0%, color-mix(in srgb, var(--dash-sand) 50%, transparent), transparent 68%),\n    var(--dash-cream);\n}\n\nhtml[data-theme=\"dark\"] .admin-dashboard {\n  --dash-cream: #171411;\n  --dash-sand: #2a241f;\n  --dash-ink: #f0e7dc;\n  --dash-muted: #b7a99a;\n  --dash-line: rgba(240, 231, 220, 0.12);\n  --dash-soft: #1e1a16;\n  --dash-card: #221e1a;\n  --dash-shadow: 0 1px 2px rgba(0, 0, 0, 0.3), 0 12px 28px rgba(0, 0, 0, 0.28);\n  --dash-shadow-soft: 0 1px 2px rgba(0, 0, 0, 0.24), 0 8px 16px rgba(0, 0, 0, 0.2);\n  --admin-accent: #8fa37a;\n  --admin-accent-soft: color-mix(in srgb, var(--admin-accent) 16%, var(--dash-soft));\n}\n\n.admin-dashboard__shell {\n  width: 100%;\n  max-width: 1120px;\n  padding-inline: clamp(1rem, 3vw, 1.5rem);\n  margin-inline: auto;\n  display: grid;\n  gap: 1rem;\n}\n\n.admin-dashboard__loading,\n.admin-dashboard__error {\n  display: grid;\n  place-items: center;\n  gap: 0.55rem;\n  min-height: 8.5rem;\n  padding: 1.5rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius);\n  background: var(--dash-card);\n  box-shadow: var(--dash-shadow-soft);\n  color: var(--dash-muted);\n  text-align: center;\n}\n\n.admin-dashboard__error {\n  color: #8b4a3c;\n}\n\nhtml[data-theme=\"dark\"] .admin-dashboard__error {\n  color: #e0a090;\n}\n\n.admin-spinner {\n  width: 1.2rem;\n  height: 1.2rem;\n  border-radius: 50%;\n  border: 2px solid color-mix(in srgb, var(--dash-sand) 80%, transparent);\n  border-top-color: var(--dash-ink);\n  animation: admin-spin 0.7s linear infinite;\n}\n\n.is-spinning {\n  display: inline-block;\n  animation: admin-spin 0.8s linear infinite;\n}\n\n@keyframes admin-spin {\n  to { transform: rotate(360deg); }\n}\n\n@keyframes admin-rise {\n  from { opacity: 0; transform: translateY(6px); }\n  to { opacity: 1; transform: translateY(0); }\n}\n\n.admin-reveal {\n  animation: admin-rise 260ms var(--dash-ease) both;\n  animation-delay: var(--admin-delay, 0ms);\n}\n\n.admin-panel,\n.admin-hero {\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius);\n  background: var(--dash-card);\n  box-shadow: var(--dash-shadow);\n  padding: 1.05rem 1.1rem;\n}\n\n.admin-hero {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.85rem 1rem;\n  background: linear-gradient(155deg, var(--admin-accent-soft), var(--dash-card) 58%);\n}\n\n.admin-hero__copy {\n  min-width: 0;\n  flex: 1 1 16rem;\n}\n\n.admin-hero__sub {\n  margin: 0.4rem 0 0;\n  max-width: 34rem;\n  color: var(--dash-muted);\n  font-size: 0.86rem;\n}\n\n.admin-hero__actions {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.45rem;\n  flex-shrink: 0;\n}\n\n.admin-eyebrow {\n  display: inline-block;\n  margin: 0;\n  font-size: 0.7rem;\n  font-weight: 600;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: var(--admin-accent);\n}\n\n.admin-hero h1 {\n  margin: 0.25rem 0 0;\n  font-family: var(--dash-serif);\n  font-size: clamp(1.45rem, 3.2vw, 1.9rem);\n  font-weight: 500;\n  letter-spacing: -0.02em;\n  line-height: 1.15;\n  color: var(--dash-ink);\n}\n\n.admin-icon-btn,\n.admin-btn {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 1px solid var(--dash-line);\n  background: var(--dash-soft);\n  color: var(--dash-ink);\n  border-radius: 999px;\n  font: inherit;\n  cursor: pointer;\n  transition: background 160ms var(--dash-ease), border-color 160ms var(--dash-ease);\n}\n\n.admin-icon-btn {\n  width: 2.3rem;\n  height: 2.3rem;\n  display: inline-grid;\n  place-items: center;\n  flex-shrink: 0;\n}\n\n.admin-icon-btn:hover,\n.admin-icon-btn:focus-visible,\n.admin-btn:hover,\n.admin-btn:focus-visible {\n  background: var(--dash-card);\n  border-color: color-mix(in srgb, var(--dash-line) 60%, var(--dash-ink));\n}\n\n.admin-icon-btn:disabled,\n.admin-btn:disabled {\n  opacity: 0.55;\n  cursor: not-allowed;\n}\n\n.admin-btn {\n  min-height: 2rem;\n  padding: 0.35rem 0.85rem;\n  font-size: 0.8rem;\n  font-weight: 500;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n\n.admin-btn--ghost {\n  background: transparent;\n}\n\n.admin-btn--primary {\n  background: var(--admin-accent);\n  border-color: color-mix(in srgb, var(--admin-accent) 70%, var(--dash-ink));\n  color: #fffdf8;\n}\n\n.admin-btn--primary:hover,\n.admin-btn--primary:focus-visible {\n  background: color-mix(in srgb, var(--admin-accent) 88%, var(--dash-ink));\n  border-color: color-mix(in srgb, var(--admin-accent) 55%, var(--dash-ink));\n  color: #fffdf8;\n}\n\n.admin-btn--danger {\n  background: transparent;\n  border-color: color-mix(in srgb, #8b4a3c 45%, var(--dash-line));\n  color: #8b4a3c;\n}\n\n.admin-btn--danger:hover,\n.admin-btn--danger:focus-visible {\n  background: color-mix(in srgb, #8b4a3c 10%, var(--dash-soft));\n}\n\nhtml[data-theme=\"dark\"] .admin-btn--danger {\n  color: #e0a090;\n  border-color: color-mix(in srgb, #e0a090 40%, var(--dash-line));\n}\n\n.admin-btn--sm {\n  min-height: 1.85rem;\n  padding: 0.28rem 0.7rem;\n  font-size: 0.76rem;\n}\n\n.admin-btn.is-active {\n  background: var(--dash-card);\n  border-color: color-mix(in srgb, var(--dash-line) 55%, var(--dash-ink));\n  box-shadow: var(--dash-shadow-soft);\n}\n\n.admin-kpis {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 0.55rem;\n}\n\n@media (min-width: 560px) {\n  .admin-kpis {\n    grid-template-columns: repeat(3, minmax(0, 1fr));\n  }\n}\n\n@media (min-width: 820px) {\n  .admin-kpis {\n    grid-template-columns: repeat(5, minmax(0, 1fr));\n  }\n}\n\n.admin-kpi {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  box-shadow: var(--dash-shadow-soft);\n  padding: 0.8rem 0.75rem;\n  text-align: left;\n  cursor: pointer;\n  color: inherit;\n  font: inherit;\n  transition: transform 160ms var(--dash-ease), border-color 160ms var(--dash-ease), background 160ms var(--dash-ease);\n}\n\n.admin-kpi:hover,\n.admin-kpi:focus-visible {\n  background: var(--dash-card);\n  border-color: color-mix(in srgb, var(--dash-line) 55%, var(--admin-accent));\n  transform: translateY(-1px);\n}\n\n.admin-kpi__value {\n  margin: 0;\n  font-size: 1.3rem;\n  font-weight: 600;\n  font-variant-numeric: tabular-nums;\n  line-height: 1.1;\n  color: var(--dash-ink);\n}\n\n.admin-kpi__label {\n  margin: 0.28rem 0 0;\n  color: var(--dash-muted);\n  font-size: 0.72rem;\n  font-weight: 500;\n  line-height: 1.25;\n}\n\n.admin-kpi__hint {\n  margin: 0.18rem 0 0;\n  color: var(--admin-accent);\n  font-size: 0.68rem;\n  font-weight: 500;\n}\n\n.admin-panel__head {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.55rem 1rem;\n  margin-bottom: 0.8rem;\n}\n\n.admin-panel__head h2 {\n  margin: 0;\n  font-family: var(--dash-serif);\n  font-size: 1.15rem;\n  font-weight: 500;\n  color: var(--dash-ink);\n}\n\n.admin-panel__head--chart {\n  margin-bottom: 0.65rem;\n}\n\n.admin-link {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 0;\n  background: transparent;\n  color: var(--dash-muted);\n  font: inherit;\n  font-size: 0.8rem;\n  font-weight: 500;\n  cursor: pointer;\n  text-decoration: none;\n  padding: 0.15rem 0 0;\n}\n\n.admin-link:hover,\n.admin-link:focus-visible {\n  color: var(--dash-ink);\n  text-decoration: underline;\n}\n\n.admin-empty {\n  margin: 0;\n  padding: 1.25rem 0.5rem;\n  text-align: center;\n  color: var(--dash-muted);\n  font-size: 0.84rem;\n}\n\n.admin-learners {\n  display: grid;\n  gap: 0.5rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.admin-panel__lede {\n  margin: 0.25rem 0 0;\n  color: var(--dash-muted);\n  font-size: 0.8rem;\n}\n\n.admin-panel--primary {\n  min-height: 22rem;\n}\n\n.admin-workspace {\n  display: grid;\n  gap: 1rem;\n}\n\n@media (min-width: 960px) {\n  .admin-workspace {\n    grid-template-columns: minmax(0, 1.55fr) minmax(0, 1fr);\n    align-items: start;\n  }\n}\n\n.admin-ops {\n  display: grid;\n  gap: 1rem;\n}\n\n.admin-count {\n  color: var(--dash-muted);\n  font-size: 0.78rem;\n  font-weight: 500;\n  white-space: nowrap;\n}\n\n.admin-toolbar {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.55rem;\n  margin: 0.85rem 0 0.75rem;\n}\n\n.admin-toolbar__search {\n  flex: 1 1 12rem;\n  min-width: 0;\n  padding: 0.55rem 0.75rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  color: var(--dash-ink);\n  font: inherit;\n  font-size: 0.86rem;\n}\n\n.admin-users {\n  display: grid;\n  gap: 0.45rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  max-height: min(34rem, 70vh);\n  overflow: auto;\n}\n\n.admin-user-row {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  width: 100%;\n  display: grid;\n  gap: 0.5rem;\n  padding: 0.8rem 0.85rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  color: inherit;\n  font: inherit;\n  text-align: left;\n  cursor: pointer;\n  transition: border-color 160ms var(--dash-ease), background 160ms var(--dash-ease);\n}\n\n.admin-user-row:hover,\n.admin-user-row:focus-visible,\n.admin-user-row.is-active {\n  background: var(--dash-card);\n  border-color: color-mix(in srgb, var(--dash-line) 50%, var(--admin-accent));\n}\n\n.admin-user-row__who {\n  display: grid;\n  gap: 0.12rem;\n  min-width: 0;\n}\n\n.admin-user-row__who strong {\n  font-weight: 550;\n  color: var(--dash-ink);\n  font-size: 0.92rem;\n}\n\n.admin-user-row__who span {\n  color: var(--dash-muted);\n  font-size: 0.76rem;\n  word-break: break-word;\n}\n\n.admin-user-row__meta {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 0.4rem 0.65rem;\n}\n\n.admin-user-row__stat {\n  display: inline-flex;\n  align-items: baseline;\n  gap: 0.28rem;\n  font-variant-numeric: tabular-nums;\n  font-size: 0.8rem;\n  color: var(--dash-ink);\n  font-weight: 500;\n}\n\n.admin-user-row__stat em {\n  font-style: normal;\n  color: var(--dash-muted);\n  font-size: 0.68rem;\n  font-weight: 500;\n}\n\n.admin-user-row__meta time {\n  margin-inline-start: auto;\n  color: var(--dash-muted);\n  font-size: 0.72rem;\n  white-space: nowrap;\n}\n\n.admin-pill {\n  display: inline-flex;\n  align-items: center;\n  max-width: 100%;\n  padding: 0.18rem 0.5rem;\n  border-radius: 999px;\n  background: var(--dash-card);\n  border: 1px solid var(--dash-line);\n  color: var(--dash-muted);\n  font-size: 0.7rem;\n  font-weight: 500;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.admin-split {\n  display: grid;\n  gap: 0.9rem;\n}\n\n@media (min-width: 820px) {\n  .admin-split {\n    grid-template-columns: repeat(2, minmax(0, 1fr));\n    align-items: start;\n  }\n}\n\n.admin-list {\n  display: grid;\n  gap: 0.5rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.admin-list__row {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.65rem;\n  padding: 0.75rem 0.8rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n}\n\n.admin-list__main {\n  display: grid;\n  gap: 0.18rem;\n  min-width: 0;\n}\n\n.admin-list__title {\n  color: var(--dash-ink);\n  font-size: 0.88rem;\n  font-weight: 500;\n  line-height: 1.3;\n}\n\n.admin-list__meta {\n  color: var(--dash-muted);\n  font-size: 0.76rem;\n  line-height: 1.35;\n  word-break: break-word;\n}\n\n.admin-list__time {\n  flex-shrink: 0;\n  color: var(--dash-muted);\n  font-size: 0.72rem;\n  white-space: nowrap;\n}\n\n.admin-list__actions {\n  display: inline-flex;\n  flex-direction: column;\n  align-items: flex-end;\n  gap: 0.35rem;\n  flex: 0 0 auto;\n}\n\n@media (min-width: 480px) {\n  .admin-list__actions {\n    flex-direction: row;\n    align-items: center;\n  }\n}\n\n.admin-feed {\n  display: grid;\n  gap: 0.4rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.admin-feed__row {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  width: 100%;\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr) auto;\n  align-items: start;\n  gap: 0.55rem;\n  padding: 0.65rem 0.7rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  color: inherit;\n  font: inherit;\n  text-align: left;\n  cursor: pointer;\n  transition: background 160ms var(--dash-ease), border-color 160ms var(--dash-ease);\n}\n\n.admin-feed__row:hover:not(:disabled),\n.admin-feed__row:focus-visible:not(:disabled) {\n  background: var(--dash-card);\n  border-color: color-mix(in srgb, var(--dash-line) 55%, var(--admin-accent));\n}\n\n.admin-feed__row:disabled {\n  cursor: default;\n  opacity: 1;\n}\n\n.admin-feed__main {\n  display: grid;\n  gap: 0.12rem;\n  min-width: 0;\n}\n\n.admin-feed__title {\n  color: var(--dash-ink);\n  font-size: 0.84rem;\n  font-weight: 500;\n  line-height: 1.3;\n}\n\n.admin-feed__meta {\n  color: var(--dash-muted);\n  font-size: 0.74rem;\n}\n\n.admin-feed__time {\n  color: var(--dash-muted);\n  font-size: 0.7rem;\n  white-space: nowrap;\n}\n\n.admin-type {\n  display: inline-flex;\n  align-items: center;\n  padding: 0.16rem 0.42rem;\n  border-radius: 999px;\n  border: 1px solid var(--dash-line);\n  background: var(--dash-card);\n  color: var(--dash-muted);\n  font-size: 0.64rem;\n  font-weight: 600;\n  letter-spacing: 0.02em;\n  text-transform: uppercase;\n  white-space: nowrap;\n}\n\n.admin-type[data-type=\"session\"] {\n  color: var(--admin-accent);\n  border-color: color-mix(in srgb, var(--admin-accent) 35%, var(--dash-line));\n}\n\n.admin-type[data-type=\"ai_check\"] {\n  color: #b45a3c;\n  border-color: color-mix(in srgb, #b45a3c 30%, var(--dash-line));\n}\n\nhtml[data-theme=\"dark\"] .admin-type[data-type=\"ai_check\"] {\n  color: #e09878;\n}\n\n.admin-type[data-type=\"user_joined\"] {\n  color: var(--dash-ink);\n}\n\n.admin-range {\n  display: inline-flex;\n  gap: 0.25rem;\n  padding: 0.22rem;\n  border: 1px solid var(--dash-line);\n  border-radius: 999px;\n  background: var(--dash-soft);\n}\n\n.admin-chart__totals {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.4rem 0.85rem;\n  margin: 0 0 0.7rem;\n  color: var(--dash-muted);\n  font-size: 0.76rem;\n  font-weight: 500;\n}\n\n.admin-chart__wrap {\n  height: 200px;\n  min-height: 200px;\n}\n\n.admin-chart__wrap.is-loading {\n  opacity: 0.55;\n}\n\n.admin-chart__empty {\n  display: grid;\n  place-items: center;\n  min-height: 140px;\n  color: var(--dash-muted);\n  font-size: 0.84rem;\n  text-align: center;\n}\n\n/* Drawer */\n.admin-drawer-root {\n  position: fixed;\n  inset: 0;\n  z-index: 80;\n  display: grid;\n  justify-items: end;\n}\n\n.admin-drawer__backdrop {\n  position: absolute;\n  inset: 0;\n  border: 0;\n  background: rgba(30, 24, 18, 0.42);\n  cursor: pointer;\n}\n\nhtml[data-theme=\"dark\"] .admin-drawer__backdrop {\n  background: rgba(0, 0, 0, 0.55);\n}\n\n.admin-drawer {\n  position: relative;\n  z-index: 1;\n  display: flex;\n  flex-direction: column;\n  width: min(28rem, 100%);\n  height: 100%;\n  background: var(--dash-cream);\n  border-left: 1px solid var(--dash-line);\n  box-shadow: var(--dash-shadow);\n  overflow: hidden;\n}\n\n.admin-drawer--wide {\n  width: min(34rem, 100%);\n}\n\n.admin-filters {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.35rem;\n  margin: 0 0 0.85rem;\n}\n\n.admin-drawer__head {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.75rem;\n  padding: 0.95rem 1.05rem;\n  border-bottom: 1px solid var(--dash-line);\n  background: var(--dash-card);\n}\n\n.admin-drawer__title {\n  margin: 0;\n  font-family: var(--dash-serif);\n  font-size: 1.15rem;\n  font-weight: 500;\n}\n\n.admin-drawer__body {\n  flex: 1;\n  overflow: auto;\n  padding: 0.85rem 1rem 1.25rem;\n}\n\n.admin-drawer__search {\n  width: 100%;\n  margin: 0 0 0.85rem;\n  padding: 0.55rem 0.75rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  color: var(--dash-ink);\n  font: inherit;\n  font-size: 0.86rem;\n}\n\n.admin-drawer__status {\n  margin: 2.5rem 0 0;\n  text-align: center;\n  color: var(--dash-muted);\n  font-size: 0.88rem;\n}\n\n.admin-drawer__list {\n  display: grid;\n  gap: 0.5rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.admin-drawer__row {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.65rem;\n  padding: 0;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  overflow: hidden;\n}\n\n.admin-drawer__hit {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  width: 100%;\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.65rem;\n  padding: 0.8rem 0.85rem;\n  border: 0;\n  background: transparent;\n  color: inherit;\n  font: inherit;\n  text-align: left;\n  cursor: pointer;\n}\n\n.admin-drawer__hit:hover,\n.admin-drawer__hit:focus-visible {\n  background: var(--dash-card);\n}\n\n.admin-drawer__row > .admin-drawer__row-main,\n.admin-drawer__row > .admin-list__actions {\n  padding: 0.8rem 0.85rem;\n}\n\n.admin-drawer__row-main {\n  display: grid;\n  gap: 0.18rem;\n  min-width: 0;\n}\n\n.admin-drawer__row-title {\n  color: var(--dash-ink);\n  font-size: 0.9rem;\n  font-weight: 500;\n  line-height: 1.3;\n}\n\n.admin-drawer__row-meta {\n  color: var(--dash-muted);\n  font-size: 0.76rem;\n  line-height: 1.35;\n  word-break: break-word;\n}\n\n.admin-drawer__row-time {\n  flex-shrink: 0;\n  color: var(--dash-muted);\n  font-size: 0.72rem;\n  white-space: nowrap;\n}\n\n.admin-user {\n  display: grid;\n  gap: 1rem;\n}\n\n.admin-user__profile {\n  display: grid;\n  gap: 0.2rem;\n}\n\n.admin-user__profile strong {\n  font-size: 1.05rem;\n  font-weight: 550;\n  color: var(--dash-ink);\n}\n\n.admin-user__profile > span {\n  color: var(--dash-muted);\n  font-size: 0.84rem;\n  word-break: break-word;\n}\n\n.admin-user__tags {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.35rem;\n  margin-top: 0.45rem;\n}\n\n.admin-user__kpis {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 0.45rem;\n}\n\n@media (min-width: 480px) {\n  .admin-user__kpis {\n    grid-template-columns: repeat(3, minmax(0, 1fr));\n  }\n}\n\n.admin-user__kpi {\n  display: grid;\n  gap: 0.15rem;\n  padding: 0.65rem 0.7rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n}\n\n.admin-user__kpi strong {\n  font-size: 1.05rem;\n  font-variant-numeric: tabular-nums;\n  color: var(--dash-ink);\n}\n\n.admin-user__kpi span {\n  color: var(--dash-muted);\n  font-size: 0.7rem;\n  font-weight: 500;\n}\n\n.admin-user__block h3 {\n  margin: 0 0 0.45rem;\n  font-size: 0.72rem;\n  font-weight: 600;\n  letter-spacing: 0.05em;\n  text-transform: uppercase;\n  color: var(--dash-muted);\n}\n\n.admin-user__copy {\n  margin: 0;\n  font-size: 0.88rem;\n  color: var(--dash-ink);\n}\n\n.admin-user__copy--muted {\n  color: var(--dash-muted);\n}\n\n.admin-user__snippet {\n  margin: 0.2rem 0 0;\n  color: var(--dash-muted);\n  font-size: 0.78rem;\n  line-height: 1.4;\n}\n\n.admin-mini-list {\n  display: grid;\n  gap: 0.4rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.admin-mini-list > li {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.65rem;\n  padding: 0.55rem 0.65rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  font-size: 0.8rem;\n}\n\n.admin-mini-list > li span {\n  color: var(--dash-ink);\n  min-width: 0;\n}\n\n.admin-mini-list > li strong,\n.admin-mini-list > li time {\n  color: var(--dash-muted);\n  font-weight: 500;\n  white-space: nowrap;\n  flex-shrink: 0;\n}\n\n.admin-mini-list__stack {\n  flex-direction: column;\n}\n\n.admin-mini-list__top {\n  display: flex;\n  justify-content: space-between;\n  gap: 0.65rem;\n  width: 100%;\n}\n\n.admin-tabs {\n  display: inline-flex;\n  gap: 0.25rem;\n  padding: 0.22rem;\n  border: 1px solid var(--dash-line);\n  border-radius: 999px;\n  background: var(--dash-soft);\n  margin-bottom: 0.25rem;\n}\n\n.admin-tabs__btn {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 0;\n  background: transparent;\n  color: var(--dash-muted);\n  border-radius: 999px;\n  padding: 0.35rem 0.75rem;\n  font: inherit;\n  font-size: 0.78rem;\n  font-weight: 500;\n  cursor: pointer;\n}\n\n.admin-tabs__btn.is-active {\n  background: var(--dash-card);\n  color: var(--dash-ink);\n  box-shadow: var(--dash-shadow-soft);\n}\n\n.admin-form {\n  display: grid;\n  gap: 0.75rem;\n}\n\n.admin-form label {\n  display: grid;\n  gap: 0.3rem;\n}\n\n.admin-form label > span {\n  color: var(--dash-muted);\n  font-size: 0.74rem;\n  font-weight: 600;\n}\n\n.admin-form input,\n.admin-form select {\n  width: 100%;\n  padding: 0.55rem 0.7rem;\n  border: 1px solid var(--dash-line);\n  border-radius: var(--dash-radius-sm);\n  background: var(--dash-soft);\n  color: var(--dash-ink);\n  font: inherit;\n  font-size: 0.88rem;\n}\n\n.admin-form__actions {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: flex-end;\n  gap: 0.45rem;\n  margin-top: 0.25rem;\n}\n\n.admin-form__error {\n  margin: 0;\n  color: #8b4a3c;\n  font-size: 0.82rem;\n}\n\nhtml[data-theme=\"dark\"] .admin-form__error {\n  color: #e0a090;\n}\n\n.admin-form__hint {\n  margin: 0.45rem 0 0;\n  color: var(--dash-muted);\n  font-size: 0.76rem;\n}\n\n.admin-danger-zone {\n  margin-top: 1.25rem;\n  padding: 0.9rem;\n  border: 1px solid color-mix(in srgb, #8b4a3c 30%, var(--dash-line));\n  border-radius: var(--dash-radius-sm);\n  background: color-mix(in srgb, #8b4a3c 6%, var(--dash-soft));\n}\n\n.admin-danger-zone h3 {\n  margin: 0 0 0.35rem;\n  font-size: 0.78rem;\n  font-weight: 600;\n  color: #8b4a3c;\n}\n\nhtml[data-theme=\"dark\"] .admin-danger-zone h3 {\n  color: #e0a090;\n}\n\n.admin-danger-zone p {\n  margin: 0 0 0.7rem;\n  color: var(--dash-muted);\n  font-size: 0.8rem;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .admin-reveal,\n  .admin-kpi,\n  .admin-spinner,\n  .is-spinning {\n    animation: none !important;\n    transition: none !important;\n  }\n}\n", ""]);
// Exports
