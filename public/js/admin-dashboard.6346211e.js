...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    aiBands: function aiBands() {
      var _this$data4;
      var bands = Array.isArray((_this$data4 = this.data) === null || _this$data4 === void 0 || (_this$data4 = _this$data4.ai_health) === null || _this$data4 === void 0 ? void 0 : _this$data4.bands) ? this.data.ai_health.bands : [];
      var total = bands.reduce(function (sum, row) {
      ...
      return bands.map(function (row) {
        return {
          ...
          width: "".concat(Math.max(3, Math.round(Number(row.value || 0) / total * 100)), "%")
        };
      });
    },
    chartInstanceKey: function chartInstanceKey() {
      var _this$data5, _points$, _points$at;
      var points = ((_this$data5 = this.data) === null || _this$data5 === void 0 || (_this$data5 = _this$data5.chart) === null || _this$data5 === void 0 ? void 0 : _this$data5.points) || [];
      return "admin-chart-".concat(this.chartDays, "-").concat(points.length, "-").concat(((_points$ = points[0]) === null || _points$ === void 0 ? void 0 : _points$.date) || 'x', "-").concat(((_points$at = points.at) === null || _points$at === void 0 || (_points$at = _points$at.call(points, -1)) === null || _points$at === void 0 ? void 0 : _points$at.date) || 'y');
    },
    ...
    chartData: function chartData() {
      var _this$data6,
        _this2 = this;
      var points = ((_this$data6 = this.data) === null || _this$data6 === void 0 || (_this$data6 = _this$data6.chart) === null || _this$data6 === void 0 ? void 0 : _this$data6.points) || [];
      ...
      return {
        ...
        datasets: [{
          label: this.t('admin.chart_ayahs'),
          data: points.map(function (point) {
            return Number(point.primary || 0);
          }),
          ...
          data: points.map(function (point) {
            return Number(point.secondary || 0);
          }),
          ...
          tooltip: {
            ...
            callbacks: {
              title: function title(items) {
                ...
                return _this3.t('admin.chart_tooltip', {
                  date: _this3.tooltipDate(point.date),
                  ayahs: Number(point.primary || 0),
                  sessions: Number(point.secondary || 0)
                });
              },
    ...
    weekSummaryText: function weekSummaryText() {
      var _this$data8;
      var week = (_this$data8 = this.data) === null || _this$data8 === void 0 ? void 0 : _this$data8.week_summary;
      if (!week || week.is_empty) return this.t('admin.week_summary_empty');
      return this.t('admin.week_summary', {
        sessions: Number(week.sessions || 0),
        ai_checks: Number(week.ai_checks || 0),
        ayahs: Number(week.ayahs || 0),
        new_users: Number(week.new_users || 0)
      });
    }
  },
  ...
  methods: {
    ...
    bandLabel: function bandLabel(key) {
      var k = String(key || '').toLowerCase();
      if (k === 'strong') return this.t('admin.result_strong');
      if (k === 'mixed') return this.t('admin.result_mixed');
      if (k === 'weak') return this.t('admin.result_weak');
      return this.t('admin.result_unknown');
    },
    ...
    drawerItemTitle: function drawerItemTitle(item) {
      ...
      if (this.drawerMode === 'notes') {
        return "".concat(item.user_name || item.user_email || '', " \xB7 ").concat(item.surah_name || '', " \xB7 ").concat(this.t('admin.ayah_n', {
          n: item.ayah_number
        }));
      }
    ...
    drawerItemMeta: function drawerItemMeta(item) {
      ...
      if (this.drawerMode === 'notes') return item.snippet || this.t('admin.outcome_note_saved');
      if (this.drawerMode === 'ai_checks') {
        return this.activityOutcome({
          outcome_key: item.band || item.accuracy_percent != null ? 'ai_result' : 'ai_check',
          outcome_params: {
            band: item.band,
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 6:
              ...
              _context.n = 7;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getAiChecks();
            case 7:
              items = _context.v;
              _context.n = 14;
              break;
            case 8:
              ...
              _context.n = 9;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getNotes();
            case 9:
              items = _context.v;
              _context.n = 14;
              break;
            ...
            case 12:
              ...
              _context.n = 13;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getActivity();
            case 13:
              items = _context.v;
            case 14:
            ...
            case 16:
              _context.p = 16;
              _t = _context.v;
              console.error('Admin drawer fetch failed', _t);
              if (!(requestId !== _this5.drawerRequestId)) {
                _context.n = 17;
                break;
              }
    ...
    onUserSearch: function onUserSearch() {
      var _this6 = this;
      if (this.userSearchTimer) clearTimeout(this.userSearchTimer);
      this.userSearchTimer = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var requestId, items, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              if (!(_this6.drawerMode !== 'users')) {
                _context2.n = 1;
                break;
              }
    ...
    resolveContact: function resolveContact(item) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var fromDrawer, _this7$data, _this7$data2, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 1:
              _this7.resolvingId = item.id;
              _context3.p = 2;
              _context3.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.resolveContact(item.id);
            case 3:
              if ((_this7$data = _this7.data) !== null && _this7$data !== void 0 && (_this7$data = _this7$data.contacts) !== null && _this7$data !== void 0 && _this7$data.items) {
                _this7.data.contacts.items = _this7.data.contacts.items.filter(function (row) {
                  return row.id !== item.id;
                });
                _this7.data.contacts.pending_total = Math.max(0, Number(_this7.data.contacts.pending_total || 1) - 1);
              }
              if ((_this7$data2 = _this7.data) !== null && _this7$data2 !== void 0 && (_this7$data2 = _this7$data2.snapshot) !== null && _this7$data2 !== void 0 && _this7$data2.pending_contacts) {
                _this7.data.snapshot.pending_contacts.value = Math.max(0, Number(_this7.data.snapshot.pending_contacts.value || 1) - 1);
              }
              if (fromDrawer) _this7.drawerItems = _this7.drawerItems.filter(function (row) {
                return row.id !== item.id;
              });
              _context3.n = 5;
              break;
            case 4:
              _context3.p = 4;
              _t3 = _context3.v;
              console.error('Resolve contact failed', _t3);
            case 5:
              _context3.p = 5;
              _this7.resolvingId = null;
    ...
    setChartDays: function setChartDays(days) {
      ...
      if (next === this.chartDays && ((_this$data9 = this.data) === null || _this$data9 === void 0 || (_this$data9 = _this$data9.chart) === null || _this$data9 === void 0 ? void 0 : _this$data9.days) === next && !this.loading) return;
      this.chartDays = next;
    ...
    fetchDashboard: function fetchDashboard() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var days, options, _options$quiet, quiet, _options$initial, initial, _options$force, force, safeDays, requestId, _sanitized$chart, _sanitized$chart2, payload, sanitized, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              days = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : _this8.chartDays;
            ...
            case 4:
              ...
              _this8.error = false;
              _this8.chartDays = (sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30 ? sanitized.chart.days : safeDays;
              _this8.chartReady = false;
              _context4.n = 5;
              return _this8.$nextTick();
            case 5:
              if (requestId === _this8.dashboardRequestId) _this8.chartReady = true;
              _context4.n = 8;
              break;
            case 6:
              _context4.p = 6;
              _t4 = _context4.v;
              console.error('Admin dashboard fetch failed', _t4);
              if (!(requestId !== _this8.dashboardRequestId)) {
                _context4.n = 7;
                break;
              }
            ...
            case 8:
              _context4.p = 8;
              if (requestId === _this8.dashboardRequestId) _this8.loading = false;
              return _context4.f(8);
            case 9:
              return _context4.a(2);
          }
        }, _callee4, null, [[1, 6, 8, 9]]);
      }))();
    }
  }
});
...
var _hoisted_11 = {
  ...
  "aria-label": "{{ t('admin.snapshot_title') }}"
};
var _hoisted_12 = {
  "class": "admin-kpis"
};
...
var _hoisted_17 = {
  "class": "admin-main-grid admin-reveal",
  style: {
    "--admin-delay": "55ms"
  }
};
...
var _hoisted_33 = {
  "class": "admin-side-stack"
};
var _hoisted_34 = {
  "class": "admin-panel",
  "aria-labelledby": "admin-learning-heading"
};
var _hoisted_35 = {
  "class": "admin-panel__head"
};
var _hoisted_36 = {
  id: "admin-learning-heading"
};
var _hoisted_37 = {
  "class": "admin-panel__hint"
};
...
var _hoisted_59 = {
  "class": "admin-chart__head"
};
var _hoisted_60 = {
  "class": "admin-chart__label"
};
var _hoisted_61 = ["aria-label"];
var _hoisted_62 = ["aria-pressed", "disabled"];
var _hoisted_63 = ["aria-pressed", "disabled"];
var _hoisted_64 = {
  key: 0,
  "class": "admin-chart__empty"
};
var _hoisted_65 = {
  "class": "admin-chart__week"
};
var _hoisted_66 = {
  "class": "admin-panel admin-reveal",
  style: {
  ...
  "aria-labelledby": "admin-mix-heading"
};
var _hoisted_67 = {
  "class": "admin-panel__head"
};
var _hoisted_68 = {
  id: "admin-mix-heading"
};
var _hoisted_69 = {
  "class": "admin-panel__hint"
};
var _hoisted_70 = {
  "class": "admin-mix-grid"
};
var _hoisted_71 = {
  "class": "admin-mix-card"
};
var _hoisted_72 = {
  key: 0,
  "class": "admin-empty"
...
var _hoisted_117 = ["disabled", "onClick"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$data$learners, _$data$data$learning$, _$data$data$learning, _$data$data$learning$2, _$data$data$learning2, _$data$data$learning$3, _$data$data$learning3, _$data$data$learning$4, _$data$data$learning4, _$data$data$ai_health, _$data$data$ai_health2, _$data$data$ai_health3, _$data$data$ai_health4, _$data$data$ai_health5, _$data$data$chart, _$data$data$mix, _$data$data$mix2, _$data$data$mix3, _$data$data$mix4, _$data$data$mix5, _$data$data$contacts, _$data$data$activity;
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "aria-hidden": "true"
  }, null, 2 /* CLASS */)], 8 /* PROPS */, _hoisted_10)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.snapshotCards, function (metric) {
  ...
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $options.openDrawer('users');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_users')), 1 /* TEXT */)]), !((_$data$data$learners = $data.data.learners) !== null && _$data$data$learners !== void 0 && _$data$data$learners.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learners_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_learner')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_position')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_learning')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_sessions')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_ai')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_active')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.learners, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_25, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.email), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [row.current_surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.current_surah_name) + " ", 1 /* TEXT */), row.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
      ...
      n: row.current_ayah
    })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_27, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.not_started')), 1 /* TEXT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_28, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.memorised_ayahs), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.learning_ayahs), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.sessions_completed), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.ai_checks) + " ", 1 /* TEXT */), row.avg_ai_accuracy != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
    ...
    })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.last_activity_at) || '—'), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */))])])]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_35, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_37, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_subtitle')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_39, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$learning$ = (_$data$data$learning = $data.data.learning) === null || _$data$data$learning === void 0 ? void 0 : _$data$data$learning.memorised_ayahs) !== null && _$data$data$learning$ !== void 0 ? _$data$data$learning$ : 0), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_40, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_in_progress')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$learning$2 = (_$data$data$learning2 = $data.data.learning) === null || _$data$data$learning2 === void 0 ? void 0 : _$data$data$learning2.learning_ayahs) !== null && _$data$data$learning$2 !== void 0 ? _$data$data$learning$2 : 0), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_41, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_with_progress')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$learning$3 = (_$data$data$learning3 = $data.data.learning) === null || _$data$data$learning3 === void 0 ? void 0 : _$data$data$learning3.learners_with_progress) !== null && _$data$data$learning$3 !== void 0 ? _$data$data$learning$3 : 0), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_42, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.learning_assessments')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$learning$4 = (_$data$data$learning4 = $data.data.learning) === null || _$data$data$learning4 === void 0 ? void 0 : _$data$data$learning4.assessments) !== null && _$data$data$learning$4 !== void 0 ? _$data$data$learning$4 : 0), 1 /* TEXT */)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_43, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_44, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_45, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_46, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[3] || (_cache[3] = function ($event) {
      return $options.openDrawer('ai_checks');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_ai')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_47, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_48, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_total')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$ai_health = (_$data$data$ai_health2 = $data.data.ai_health) === null || _$data$data$ai_health2 === void 0 ? void 0 : _$data$data$ai_health2.total) !== null && _$data$data$ai_health !== void 0 ? _$data$data$ai_health : 0), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_49, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_week')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$ai_health3 = (_$data$data$ai_health4 = $data.data.ai_health) === null || _$data$data$ai_health4 === void 0 ? void 0 : _$data$data$ai_health4.last_7d) !== null && _$data$data$ai_health3 !== void 0 ? _$data$data$ai_health3 : 0), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_50, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_avg')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, [((_$data$data$ai_health5 = $data.data.ai_health) === null || _$data$data$ai_health5 === void 0 ? void 0 : _$data$data$ai_health5.avg_accuracy) != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.accuracy', {
    n: $data.data.ai_health.avg_accuracy
    ...
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("—")], 64 /* STABLE_FRAGMENT */))])])]), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.aiBands, function (band) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: band.key,
      "class": "admin-band-row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_51, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.bandLabel(band.key)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_52, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      style: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeStyle)({
        width: band.width
      })
    }, null, 4 /* STYLE */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_53, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(band.value), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */)), !$options.aiBands.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_54, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_empty')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_55, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_56, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_57, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_subtitle')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_60, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_label')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-range",
    role: "group",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_7')), 11 /* TEXT, CLASS, PROPS */, _hoisted_62), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-btn admin-btn--ghost admin-btn--sm", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_30')), 11 /* TEXT, CLASS, PROPS */, _hoisted_63)], 8 /* PROPS */, _hoisted_61)]), (_$data$data$chart = $data.data.chart) !== null && _$data$data$chart !== void 0 && _$data$data$chart.is_empty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_64, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.chart_empty')), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 1,
  ...
  }, null, 8 /* PROPS */, ["data", "options", "aria-label"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_65, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.weekSummaryText), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_66, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_67, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_68, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_69, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_subtitle')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_71, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_subscriptions')), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.mixRows((_$data$data$mix = $data.data.mix) === null || _$data$data$mix === void 0 ? void 0 : _$data$data$mix.subscriptions), function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: "sub-".concat(row.key),
      "class": "admin-mix-row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(row.key)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.value), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */)), !$options.mixRows((_$data$data$mix2 = $data.data.mix) === null || _$data$data$mix2 === void 0 ? void 0 : _$data$data$mix2.subscriptions).length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_72, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_empty')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_73, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_locales')), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.mixRows((_$data$data$mix3 = $data.data.mix) === null || _$data$data$mix3 === void 0 ? void 0 : _$data$data$mix3.locales), function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: "loc-".concat(row.key),
      "class": "admin-mix-row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.key), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.value), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */)), !$options.mixRows((_$data$data$mix4 = $data.data.mix) === null || _$data$data$mix4 === void 0 ? void 0 : _$data$data$mix4.locales).length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_74, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_empty')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_75, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.mix_auth')), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.mixRows((_$data$data$mix5 = $data.data.mix) === null || _$data$data$mix5 === void 0 ? void 0 : _$data$data$mix5.auth_providers), function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: "auth-".concat(row.key),
      "class": "admin-mix-row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.authLabel(row.key)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.value), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */))])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_76, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_78, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_79, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_80, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_subtitle')), 1 /* TEXT */)]), $options.contactInboxUrl ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "admin-link",
    href: $options.contactInboxUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_contacts')), 9 /* TEXT, PROPS */, _hoisted_81)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), !((_$data$data$contacts = $data.data.contacts) !== null && _$data$data$contacts !== void 0 && (_$data$data$contacts = _$data$data$contacts.items) !== null && _$data$data$contacts !== void 0 && _$data$data$contacts.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_82, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_83, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.contacts.items, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id,
      "class": "admin-list__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_84, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_85, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.subject || _ctx.t('admin.contact_no_subject')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_86, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.email), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_87, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-list__time",
      datetime: item.created_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.created_at)), 9 /* TEXT, PROPS */, _hoisted_88), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_89)])]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_90, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_91, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_92, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_93, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[6] || (_cache[6] = function ($event) {
      return $options.openDrawer('activity');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_activity')), 1 /* TEXT */)]), !((_$data$data$activity = $data.data.activity) !== null && _$data$data$activity !== void 0 && _$data$data$activity.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_94, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_95, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.activity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id || "".concat(item.type, "-").concat(index),
      "class": "admin-list__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_96, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_97, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_98, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "admin-list__time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_99)]);
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_105)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_106, [$data.drawerMode === 'users' ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
    key: 0,
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_107)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.userSearch, void 0, {
    trim: true
  }]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_108, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_109, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : !$data.drawerItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_110, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerEmptyMessage), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_111, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.drawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: $options.drawerItemKey(item),
      "class": "admin-drawer__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_112, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_113, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemTitle(item)), 1 /* TEXT */), $options.drawerItemMeta(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_114, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerItemMeta(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_115, [$options.drawerItemTime(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("time", {
      key: 0,
      "class": "admin-drawer__row-time",
      datetime: $options.drawerItemTime(item)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate($options.drawerItemTime(item))), 9 /* TEXT, PROPS */, _hoisted_116)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerMode === 'contacts' && item.status === 'pending' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 1,
      type: "button",
      "class": "admin-btn admin-btn--ghost admin-btn--sm",
      disabled: $data.resolvingId === item.id,
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_117)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
  }), 128 /* KEYED_FRAGMENT */))]))])])], 8 /* PROPS */, _hoisted_100)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
}
...
var adminApi = {
  ...
  getActivity: function getActivity() {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      var limit, _yield$withRetry3, data;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          ...
          case 1:
            ...
            return _context3.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.activity) ? data.activity : []);
        }
      }, _callee3);
    }))();
  },
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          ...
          case 1:
            ...
            return _context4.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.sessions) ? data.sessions : []);
        }
      }, _callee4);
    }))();
  },
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          ...
          case 1:
            ...
            return _context5.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.attempts) ? data.attempts : []);
        }
      }, _callee5);
    }))();
  },
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          ...
          case 1:
            ...
            return _context6.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.notes) ? data.notes : []);
        }
      }, _callee6);
    }))();
  },
  getContacts: function getContacts() {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
      var _ref2, _ref2$limit, limit, _ref2$status, status, _yield$withRetry7, data;
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.n) {
          ...
          case 1:
            ...
            return _context7.a(2, Array.isArray(data === null || data === void 0 ? void 0 : data.contacts) ? data.contacts : []);
        }
      }, _callee7);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
      ...
      return _regenerator().w(function (_context8) {
        while (1) switch (_context8.n) {
          ...
          case 1:
            _yield$http$patch = _context8.v;
            data = _yield$http$patch.data;
            return _context8.a(2, (data === null || data === void 0 ? void 0 : data.contact) || null);
        }
      }, _callee8);
    }))();
  },
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.n) {
          ...
          case 1:
            _yield$http$delete = _context9.v;
            data = _yield$http$delete.data;
            return _context9.a(2, !!(data !== null && data !== void 0 && data.deleted));
        }
      }, _callee9);
    }))();
  }
