...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var vue_chartjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue-chartjs */ "./node_modules/vue-chartjs/dist/index.js");
...
/* harmony import */ var _Dashboard_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Dashboard.css */ "./resources/js/views/Dashboard.css");
...
chart_js__WEBPACK_IMPORTED_MODULE_4__.Chart.register(chart_js__WEBPACK_IMPORTED_MODULE_4__.CategoryScale, chart_js__WEBPACK_IMPORTED_MODULE_4__.LinearScale, chart_js__WEBPACK_IMPORTED_MODULE_4__.BarElement, chart_js__WEBPACK_IMPORTED_MODULE_4__.Tooltip, chart_js__WEBPACK_IMPORTED_MODULE_4__.Legend);
var METRIC_META = [{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'UserDashboard',
  components: {
    Bar: vue_chartjs__WEBPACK_IMPORTED_MODULE_5__.Bar,
  ...
  computed: {
    ...
    journeyVersesLabel: function journeyVersesLabel() {
      var row = this.journeyContinue;
      if (!row) return '';
      var start = Number(row.ayah_start || 0);
      var end = Number(row.ayah_end || start);
      if (start > 0 && end > 0 && start !== end) {
        return this.t('dashboard.journey_verses_range', {
          start: start,
          end: end
        });
      }
      if (start > 0) return this.t('dashboard.journey_verse', {
        n: start
      });
      return '';
    },
    journeyRememberedLabel: function journeyRememberedLabel() {
      var row = this.journeyContinue;
      if (!row) return '';
      var remembered = Number(row.remembered_count);
      var total = Number(row.range_ayah_count);
      if (!Number.isFinite(remembered) || !Number.isFinite(total) || total <= 0) return '';
      return this.t('dashboard.journey_remembered', {
    ...
    journeyReviewVersesLabel: function journeyReviewVersesLabel() {
      var row = this.journeyReview;
      if (!row) return '';
      var start = Number(row.ayah_start || 0);
      var end = Number(row.ayah_end || start);
      if (start > 0 && end > 0 && start !== end) {
    ...
    isLiveContinueAction: function isLiveContinueAction() {
      var _this$data11;
      var type = String(((_this$data11 = this.data) === null || _this$data11 === void 0 || (_this$data11 = _this$data11["continue"]) === null || _this$data11 === void 0 ? void 0 : _this$data11.action_type) || '');
      return type === 'resume_session' || type === 'continue_session';
    },
    liveReturnSession: function liveReturnSession() {
      var _this$data12;
      if (!this.isLiveContinueAction || !((_this$data12 = this.data) !== null && _this$data12 !== void 0 && _this$data12["continue"])) return null;
    ...
    recommendedNext: function recommendedNext() {
      var _this$data13;
      var next = (_this$data13 = this.data) === null || _this$data13 === void 0 ? void 0 : _this$data13.recommended_next;
    ...
    snapshotCards: function snapshotCards() {
      var _this$data14,
        _this = this;
      var snap = ((_this$data14 = this.data) === null || _this$data14 === void 0 ? void 0 : _this$data14.snapshot) || {};
    ...
    currentSurahStats: function currentSurahStats() {
      var _this$data$progress$m2, _this$data15, _this$data$progress$l, _this$data16;
      var memorised = Number((_this$data$progress$m2 = (_this$data15 = this.data) === null || _this$data15 === void 0 || (_this$data15 = _this$data15.progress) === null || _this$data15 === void 0 ? void 0 : _this$data15.memorised_ayah_count) !== null && _this$data$progress$m2 !== void 0 ? _this$data$progress$m2 : 0);
      var learning = Number((_this$data$progress$l = (_this$data16 = this.data) === null || _this$data16 === void 0 || (_this$data16 = _this$data16.progress) === null || _this$data16 === void 0 ? void 0 : _this$data16.learning_ayah_count) !== null && _this$data$progress$l !== void 0 ? _this$data$progress$l : 0);
      var promoteLearning = memorised === 0 && learning > 0;
      var memorisedStat = {
        key: 'memorised',
        value: memorised,
        label: memorised === 0 ? this.t('dashboard.completed_count') : this.t('dashboard.memorised_count'),
    ...
    surahProgress: function surahProgress() {
      var _this$data17, _progress$surah_pract;
      var progress = (_this$data17 = this.data) === null || _this$data17 === void 0 ? void 0 : _this$data17.progress;
    ...
    retentionChips: function retentionChips() {
      var _this$data19;
      var retention = (_this$data19 = this.data) === null || _this$data19 === void 0 ? void 0 : _this$data19.retention;
      if (!retention) return [];
      var chips = [];
    ...
    chartInstanceKey: function chartInstanceKey() {
      var _this$data20, _points$, _points;
      var points = ((_this$data20 = this.data) === null || _this$data20 === void 0 || (_this$data20 = _this$data20.chart) === null || _this$data20 === void 0 ? void 0 : _this$data20.points) || [];
    ...
    chartData: function chartData() {
      var _this$data21,
        _this2 = this;
      var points = ((_this$data21 = this.data) === null || _this$data21 === void 0 || (_this$data21 = _this$data21.chart) === null || _this$data21 === void 0 ? void 0 : _this$data21.points) || [];
    ...
    chartOptions: function chartOptions() {
      var _this$data22,
        _this3 = this;
      var points = ((_this$data22 = this.data) === null || _this$data22 === void 0 || (_this$data22 = _this$data22.chart) === null || _this$data22 === void 0 ? void 0 : _this$data22.points) || [];
      var palette = this.chartPalette;
      return {
        responsive: true,
    ...
    weekSummaryText: function weekSummaryText() {
      var _this$data23;
      var week = (_this$data23 = this.data) === null || _this$data23 === void 0 ? void 0 : _this$data23.week_summary;
  ...
  methods: {
    ...
    reviewNowHref: function reviewNowHref(item) {
      ...
      var base = this.memorisationUrl.split('?')[0];
      if (!(surah > 0 && ayah > 0)) return (item === null || item === void 0 ? void 0 : item.href) || base;
    ...
    setChartDays: function setChartDays(days) {
      ...
      if (next === this.chartDays && ((_this$data24 = this.data) === null || _this$data24 === void 0 || (_this$data24 = _this$data24.chart) === null || _this$data24 === void 0 ? void 0 : _this$data24.days) === next && !this.loading) return;
      this.chartDays = next;
          ...
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 9:
              if (initial || force || !_this7.data) {
                _this7.failureKind = (0,_utils_networkStatus__WEBPACK_IMPORTED_MODULE_2__.classifyRequestFailure)(_t2);
                _this7.error = true;
                _this7.data = null;
              }
...
var _hoisted_4 = {
  "class": "dash-hero dash-reveal"
};
var _hoisted_5 = {
  "class": "dash-hero__row"
};
var _hoisted_6 = {
  "class": "dash-hero__copy"
};
var _hoisted_7 = {
  "class": "dash-eyebrow"
};
...
var _hoisted_9 = {
  key: 0,
  "class": "dash-hero__meta"
};
var _hoisted_10 = ["disabled", "aria-label"];
var _hoisted_11 = {
  "class": "dash-hero__actions"
};
var _hoisted_12 = ["aria-label"];
var _hoisted_13 = {
  "class": "dash-return-session__copy"
};
var _hoisted_14 = {
...
var _hoisted_19 = {
  "class": "dash-return-session__actions"
};
...
var _hoisted_28 = {
  "class": "dash-continue__body"
};
var _hoisted_29 = {
  "class": "dash-continue__label"
};
var _hoisted_30 = {
  "class": "dash-continue__title"
};
var _hoisted_31 = {
  key: 0,
  "class": "dash-continue__verses"
};
var _hoisted_32 = {
  key: 1,
  "class": "dash-continue__remembered"
};
var _hoisted_33 = {
  "class": "dash-continue__go"
};
var _hoisted_34 = {
  key: 1,
...
var _hoisted_37 = ["aria-valuenow", "aria-label"];
var _hoisted_38 = {
...
var _hoisted_40 = {
  "class": "dash-review__copy"
};
var _hoisted_41 = {
  id: "dash-review-title",
  "class": "dash-review__label"
};
var _hoisted_42 = {
  "class": "dash-review__title"
};
var _hoisted_43 = {
  key: 0,
  "class": "dash-review__verses"
};
var _hoisted_44 = ["href"];
var _hoisted_45 = {
  "class": "dash-panel dash-reveal dash-data-panel",
...
var _hoisted_46 = {
  "class": "dash-panel__head"
};
var _hoisted_47 = {
  id: "dash-data-heading"
};
var _hoisted_48 = {
  "class": "dash-panel__hint"
};
var _hoisted_49 = {
  "class": "dash-metrics"
};
...
var _hoisted_64 = ["aria-valuenow", "aria-label"];
var _hoisted_65 = {
...
var _hoisted_74 = ["aria-pressed", "disabled"];
var _hoisted_75 = ["aria-pressed", "disabled"];
var _hoisted_76 = {
  key: 0,
  "class": "dash-chart__empty"
};
var _hoisted_77 = {
  "class": "dash-split dash-reveal",
  style: {
    "--dash-delay": "60ms"
  }
};
var _hoisted_78 = {
  "class": "dash-panel",
  "aria-labelledby": "dash-weak-heading"
};
var _hoisted_79 = {
  "class": "dash-panel__head"
};
...
var _hoisted_85 = {
  "class": "dash-list__row dash-list__row--static"
};
var _hoisted_86 = ["href"];
var _hoisted_87 = {
  "class": "dash-list__title-row"
};
var _hoisted_88 = {
  "class": "dash-list__title"
};
var _hoisted_89 = {
  key: 0,
  "class": "dash-list__phrase",
  lang: "ar",
  dir: "rtl"
};
var _hoisted_90 = {
  "class": "dash-list__actions"
};
...
var _hoisted_101 = {
  key: 0,
  "class": "dash-list__meta"
};
var _hoisted_102 = ["datetime"];
var _hoisted_103 = ["aria-labelledby"];
...
var _hoisted_107 = ["id"];
var _hoisted_108 = ["aria-label"];
var _hoisted_109 = {
  "class": "dash-drawer__body"
};
var _hoisted_110 = ["aria-label"];
var _hoisted_111 = ["aria-selected", "onClick"];
var _hoisted_112 = {
  key: 1,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$data$progress, _$data$data$progress2, _$data$data$progress3, _$data$data$chart, _$data$data$weaknesse, _$data$data$weaknesse2, _$data$data$weaknesse3, _$data$data$activity;
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "dash-spinner",
    "aria-hidden": "true"
    ...
    key: 3
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_kicker')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.greetingText), 1 /* TEXT */), _cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "dash-rule",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), $options.retentionChips.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_9, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.retentionChips, function (chip) {
    ...
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_now')), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_20)])], 8 /* PROPS */, _hoisted_12)) : $options.showJourneyStart ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_21, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_start_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_23, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_start_hint')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--primary",
    href: $options.startBeginningHref
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_start_beginning')), 9 /* TEXT, PROPS */, _hoisted_25), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--ghost",
    href: $options.chooseStartHref
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_choose_start')), 9 /* TEXT, PROPS */, _hoisted_26)])])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 2
    ...
    href: $options.journeyContinueHref
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyContinueLabel), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyContinue.surah_name || $options.t('dashboard.start_session')), 1 /* TEXT */), $options.journeyVersesLabel ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyVersesLabel), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.journeyRememberedLabel ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyRememberedLabel), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_33, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyContinueCta), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_27)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.showJourneyOverall ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_35, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_overall_label')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyOverallPercent) + "%", 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, null, 6 /* CLASS, STYLE */)], 8 /* PROPS */, _hoisted_37), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_38, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_overall_ayahs', {
    n: $options.journeyMemorisedCount
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.journeyReview ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_39, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_40, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_41, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_review_label')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_42, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyReview.surah_name), 1 /* TEXT */), $options.journeyReviewVersesLabel ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_43, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.journeyReviewVersesLabel), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--ghost",
    href: $options.journeyReview.href
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_review_cta')), 9 /* TEXT, PROPS */, _hoisted_44)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_45, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_46, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_47, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_data_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_48, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.journey_data_subtitle')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_49, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.snapshotCards, function (metric) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)(metric.href ? 'a' : 'button'), {
      ...
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-metric", ["dash-metric--".concat(metric.tone), {
      ...
      "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
        return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_50, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.value), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_51, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.label), 1 /* TEXT */)];
      }),
      _: 2 /* DYNAMIC */
    }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["type", "href", "class", "onClick"]);
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.view_memorised_ayahs')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "dash-link",
    onClick: _cache[4] || (_cache[4] = function ($event) {
      return $options.openDrawer('activity');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.view_all_activity')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-link",
    href: $options.savedSessionsHref
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.view_saved_sessions')), 9 /* TEXT, PROPS */, _hoisted_53)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_54, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_55, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_56, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.progress_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_57, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.progress_subtitle')), 1 /* TEXT */)]), $options.weekSummaryText ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.weekSummaryText), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_61, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.current_position')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", _hoisted_62, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(((_$data$data$progress = $data.data.progress) === null || _$data$data$progress === void 0 ? void 0 : _$data$data$progress.current_surah_name) || $options.t('dashboard.not_started')), 1 /* TEXT */), $options.surahProgress ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_63, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, null, 6 /* CLASS, STYLE */)], 8 /* PROPS */, _hoisted_64), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_65, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.surahProgress.value) + "%", 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.ayahRangeLabel($data.data.progress) || (_$data$data$progress2 = $data.data.progress) !== null && _$data$data$progress2 !== void 0 && _$data$data$progress2.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_66, [$options.ayahRangeLabel($data.data.progress) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_67, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.ayahRangeLabel($data.data.progress)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$data$progress3 = $data.data.progress) !== null && _$data$data$progress3 !== void 0 && _$data$data$progress3.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_68, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.at_ayah', {
    n: $data.data.progress.current_ayah
  })), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_69, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.currentSurahStats, function (stat) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: stat.key,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-stat", stat.emphasis])
  ...
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_71, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_72, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.activity_chart_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.days_7')), 11 /* TEXT, CLASS, PROPS */, _hoisted_74), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-btn dash-btn--ghost dash-btn--sm", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.days_30')), 11 /* TEXT, CLASS, PROPS */, _hoisted_75)], 8 /* PROPS */, _hoisted_73)]), (_$data$data$chart = $data.data.chart) !== null && _$data$data$chart !== void 0 && _$data$data$chart.is_empty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_76, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.chart_empty_message')), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 1,
  ...
  }, null, 8 /* PROPS */, ["data", "options", "aria-label"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */))])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_78, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_79, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_80, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.strengthen_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_81, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.strengthen_subtitle')), 1 /* TEXT */)]), (_$data$data$weaknesse = $data.data.weaknesses) !== null && _$data$data$weaknesse !== void 0 && _$data$data$weaknesse.has_more && (_$data$data$weaknesse2 = $data.data.weaknesses) !== null && _$data$data$weaknesse2 !== void 0 && _$data$data$weaknesse2.view_all_href ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "dash-link",
    href: $data.data.weaknesses.view_all_href
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.view_all_reviews')), 9 /* TEXT, PROPS */, _hoisted_82)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), !((_$data$data$weaknesse3 = $data.data.weaknesses) !== null && _$data$data$weaknesse3 !== void 0 && (_$data$data$weaknesse3 = _$data$data$weaknesse3.items) !== null && _$data$data$weaknesse3 !== void 0 && _$data$data$weaknesse3.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_83, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.weak_empty_message')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_84, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.weaknesses.items, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.key,
      "class": "dash-list__item"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_85, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      "class": "dash-list__main dash-list__main--link",
      href: item.href || $options.memorisationUrl
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_87, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_88, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.surah_name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.ayah_n', {
      n: item.ayah_number
      ...
      key: 0,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-strength", "dash-strength--".concat(item.strength)])
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.strengthLabel(item)), 3 /* TEXT, CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), item.phrase ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_89, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.phrase), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 8 /* PROPS */, _hoisted_86), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_90, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      "class": "dash-btn dash-btn--ghost dash-btn--sm",
      href: $options.reviewNowHref(item)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.review_now')), 9 /* TEXT, PROPS */, _hoisted_91)])])]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_92, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_93, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_94, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_95, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.activity_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "dash-link",
    onClick: _cache[7] || (_cache[7] = function ($event) {
      return $options.openDrawer('activity');
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.view_all_activity')), 1 /* TEXT */)]), !((_$data$data$activity = $data.data.activity) !== null && _$data$data$activity !== void 0 && _$data$data$activity.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_96, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.activity_empty_message')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_97, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.activity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "".concat(item.type, "-").concat(item.occurred_at, "-").concat(index)
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      "class": "dash-list__row",
      href: item.href || $options.memorisationUrl
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_99, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_100, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_101, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-list__time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_102)], 8 /* PROPS */, _hoisted_98)]);
  }), 128 /* KEYED_FRAGMENT */))]))])])], 64 /* STABLE_FRAGMENT */))]), $options.drawerOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
  ...
  }, null, 8 /* PROPS */, _hoisted_104), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_105, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_106, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", {
    id: $options.drawerTitleId,
    "class": "dash-drawer__title"
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerTitle), 9 /* TEXT, PROPS */, _hoisted_107), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "dash-icon-btn",
    "aria-label": $options.t('dashboard.drawer_close'),
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_108)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_109, [$data.drawerMode === 'activity' && !$data.drawerLoading && !$data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_111);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_110)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_112, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.drawer_loading')), 1 /* TEXT */)) : $data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_113, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.drawer_load_error')), 1 /* TEXT */)) : !$options.visibleDrawerItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_114, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerEmptyMessage), 1 /* TEXT */)) : $data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_115, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id || "".concat(item.type, "-").concat(item.occurred_at)
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      "class": "dash-drawer__row dash-drawer__row--link",
      href: item.href || $options.memorisationUrl
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_117, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_118, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_119, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item.type)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */)]), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_120, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-drawer__row-time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_121)], 8 /* PROPS */, _hoisted_116)]);
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'sessions' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_122, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "session-".concat(item.id),
      "class": "dash-drawer__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_123, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_124, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.surah_name || $options.t('dashboard.not_started')) + " ", 1 /* TEXT */), $options.formatItemRange(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatItemRange(item)), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_125, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.sessionStatusLabel(item.status)), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-drawer__row-time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_126)]);
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'ai_checks' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_127, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "ai-".concat(item.id),
      "class": "dash-drawer__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_128, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_129, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.surah_name || $options.t('dashboard.not_started')) + " ", 1 /* TEXT */), $options.formatItemRange(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatItemRange(item)), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_130, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.aiResultLabel(item)), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-drawer__row-time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_131)]);
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'notes' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_132, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "note-".concat(item.id),
      "class": "dash-drawer__row"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_133, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_134, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteHeading(item)), 1 /* TEXT */), $options.noteSnippet(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_135, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteSnippet(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-drawer__row-time",
      datetime: item.updated_at || item.created_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatActivityDate(item.updated_at || item.created_at)), 9 /* TEXT, PROPS */, _hoisted_136)]);
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'hifz' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_137, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.visibleDrawerItems, function (group) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "hifz-".concat(group.surah_number),
      "class": "dash-drawer__group"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_138, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_139, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(group.surah_name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_140, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.drawer_hifz_memorised', {
    ...
    })), 1 /* TEXT */)]), group.memorised_ayahs.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_141, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(group.memorised_ayahs.map(function (n) {
      return $options.t('dashboard.ayah_n', {
        n: n
      });
    }).join(' · ')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
  }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])], 8 /* PROPS */, _hoisted_103)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
}
