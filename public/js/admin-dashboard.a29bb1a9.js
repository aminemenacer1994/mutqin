...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    activeFilterCount: function activeFilterCount() {
      ...
      if (this.filters.sessionsGt0) count += 1;
  ...
  methods: {
    ...
    onDrawerSectionToggle: function onDrawerSectionToggle(key, event) {
      var _event$target;
      if (!key || !this.drawerSections) return;
      this.drawerSections[key] = !!(event !== null && event !== void 0 && (_event$target = event.target) !== null && _event$target !== void 0 && _event$target.open);
    },
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 4:
              _this7.showToast(_this7.t('admin.copied'));
              _context4.n = 6;
              break;
            case 5:
              _context4.p = 5;
              _t2 = _context4.v;
              _this7.showToast(_this7.t('admin.form_error'));
            case 6:
              return _context4.a(2);
          }
        }, _callee4, null, [[1, 5]]);
          ...
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                page: 1,
                per_page: Math.min(500, Math.max(_this9.usersTotal || 25, 25)),
                q: _this9.filters.q,
            ...
            case 1:
              ...
              suffix = _this9.filtersActive ? 'filtered' : 'all';
              link.href = url;
            ...
            case 2:
              _context5.p = 2;
              _t3 = _context5.v;
              _this9.showToast(_this9.formErrorFrom(_t3));
            case 3:
    ...
    runConfirmAction: function runConfirmAction() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        var _this0$confirmRow;
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              if (!(!((_this0$confirmRow = _this0.confirmRow) !== null && _this0$confirmRow !== void 0 && _this0$confirmRow.id) || !_this0.confirmKind)) {
                _context6.n = 1;
                break;
              }
              return _context6.a(2);
            case 1:
              _this0.confirmBusy = true;
              _context6.p = 2;
              if (!(_this0.confirmKind === 'reset')) {
                _context6.n = 4;
                break;
              }
              _context6.n = 3;
              return _this0.resetPassword(_this0.confirmRow);
            case 3:
              _context6.n = 5;
              break;
            case 4:
              if (!(_this0.confirmKind === 'deactivate')) {
                _context6.n = 5;
                break;
              }
              _context6.n = 5;
              return _this0.deactivateAccount(_this0.confirmRow);
            case 5:
              _this0.confirmOpen = false;
              _this0.confirmKind = '';
              _this0.confirmRow = null;
            case 6:
              _context6.p = 6;
              _this0.confirmBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 1:
              password = _this1.generateTempPassword();
              _context7.p = 2;
              _context7.n = 3;
            ...
            case 3:
              _this1.showToast(_this1.t('admin.action_reset_password_done', {
                password: password
              }));
              _context7.n = 5;
              break;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        ...
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              if (!(!(row !== null && row !== void 0 && row.id) || Number(row.id) === _this10.ownerId)) {
                _context8.n = 1;
                break;
              }
            ...
            case 3:
              if (!(_this10.selectedUserId === row.id)) {
                _context8.n = 4;
                break;
              }
              delete _this10.detailCache[row.id];
              _context8.n = 4;
              return _this10.loadDetail(row.id);
            case 4:
              _this10.showToast(_this10.t('admin.toast_saved'));
              _context8.n = 6;
              break;
            case 5:
              _context8.p = 5;
              _t5 = _context8.v;
              _this10.showToast(_this10.formErrorFrom(_t5));
            case 6:
              return _context8.a(2);
          }
        }, _callee8, null, [[1, 5]]);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              requestId = ++_this11.usersRequestId;
              _this11.usersLoading = true;
              _this11.usersError = false;
              _context9.p = 1;
              _context9.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                page: _this11.usersPage,
                per_page: _this11.usersPerPage,
                limit: _this11.usersPerPage,
                q: _this11.filters.q,
                status: _this11.filters.status,
                activity: _this11.filters.activity,
                progress: _this11.filters.progress,
                sessions: _this11.filters.sessionsGt0 ? 'gt0' : '',
                sort: _this11.sortKey,
                dir: _this11.sortDir
              });
            case 2:
              result = _context9.v;
              if (!(requestId !== _this11.usersRequestId)) {
                _context9.n = 3;
                break;
              }
              return _context9.a(2);
            case 3:
              _this11.users = result.users;
              _this11.usersTotal = result.total;
              _this11.usersPage = result.page || _this11.usersPage;
              _this11.usersPerPage = result.per_page || _this11.usersPerPage;
              _this11.usersTotalPages = result.total_pages || 1;
              _this11.selectedIds = _this11.selectedIds.filter(function (id) {
                return _this11.users.some(function (row) {
                  return row.id === id;
                });
              });
            ...
            case 4:
              ...
              return _context9.a(2);
            case 5:
              _this11.usersError = true;
            case 6:
              _context9.p = 6;
              if (requestId === _this11.usersRequestId) _this11.usersLoading = false;
    ...
    toggleSelectAll: function toggleSelectAll(event) {
      var _event$target2;
      if (event !== null && event !== void 0 && (_event$target2 = event.target) !== null && _event$target2 !== void 0 && _event$target2.checked) {
          ...
          while (1) switch (_context0.p = _context0.n) {
            ...
            case 1:
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                ...
                user_ids: _this12.selectedIds,
                subscription_status: _this12.bulkStatus
              });
            case 3:
              _this12.selectedIds = [];
              _context0.n = 4;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 1:
              ids = _this13.selectedIds.filter(function (id) {
                return Number(id) !== _this13.ownerId;
              });
              if (ids.length) {
                _context1.n = 2;
                break;
              }
              _this13.showToast(_this13.t('admin.bulk_deactivate_self_blocked'));
              return _context1.a(2);
            case 2:
              if (window.confirm(_this13.t('admin.bulk_deactivate_confirm', {
                n: ids.length
              }))) {
                _context1.n = 3;
                break;
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            ...
            case 1:
              ...
              if (sanitized) _this14.data = sanitized;
              _context10.n = 3;
              break;
            case 2:
              _context10.p = 2;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        ...
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.p = _context11.n) {
            case 0:
              if (!_this15.detailCache[id]) {
                _context11.n = 1;
                break;
              }
              _this15.detail = _this15.detailCache[id];
              _this15.hydrateEditForm(_this15.detail.user);
              _this15.syncDetailStatsFromList();
              _this15.detailLoading = false;
              _this15.detailError = false;
              return _context11.a(2);
            case 1:
              requestId = ++_this15.detailRequestId;
              _this15.detailLoading = true;
              _this15.detailError = false;
              _context11.p = 2;
              _context11.n = 3;
            ...
            case 3:
              detail = _context11.v;
              if (!(requestId !== _this15.detailRequestId)) {
                _context11.n = 4;
                break;
              }
              return _context11.a(2);
            case 4:
              _this15.detail = detail;
              _this15.detailCache[id] = detail;
              _this15.hydrateEditForm(detail === null || detail === void 0 ? void 0 : detail.user);
              _this15.syncDetailStatsFromList();
              _context11.n = 7;
              break;
            case 5:
              ...
              return _context11.a(2);
            case 6:
              _this15.detailError = true;
              _this15.detail = null;
            case 7:
              _context11.p = 7;
              if (requestId === _this15.detailRequestId) _this15.detailLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        ...
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.p = _context12.n) {
            case 0:
              if (!(!_this16.selectedUserId || !_this16.editFormDirty)) {
                _context12.n = 1;
                break;
              }
              return _context12.a(2);
            case 1:
              _this16.formSaving = true;
              _this16.formError = '';
              _context12.p = 2;
              payload = {
                name: _this16.editForm.name,
                email: _this16.editForm.email,
                subscription_status: _this16.editForm.subscription_status
              };
              _context12.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.updateUser(_this16.selectedUserId, payload);
            case 3:
              result = _context12.v;
              if (result !== null && result !== void 0 && result.detail) {
                _this16.detail = result.detail;
                _this16.detailCache[_this16.selectedUserId] = result.detail;
                _this16.hydrateEditForm(result.detail.user);
              }
              _context12.n = 4;
              return _this16.reloadUsers();
            case 4:
              _this16.showToast(_this16.t('admin.toast_saved'));
              _context12.n = 6;
              break;
            case 5:
              _context12.p = 5;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        ...
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.p = _context13.n) {
            case 0:
              if (!(!_this17.selectedUserId || !_this17.deleteConfirmReady)) {
                _context13.n = 1;
                break;
              }
              return _context13.a(2);
            case 1:
              _this17.deletingUser = true;
              _this17.formError = '';
              _context13.p = 2;
              _context13.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteUser(_this17.selectedUserId);
            case 3:
              delete _this17.detailCache[_this17.selectedUserId];
              _this17.selectedUserId = null;
              _this17.detail = null;
              _this17.drawerOpen = false;
              _this17.closeDeleteModal();
              _context13.n = 4;
              return _this17.reloadUsers();
            case 4:
              _this17.refreshSnapshotQuiet();
              _this17.showToast(_this17.t('admin.toast_deleted'));
              _context13.n = 6;
              break;
            case 5:
              _context13.p = 5;
              _t0 = _context13.v;
              _this17.formError = _this17.formErrorFrom(_t0);
            case 6:
              _context13.p = 6;
              _this17.deletingUser = false;
    ...
    deleteNote: function deleteNote(row) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        var _this18$detail, _this18$detail2;
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.n) {
            ...
            case 1:
              if (window.confirm(_this18.t('admin.delete_note_confirm'))) {
                _context14.n = 2;
                break;
              }
              return _context14.a(2);
            ...
            case 3:
              if ((_this18$detail = _this18.detail) !== null && _this18$detail !== void 0 && _this18$detail.recent_notes) {
                _this18.detail.recent_notes = _this18.detail.recent_notes.filter(function (n) {
                  return n.id !== row.id;
                });
              }
              if ((_this18$detail2 = _this18.detail) !== null && _this18$detail2 !== void 0 && _this18$detail2.stats) {
                _this18.detail.stats.notes = Math.max(0, Number(_this18.detail.stats.notes || 1) - 1);
              }
              if (_this18.selectedUserId) _this18.detailCache[_this18.selectedUserId] = _this18.detail;
            case 4:
              return _context14.a(2);
          }
        }, _callee14);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15() {
        ...
        return _regenerator().w(function (_context15) {
          while (1) switch (_context15.p = _context15.n) {
            case 0:
              _this19.createSaving = true;
              _this19.createError = '';
              password = _this19.generateTempPassword();
              tier = String(_this19.createForm.subscription_tier || 'none').toLowerCase();
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.createUser({
                name: _this19.createForm.name,
                email: _this19.createForm.email,
            ...
            case 2:
              ...
              _this19.createOpen = false;
              _this19.usersPage = 1;
              _context15.n = 3;
              return _this19.reloadUsers();
            case 3:
              if (created !== null && created !== void 0 && created.id) {
                _this19.users = [created].concat(_toConsumableArray(_this19.users.filter(function (row) {
                  return Number(row.id) !== Number(created.id);
                }))).slice(0, _this19.usersPerPage);
                _this19.selectUser(created.id);
              }
              _this19.refreshSnapshotQuiet();
              _this19.showToast(_this19.t('admin.toast_created', {
                password: password
              }));
              _context15.n = 5;
              break;
            case 4:
              _context15.p = 4;
              _t1 = _context15.v;
              _this19.createError = _this19.formErrorFrom(_t1);
            case 5:
              _context15.p = 5;
              _this19.createSaving = false;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", {
    ...
    open: $data.drawerSections.surahs,
    onToggle: _cache[47] || (_cache[47] = function ($event) {
      return $options.onDrawerSectionToggle('surahs', $event);
    })
    ...
    "class": "admin-collapse",
    open: $data.drawerSections.sessions,
    onToggle: _cache[48] || (_cache[48] = function ($event) {
      return $options.onDrawerSectionToggle('sessions', $event);
    })
    ...
    "class": "admin-collapse",
    open: $data.drawerSections.ai,
    onToggle: _cache[49] || (_cache[49] = function ($event) {
      return $options.onDrawerSectionToggle('ai', $event);
    })
    ...
    "class": "admin-collapse",
    open: $data.drawerSections.notes,
    onToggle: _cache[51] || (_cache[51] = function ($event) {
      return $options.onDrawerSectionToggle('notes', $event);
    })
    ...
    "class": "admin-collapse",
    open: $data.drawerSections.account,
    onToggle: _cache[55] || (_cache[55] = function ($event) {
      return $options.onDrawerSectionToggle('account', $event);
    })
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.truncateId(((_$data$detail$user7 = $data.detail.user) === null || _$data$detail$user7 === void 0 ? void 0 : _$data$detail$user7.id) || $data.selectedUserId)), 9 /* TEXT, PROPS */, _hoisted_153), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    onClick: _cache[54] || (_cache[54] = function ($event) {
      ...
      return $options.copyUserId(((_$data$detail$user8 = $data.detail.user) === null || _$data$detail$user8 === void 0 ? void 0 : _$data$detail$user8.id) || $data.selectedUserId);
    })
    ...
    "class": "admin-collapse",
    open: $data.drawerSections.danger,
    onToggle: _cache[57] || (_cache[57] = function ($event) {
      return $options.onDrawerSectionToggle('danger', $event);
    })
