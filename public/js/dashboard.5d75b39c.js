...
var METRIC_META = [{
  ...
  contextKey: 'metric_completed_hint'
}, {
  key: 'saved_sessions',
  icon: 'bi bi-bookmark-heart',
  tone: 'accent',
  labelKey: 'metric_saved',
  contextKey: 'metric_saved_hint'
}, {
  key: 'memorised_ayahs',
  icon: 'bi bi-book',
  tone: 'accent',
  labelKey: 'metric_memorised',
  contextKey: 'metric_memorised_hint'
}, {
  key: 'ai_recite_attempts',
  icon: 'bi bi-mic',
  tone: 'info',
  labelKey: 'metric_ai_recite',
  contextKey: 'metric_ai_recite_hint'
}, {
  key: 'notes',
  icon: 'bi bi-journal-text',
  tone: 'neutral',
  labelKey: 'metric_notes',
  contextKey: 'metric_notes_hint'
}];
var ACTIVITY_ICONS = {
  session_completed: 'bi bi-check2-circle',
  session_ended_early: 'bi bi-pause-circle',
  session_saved: 'bi bi-bookmark-check',
  session_resumed: 'bi bi-play-circle',
  ai_recite: 'bi bi-mic',
  assessment: 'bi bi-clipboard-check',
  recommendation: 'bi bi-lightbulb',
  note: 'bi bi-journal-text',
  ayah_memorised: 'bi bi-stars',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    continueHref: function continueHref() {
      var _this$data6;
      var href = String(((_this$data6 = this.data) === null || _this$data6 === void 0 || (_this$data6 = _this$data6["continue"]) === null || _this$data6 === void 0 ? void 0 : _this$data6.href) || '').trim();
      if (href) return href;
      return this.memorisationUrl;
    },
    chartSummary: function chartSummary() {
      var _this$data7;
      var chart = (_this$data7 = this.data) === null || _this$data7 === void 0 ? void 0 : _this$data7.chart;
      if (!chart) return '';
      if (chart.summary_key === 'chart_summary_empty') return this.t('dashboard.chart_summary_empty');
      if (chart.summary_key === 'chart_summary' && chart.summary_params) {
        return this.t('dashboard.chart_summary', chart.summary_params);
      }
      return chart.summary || '';
    },
    syncClass: function syncClass() {
      return {
        'is-loading': this.syncState === 'loading' || this.loading,
        'is-error': this.syncState === 'error',
        'is-ready': this.syncState === 'ready'
      };
    },
    syncIcon: function syncIcon() {
      if (this.syncState === 'error') return 'bi bi-exclamation-circle';
      if (this.loading || this.syncState === 'loading') return 'bi bi-arrow-repeat is-spinning';
      return 'bi bi-cloud-check';
    },
    syncLabel: function syncLabel() {
      if (this.syncState === 'error') return this.t('dashboard.sync_error');
      if (this.loading || this.syncState === 'loading') return this.t('dashboard.sync_loading');
      if (this.lastSyncedAt) {
        return this.t('dashboard.sync_ready', {
          when: this.formatRelative(this.lastSyncedAt)
        });
      }
      return this.t('dashboard.sync_ready_now');
    },
    snapshotCards: function snapshotCards() {
      ...
      return METRIC_META.map(function (meta) {
        ...
        return {
          ...
          icon: meta.icon,
          tone: meta.tone,
          label: _this.t("dashboard.".concat(meta.labelKey)),
          value: Number((_row$value = row.value) !== null && _row$value !== void 0 ? _row$value : 0),
          context: _this.t("dashboard.".concat(meta.contextKey)),
    ...
    chartTotals: function chartTotals() {
      ...
      if (!points.length || (_this$data1 = this.data) !== null && _this$data1 !== void 0 && (_this$data1 = _this$data1.chart) !== null && _this$data1 !== void 0 && _this$data1.is_empty) return null;
      return {
        ayahs: points.reduce(function (sum, point) {
          return sum + Number(point.primary || point.ayahs_memorised || 0);
        }, 0),
        sessions: points.reduce(function (sum, point) {
          return sum + Number(point.secondary || point.sessions_completed || 0);
        }, 0)
      };
    },
    retentionChips: function retentionChips() {
      var _this$data10, _retention$todays_foc;
      var retention = (_this$data10 = this.data) === null || _this$data10 === void 0 ? void 0 : _this$data10.retention;
      if (!retention) return [];
      var chips = [];
      ...
      } else if ((_retention$todays_foc = retention.todays_focus) !== null && _retention$todays_foc !== void 0 && _retention$todays_foc.detail) {
        chips.push({
          key: 'focus',
          icon: 'bi bi-moon-stars',
          label: this.t('dashboard.todays_focus', {
            detail: retention.todays_focus.detail
          })
        });
      }
    ...
    chartData: function chartData() {
      ...
      return {
        ...
        datasets: [{
          ...
          backgroundColor: 'rgba(139, 94, 60, 0.78)',
          hoverBackgroundColor: 'rgba(168, 106, 63, 0.9)',
          borderRadius: 8,
          maxBarThickness: 22
        }, {
          ...
          backgroundColor: 'rgba(46, 125, 100, 0.58)',
          hoverBackgroundColor: 'rgba(46, 125, 100, 0.78)',
          borderRadius: 8,
          maxBarThickness: 22
        }]
      };
      ...
      return {
        ...
        plugins: {
          legend: {
            ...
            labels: {
              boxWidth: 12,
              color: this.cssVar('--text-muted', '#5a5048'),
              font: {
                size: 12
              }
            }
          ...
          tooltip: {
            backgroundColor: this.cssVar('--surface-strong', '#fff'),
            titleColor: this.cssVar('--text', '#1f1a17'),
            bodyColor: this.cssVar('--text-muted', '#5a5048'),
            borderColor: this.cssVar('--border', 'rgba(78,58,38,0.22)'),
            borderWidth: 1,
            padding: 10,
            cornerRadius: 10,
            callbacks: {
              title: function title(items) {
                var _items$0$dataIndex, _items$, _points$index;
                ...
                return ((_points$index = points[index]) === null || _points$index === void 0 ? void 0 : _points$index.date) || '';
              }
            }
          }
        },
  ...
  methods: {
    sanitizePayload: function sanitizePayload(payload) {
      ...
      if (this.ownerId && ownerId && ownerId !== this.ownerId) return null;
      return payload;
    },
    cssVar: function cssVar(name, fallback) {
      if (typeof window === 'undefined') return fallback;
      return getComputedStyle(document.documentElement).getPropertyValue(name).trim() || fallback;
    },
    activityIcon: function activityIcon(type) {
      return ACTIVITY_ICONS[type] || ACTIVITY_ICONS["default"];
    },
    statusClass: function statusClass(value) {
      var text = String(value || '').toLowerCase();
      if (text.includes('review')) return 'dash-status--review';
      return 'dash-status--strengthen';
    },
    weakStatus: function weakStatus(item) {
      var key = item === null || item === void 0 ? void 0 : item.status_key;
      if (key) {
        var translated = this.t("dashboard.".concat(key));
        if (translated && translated !== "dashboard.".concat(key)) return translated;
      }
      return (item === null || item === void 0 ? void 0 : item.status_label) || this.t('dashboard.status_strengthen');
    },
    ...
    ayahRangeLabel: function ayahRangeLabel(row) {
      ...
      if (row.current_ayah) return this.t('dashboard.ayah_n', {
        n: row.current_ayah
      });
      return '';
    },
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              if (!(_this4.chartDays === days && ((_this4$data = _this4.data) === null || _this4$data === void 0 || (_this4$data = _this4$data.chart) === null || _this4$data === void 0 ? void 0 : _this4$data.days) === days)) {
                _context.n = 1;
                break;
              }
              return _context.a(2);
            case 1:
              _this4.chartDays = days;
              _context.n = 2;
              return _this4.fetchDashboard(days);
            case 2:
              return _context.a(2);
          }
        }, _callee);
    ...
    fetchDashboard: function fetchDashboard() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var days, _ref, _ref$quiet, quiet, _ref$initial, initial, _ref$force, force, _payload$chart, _payload$meta2, payload, _t, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              days = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 30;
              _ref = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : {}, _ref$quiet = _ref.quiet, quiet = _ref$quiet === void 0 ? false : _ref$quiet, _ref$initial = _ref.initial, initial = _ref$initial === void 0 ? false : _ref$initial, _ref$force = _ref.force, force = _ref$force === void 0 ? false : _ref$force;
              if (!(_this5.loading && !force && !initial)) {
                _context2.n = 1;
                break;
              }
            ...
            case 3:
              payload = _t.sanitizePayload.call(_t, _context2.v);
              if (payload) {
                _context2.n = 4;
                break;
              }
            ...
            case 4:
              _this5.data = payload;
              _this5.chartDays = (payload === null || payload === void 0 || (_payload$chart = payload.chart) === null || _payload$chart === void 0 ? void 0 : _payload$chart.days) === 7 ? 7 : 30;
              _this5.lastSyncedAt = (payload === null || payload === void 0 || (_payload$meta2 = payload.meta) === null || _payload$meta2 === void 0 ? void 0 : _payload$meta2.generated_at) || new Date().toISOString();
...
var _hoisted_7 = {
  "class": "dash-card dash-welcome dash-reveal",
  "aria-labelledby": "dash-welcome-heading"
};
var _hoisted_8 = {
  "class": "dash-welcome__copy"
};
var _hoisted_9 = {
  "class": "dash-kicker"
};
...
var _hoisted_16 = {
  key: 0,
  "class": "dash-continue__range"
};
var _hoisted_17 = {
  key: 0,
  "class": "dash-continue__message"
};
var _hoisted_18 = {
  "class": "dash-continue__meta"
};
var _hoisted_19 = {
  key: 0
};
...
var _hoisted_22 = {
  "class": "dash-continue__actions"
};
var _hoisted_23 = ["href"];
var _hoisted_24 = {
  "class": "dash-card dash-snapshot dash-reveal",
...
var _hoisted_28 = {
  "class": "dash-metric__top"
};
var _hoisted_29 = {
  "class": "dash-metric__icon",
  "aria-hidden": "true"
};
var _hoisted_30 = {
...
var _hoisted_32 = {
  key: 0,
  "class": "dash-metric__change"
};
var _hoisted_33 = {
  key: 1,
  "class": "dash-metric__context"
};
var _hoisted_34 = {
  "class": "dash-card dash-progress dash-reveal",
...
var _hoisted_41 = {
  "class": "dash-progress-panel"
};
var _hoisted_42 = {
  "class": "dash-position"
};
var _hoisted_43 = {
  "class": "dash-position__kicker"
};
var _hoisted_44 = {
...
var _hoisted_45 = {
  key: 0,
  "class": "dash-position__range"
};
var _hoisted_46 = {
  "class": "dash-progress-counts"
};
var _hoisted_47 = {
  "class": "dash-progress-count"
};
var _hoisted_48 = {
  "class": "dash-progress-count"
};
...
var _hoisted_52 = {
  key: 1,
  "class": "dash-progress-meta"
};
var _hoisted_53 = {
  "class": "dash-chart-panel"
};
var _hoisted_54 = {
  "class": "dash-chart-panel__head"
};
var _hoisted_55 = {
  key: 0,
  "class": "dash-chart-totals"
};
var _hoisted_56 = {
  key: 0,
...
var _hoisted_58 = {
  "class": "dash-chart-summary"
};
var _hoisted_59 = {
  "class": "dash-card dash-strengthen dash-reveal",
...
var _hoisted_63 = {
  key: 0,
  "class": "dash-empty dash-empty--action"
};
var _hoisted_64 = ["href"];
var _hoisted_65 = {
  key: 1,
  "class": "dash-weak-list"
};
var _hoisted_66 = {
  "class": "dash-weak-item__head"
};
var _hoisted_67 = {
  "class": "dash-weak-item__index",
  "aria-hidden": "true"
};
var _hoisted_68 = {
  "class": "dash-weak-item__titles"
};
var _hoisted_69 = {
  "class": "dash-weak-item__title"
};
var _hoisted_70 = {
  key: 0,
  "class": "dash-weak-item__phrase",
  lang: "ar",
  dir: "rtl"
};
var _hoisted_71 = {
  "class": "dash-weak-item__explain"
};
var _hoisted_72 = {
  "class": "dash-weak-item__foot"
};
var _hoisted_73 = {
  "class": "dash-weak-item__time"
};
var _hoisted_74 = ["href"];
var _hoisted_75 = {
  "class": "dash-card dash-activity dash-reveal",
...
var _hoisted_81 = {
  key: 1,
  "class": "dash-activity-list"
};
var _hoisted_82 = {
  "class": "dash-activity-item__icon",
  "aria-hidden": "true"
};
var _hoisted_83 = {
  "class": "dash-activity-item__body"
};
var _hoisted_84 = {
  "class": "dash-activity-item__row"
};
var _hoisted_85 = {
  "class": "dash-activity-item__title"
};
var _hoisted_86 = ["datetime"];
var _hoisted_87 = {
  key: 0,
  "class": "dash-activity-item__context"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$data$progress, _$data$data$progress2, _$data$data$progress$, _$data$data$progress3, _$data$data$progress$2, _$data$data$progress4, _$data$data$progress5, _$data$data$chart, _$data$data$weaknesse, _$data$data$weaknesse2, _$data$data$weaknesse3, _$data$data$activity;
  var _component_Bar = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("Bar");
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[4] || (_cache[4] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "dash-spinner",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.loading')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.loading_hint')), 1 /* TEXT */)])) : $data.error && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_4, [_cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    ...
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-sync", $options.syncClass]),
    "aria-live": "polite"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)($options.syncIcon),
    "aria-hidden": "true"
  }, null, 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.syncLabel), 1 /* TEXT */)], 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "aria-hidden": "true"
  }, null, 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.refresh')), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_6)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.bismillah')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", _hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.greetingText), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_11, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.supporting_message')), 1 /* TEXT */)]), $options.retentionChips.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    "class": "dash-retention",
    "aria-label": _ctx.t('dashboard.retention_label')
  }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.retentionChips, function (chip) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      ...
      "aria-hidden": "true"
    }, null, 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(chip.label), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_12)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.data["continue"] ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.next_step')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_15, [$data.data["continue"].surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.data["continue"].surah_name) + " ", 1 /* TEXT */), $options.ayahRangeLabel($data.data["continue"]) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.ayahRangeLabel($data.data["continue"])), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.continueMessage), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */))]), $data.data["continue"].surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.continueMessage), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_18, [$data.data["continue"].last_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_19, [_cache[6] || (_cache[6] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-bookmark-heart",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.last_ayah', {
    n: $data.data["continue"].last_ayah
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.data["continue"].completion_percent != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_20, [_cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-heart-half",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.completion', {
    n: $data.data["continue"].completion_percent
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.data["continue"].last_activity_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_21, [_cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-clock-history",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative($data.data["continue"].last_activity_at)), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--primary dash-btn--lg",
    href: $options.continueHref
  }, [_cache[9] || (_cache[9] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-play-fill",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.continueCta), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_23)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_25, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_26, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.snapshot_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.snapshot_subtitle')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_27, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.snapshotCards, function (metric) {
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_29, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(metric.icon)
    }, null, 2 /* CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.value), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.label), 1 /* TEXT */), metric.change != null && metric.change > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_32, [_cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      "class": "bi bi-arrow-up-short",
      "aria-hidden": "true"
    }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.change_7d', {
      n: metric.change
    })), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_33, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.context), 1 /* TEXT */))], 2 /* CLASS */);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_35, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.progress_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.progress_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "dash-range-toggle",
    role: "group",
    "aria-label": _ctx.t('dashboard.chart_range')
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.days_7')), 11 /* TEXT, CLASS, PROPS */, _hoisted_38), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-btn dash-btn--ghost dash-btn--sm", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.days_30')), 11 /* TEXT, CLASS, PROPS */, _hoisted_39)], 8 /* PROPS */, _hoisted_37)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_40, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_41, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_42, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_43, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.current_position')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_44, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(((_$data$data$progress = $data.data.progress) === null || _$data$data$progress === void 0 ? void 0 : _$data$data$progress.current_surah_name) || _ctx.t('dashboard.not_started')), 1 /* TEXT */), $options.ayahRangeLabel($data.data.progress) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_45, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.ayahRangeLabel($data.data.progress)) + " ", 1 /* TEXT */), (_$data$data$progress2 = $data.data.progress) !== null && _$data$data$progress2 !== void 0 && _$data$data$progress2.current_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.at_ayah', {
    n: $data.data.progress.current_ayah
  })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_46, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_47, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$progress$ = (_$data$data$progress3 = $data.data.progress) === null || _$data$data$progress3 === void 0 ? void 0 : _$data$data$progress3.memorised_ayah_count) !== null && _$data$data$progress$ !== void 0 ? _$data$data$progress$ : 0), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.memorised_count')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_48, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$data$progress$2 = (_$data$data$progress4 = $data.data.progress) === null || _$data$data$progress4 === void 0 ? void 0 : _$data$data$progress4.learning_ayah_count) !== null && _$data$data$progress$2 !== void 0 ? _$data$data$progress$2 : 0), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.learning_count')), 1 /* TEXT */)])]), $options.primaryCompletion != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_49, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_50, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.primaryCompletion.label), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.primaryCompletion.value) + "%", 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, null, 4 /* STYLE */)], 8 /* PROPS */, _hoisted_51)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (_$data$data$progress5 = $data.data.progress) !== null && _$data$data$progress5 !== void 0 && _$data$data$progress5.last_activity_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_52, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-moon-stars",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.last_activity_soft', {
    when: $options.formatRelative($data.data.progress.last_activity_at)
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_53, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_54, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.activity_chart_title')), 1 /* TEXT */), $options.chartTotals ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_55, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.chart_total_ayahs', {
    n: $options.chartTotals.ayahs
  })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.chart_total_sessions', {
    n: $options.chartTotals.sessions
  })), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (_$data$data$chart = $data.data.chart) !== null && _$data$data$chart !== void 0 && _$data$data$chart.is_empty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_56, [_cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-book-half",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.chart_empty_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.chart_empty_message')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--primary dash-btn--sm",
    href: $options.memorisationUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.start_session')), 9 /* TEXT, PROPS */, _hoisted_57)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 1,
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-chart-wrap", {
    ...
    "aria-label": _ctx.t('dashboard.chart_aria')
  }, null, 8 /* PROPS */, ["data", "options", "aria-label"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.chartSummary), 1 /* TEXT */)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_61, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.strengthen_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.strengthen_subtitle')), 1 /* TEXT */)]), (_$data$data$weaknesse = $data.data.weaknesses) !== null && _$data$data$weaknesse !== void 0 && _$data$data$weaknesse.has_more && (_$data$data$weaknesse2 = $data.data.weaknesses) !== null && _$data$data$weaknesse2 !== void 0 && _$data$data$weaknesse2.view_all_href ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "dash-link",
    href: $data.data.weaknesses.view_all_href
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.view_all')) + " ", 1 /* TEXT */), _cache[13] || (_cache[13] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-arrow-right",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))], 8 /* PROPS */, _hoisted_62)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), !((_$data$data$weaknesse3 = $data.data.weaknesses) !== null && _$data$data$weaknesse3 !== void 0 && (_$data$data$weaknesse3 = _$data$data$weaknesse3.items) !== null && _$data$data$weaknesse3 !== void 0 && _$data$data$weaknesse3.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_63, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "dash-empty__icon",
    "aria-hidden": "true"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-heart"
  })], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.weak_empty_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.weak_empty_message')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--ghost dash-btn--sm",
    href: $options.memorisationUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.start_check')), 9 /* TEXT, PROPS */, _hoisted_64)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_65, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.weaknesses.items, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.key,
      "class": "dash-weak-item"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_66, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_67, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(index + 1), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_68, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_69, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.surah_name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.ayah_n', {
      n: item.ayah_number
    })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-status", $options.statusClass(item.status_key || item.status_label)])
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.weakStatus(item)), 3 /* TEXT, CLASS */)])]), item.phrase ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("blockquote", _hoisted_70, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.phrase), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_71, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.weakExplain(item)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_72, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_73, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.detected_at)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      "class": "dash-btn dash-btn--primary dash-btn--sm",
      href: item.href || $options.memorisationUrl
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t("dashboard.".concat(item.action_key || 'action_review'))), 9 /* TEXT, PROPS */, _hoisted_74)])]);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_75, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_76, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_77, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.activity_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-link",
    href: $options.memorisationUrl
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.go_to_workspace')) + " ", 1 /* TEXT */), _cache[15] || (_cache[15] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-arrow-right",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))], 8 /* PROPS */, _hoisted_78)]), !((_$data$data$activity = $data.data.activity) !== null && _$data$data$activity !== void 0 && _$data$data$activity.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_79, [_cache[16] || (_cache[16] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "dash-empty__icon",
    "aria-hidden": "true"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-sunrise"
  })], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.activity_empty_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.activity_empty_message')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "dash-btn dash-btn--primary dash-btn--sm",
    href: $options.memorisationUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.start_session')), 9 /* TEXT, PROPS */, _hoisted_80)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ol", _hoisted_81, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.data.activity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: "".concat(item.type, "-").concat(item.occurred_at, "-").concat(index),
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-activity-item", "dash-activity-item--".concat(item.type || 'default')])
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_82, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)($options.activityIcon(item.type))
    }, null, 2 /* CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_83, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_84, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_85, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.title), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", {
      "class": "dash-activity-item__time",
      datetime: item.occurred_at
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatAbsolute(item.occurred_at)), 9 /* TEXT, PROPS */, _hoisted_86)]), item.context ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_87, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.context), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), item.href ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
      key: 1,
      "class": "dash-activity-item__link",
      href: item.href
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.open')), 9 /* TEXT, PROPS */, _hoisted_88)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 2 /* CLASS */);
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_89, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('dashboard.footnote')), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
}
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".user-dashboard {\n  --dash-ease: cubic-bezier(0.22, 1, 0.36, 1);\n  --dash-radius: 22px;\n  --dash-radius-sm: 16px;\n  --dash-font: var(--font-ui, \"Avenir Next\", \"Segoe UI\", \"Helvetica Neue\", sans-serif);\n  --dash-shadow:\n    0 1px 2px rgba(45, 32, 20, 0.06),\n    0 14px 34px rgba(45, 32, 20, 0.12),\n    0 28px 56px rgba(45, 32, 20, 0.08);\n  --dash-shadow-hover:\n    0 2px 4px rgba(45, 32, 20, 0.08),\n    0 20px 44px rgba(45, 32, 20, 0.16),\n    0 36px 68px rgba(45, 32, 20, 0.1);\n  --dash-border: color-mix(in srgb, var(--border) 88%, var(--accent));\n  padding: clamp(1rem, 2.4vw, 1.65rem) 0 clamp(2.5rem, 5vw, 3.75rem);\n  color: var(--text);\n  font-family: var(--dash-font);\n  letter-spacing: -0.01em;\n  background:\n    radial-gradient(95% 55% at 8% 0%, color-mix(in srgb, var(--accent) 13%, transparent), transparent 58%),\n    radial-gradient(70% 40% at 100% 6%, color-mix(in srgb, var(--success) 10%, transparent), transparent 52%);\n}\n\n.user-dashboard__shell {\n  width: min(72rem, calc(100% - clamp(1.1rem, 4vw, 2.4rem)));\n  margin: 0 auto;\n  display: grid;\n  gap: clamp(0.95rem, 2.2vw, 1.4rem);\n}\n\n.user-dashboard__loading,\n.user-dashboard__error {\n  display: grid;\n  place-items: center;\n  gap: 0.65rem;\n  min-height: 12rem;\n  padding: 2rem 1.25rem;\n  border: 1px solid var(--dash-border);\n  border-radius: var(--dash-radius);\n  background: var(--surface-strong);\n  box-shadow: var(--dash-shadow);\n  color: var(--text-muted);\n  text-align: center;\n}\n\n.user-dashboard__error {\n  color: var(--danger);\n}\n\n.dash-spinner {\n  width: 2.1rem;\n  height: 2.1rem;\n  border-radius: 50%;\n  border: 2.5px solid color-mix(in srgb, var(--accent) 22%, transparent);\n  border-top-color: var(--accent);\n  animation: dash-spin 0.75s linear infinite;\n}\n\n.is-spinning {\n  display: inline-block;\n  animation: dash-spin 0.9s linear infinite;\n}\n\n@keyframes dash-spin {\n  to { transform: rotate(360deg); }\n}\n\n@keyframes dash-rise {\n  from {\n    opacity: 0;\n    transform: translateY(10px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n\n.dash-reveal {\n  animation: dash-rise 420ms var(--dash-ease) both;\n  animation-delay: var(--dash-delay, 0ms);\n}\n\n.dash-topbar {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.65rem;\n}\n\n.dash-sync {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.4rem;\n  margin: 0;\n  padding: 0.35rem 0.7rem;\n  border-radius: 999px;\n  border: 1px solid transparent;\n  background: color-mix(in srgb, var(--surface-strong) 80%, transparent);\n  color: var(--text-muted);\n  font-size: 0.86rem;\n  font-weight: 600;\n}\n\n.dash-sync.is-ready {\n  color: var(--success-strong);\n  background: var(--success-soft);\n  border-color: color-mix(in srgb, var(--success) 24%, transparent);\n}\n\n.dash-sync.is-error {\n  color: var(--danger-strong);\n  background: var(--danger-soft);\n  border-color: color-mix(in srgb, var(--danger) 24%, transparent);\n}\n\n.dash-sync.is-loading {\n  color: var(--accent-strong);\n  background: var(--accent-light);\n  border-color: color-mix(in srgb, var(--accent) 28%, transparent);\n}\n\n.dash-kicker {\n  margin: 0 0 0.45rem;\n  color: var(--accent-strong);\n  font-size: 0.78rem;\n  font-weight: 800;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n}\n\n.dash-footnote {\n  margin: 0.15rem 0 0;\n  text-align: center;\n  color: var(--text-muted);\n  font-size: 0.86rem;\n  line-height: 1.5;\n}\n\n.dash-card {\n  border: 1px solid var(--dash-border);\n  border-radius: var(--dash-radius);\n  background: color-mix(in srgb, var(--surface-strong) 94%, transparent);\n  box-shadow: var(--dash-shadow);\n  padding: clamp(1.05rem, 2.2vw, 1.45rem);\n  backdrop-filter: blur(8px);\n  transition: box-shadow 180ms var(--dash-ease), border-color 180ms var(--dash-ease), transform 180ms var(--dash-ease);\n}\n\n.dash-card:hover {\n  box-shadow: var(--dash-shadow-hover);\n  border-color: color-mix(in srgb, var(--accent) 28%, var(--border));\n}\n\n.dash-card__head {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 0.75rem 1rem;\n  margin-bottom: 1rem;\n}\n\n.dash-card__head h2,\n.dash-card__head h3 {\n  margin: 0;\n  font-size: clamp(1.12rem, 2.2vw, 1.28rem);\n  font-weight: 750;\n  letter-spacing: -0.03em;\n  line-height: 1.25;\n  color: var(--text);\n}\n\n.dash-card__head p {\n  margin: 0.3rem 0 0;\n  color: var(--text-muted);\n  font-size: 0.9rem;\n  line-height: 1.45;\n}\n\n.dash-welcome {\n  display: grid;\n  gap: 1.1rem;\n  background:\n    radial-gradient(120% 90% at 100% 0%, color-mix(in srgb, var(--accent) 18%, transparent), transparent 55%),\n    linear-gradient(160deg, color-mix(in srgb, var(--surface-strong) 92%, var(--accent-light)), var(--surface-strong));\n  box-shadow: var(--dash-shadow);\n}\n\n.dash-welcome__copy h1 {\n  margin: 0;\n  font-size: clamp(1.85rem, 4.4vw, 2.55rem);\n  font-weight: 780;\n  letter-spacing: -0.045em;\n  line-height: 1.08;\n  color: var(--text);\n}\n\n.dash-welcome__lede,\n.dash-welcome__copy > p {\n  margin: 0.55rem 0 0;\n  max-width: 42ch;\n  color: var(--text-muted);\n  font-size: 1.02rem;\n  line-height: 1.55;\n  font-weight: 500;\n}\n\n.dash-continue {\n  display: grid;\n  gap: 0.7rem;\n  padding: 1.2rem 1.2rem 1.15rem;\n  border-radius: calc(var(--dash-radius) - 6px);\n  border: 1px solid color-mix(in srgb, var(--accent) 22%, var(--border));\n  background:\n    linear-gradient(180deg, color-mix(in srgb, var(--accent-light) 55%, transparent), transparent 70%),\n    color-mix(in srgb, var(--surface) 90%, var(--accent-light));\n  box-shadow:\n    inset 0 1px 0 rgba(255, 255, 255, 0.34),\n    0 10px 28px rgba(45, 32, 20, 0.1),\n    0 22px 40px rgba(45, 32, 20, 0.06);\n}\n\n.dash-continue__eyebrow {\n  margin: 0;\n  color: var(--accent-strong);\n  font-size: 0.72rem;\n  font-weight: 800;\n  letter-spacing: 0.09em;\n  text-transform: uppercase;\n}\n\n.dash-continue__meta {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.45rem 0.9rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  color: var(--text-muted);\n  font-size: 0.88rem;\n}\n\n.dash-continue__meta li {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n\n.dash-continue__meta i {\n  color: var(--accent);\n}\n\n.dash-continue__title {\n  margin: 0;\n  font-size: clamp(1.28rem, 2.8vw, 1.55rem);\n  font-weight: 780;\n  letter-spacing: -0.035em;\n  line-height: 1.2;\n  color: var(--text);\n}\n\n.dash-continue__range {\n  display: inline-block;\n  margin-inline-start: 0.35rem;\n  color: var(--text-muted);\n  font-size: 0.82em;\n  font-weight: 650;\n  letter-spacing: -0.02em;\n}\n\n.dash-continue__message {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.92rem;\n  line-height: 1.45;\n  max-width: 48ch;\n}\n\n.dash-continue__actions {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.65rem;\n  align-items: center;\n}\n\n.dash-btn {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.45rem;\n  min-height: 2.75rem;\n  padding: 0.55rem 1.1rem;\n  border-radius: 14px;\n  border: 1px solid transparent;\n  font-weight: 700;\n  font-size: 0.96rem;\n  text-decoration: none;\n  cursor: pointer;\n  transition:\n    background 160ms var(--dash-ease),\n    color 160ms var(--dash-ease),\n    border-color 160ms var(--dash-ease),\n    box-shadow 160ms var(--dash-ease),\n    transform 160ms var(--dash-ease);\n}\n\n.dash-btn:active:not(:disabled) {\n  transform: translateY(1px);\n}\n\n.dash-btn:disabled {\n  opacity: 0.62;\n  cursor: not-allowed;\n}\n\n.dash-btn--primary {\n  background: linear-gradient(180deg, var(--accent-strong), var(--accent));\n  color: #fff;\n  box-shadow: 0 8px 18px color-mix(in srgb, var(--accent) 28%, transparent);\n}\n\n.dash-btn--primary:hover,\n.dash-btn--primary:focus-visible {\n  background: linear-gradient(180deg, color-mix(in srgb, var(--accent-strong) 88%, #fff), var(--accent-strong));\n  color: #fff;\n  box-shadow: 0 10px 22px color-mix(in srgb, var(--accent) 34%, transparent);\n}\n\n.dash-btn--ghost {\n  background: color-mix(in srgb, var(--surface) 88%, transparent);\n  border-color: var(--dash-border);\n  color: var(--text);\n}\n\n.dash-btn--ghost:hover,\n.dash-btn--ghost:focus-visible {\n  border-color: color-mix(in srgb, var(--accent) 45%, var(--border));\n  color: var(--accent-strong);\n  background: var(--accent-light);\n}\n\n.dash-btn--sm {\n  min-height: 2.2rem;\n  padding: 0.35rem 0.85rem;\n  font-size: 0.88rem;\n  border-radius: 12px;\n}\n\n.dash-btn--lg {\n  min-height: 3.1rem;\n  padding: 0.75rem 1.35rem;\n  font-size: 1.02rem;\n  width: min(100%, 22rem);\n  border-radius: 16px;\n}\n\n.dash-btn.is-active {\n  background: var(--accent-light);\n  border-color: color-mix(in srgb, var(--accent) 45%, var(--border));\n  color: var(--accent-strong);\n  box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--accent) 18%, transparent);\n}\n\n.dash-retention {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.55rem;\n}\n\n.dash-chip {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.4rem;\n  min-height: 2rem;\n  padding: 0.3rem 0.75rem;\n  border-radius: 999px;\n  border: 1px solid color-mix(in srgb, var(--accent) 22%, transparent);\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  font-size: 0.8rem;\n  font-weight: 700;\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.25);\n}\n\n.dash-metrics {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 0.8rem;\n}\n\n@media (min-width: 768px) {\n  .dash-metrics {\n    grid-template-columns: repeat(3, minmax(0, 1fr));\n  }\n}\n\n@media (min-width: 1100px) {\n  .dash-metrics {\n    grid-template-columns: repeat(5, minmax(0, 1fr));\n  }\n}\n\n.dash-metric {\n  display: grid;\n  gap: 0.38rem;\n  align-content: start;\n  min-height: 8.4rem;\n  padding: 1rem 1.05rem;\n  border: 1px solid var(--dash-border);\n  border-radius: var(--dash-radius-sm);\n  background:\n    linear-gradient(180deg, color-mix(in srgb, var(--metric-tint, var(--accent-light)) 62%, transparent), transparent 72%),\n    var(--surface);\n  box-shadow: 0 6px 16px rgba(45, 32, 20, 0.05);\n  transition: transform 180ms var(--dash-ease), box-shadow 180ms var(--dash-ease), border-color 180ms var(--dash-ease);\n}\n\n.dash-metric:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 12px 24px rgba(45, 32, 20, 0.1);\n  border-color: color-mix(in srgb, var(--accent) 36%, var(--border));\n}\n\n.dash-metric--success { --metric-tint: var(--success-soft); }\n.dash-metric--accent { --metric-tint: var(--accent-light); }\n.dash-metric--info { --metric-tint: color-mix(in srgb, var(--accent) 12%, var(--success-soft)); }\n.dash-metric--neutral { --metric-tint: color-mix(in srgb, var(--border) 35%, transparent); }\n\n.dash-metric.is-empty {\n  opacity: 0.9;\n}\n\n.dash-metric__top {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.5rem;\n}\n\n.dash-metric__icon {\n  width: 2.2rem;\n  height: 2.2rem;\n  display: inline-grid;\n  place-items: center;\n  border-radius: 12px;\n  background: color-mix(in srgb, var(--metric-tint, var(--accent-light)) 85%, var(--surface-strong));\n  color: var(--accent-strong);\n  font-size: 1.05rem;\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.3);\n}\n\n.dash-metric--success .dash-metric__icon { color: var(--success-strong); }\n\n.dash-metric__label {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.84rem;\n  font-weight: 650;\n  line-height: 1.3;\n}\n\n.dash-metric__value {\n  margin: 0;\n  font-size: clamp(1.5rem, 3vw, 1.75rem);\n  font-weight: 760;\n  letter-spacing: -0.04em;\n  color: var(--text);\n  line-height: 1;\n  font-variant-numeric: tabular-nums;\n}\n\n.dash-metric__context,\n.dash-metric__change {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.78rem;\n  line-height: 1.35;\n}\n\n.dash-metric__change {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.1rem;\n  color: var(--success-strong);\n  font-weight: 700;\n}\n\n.dash-progress-grid {\n  display: grid;\n  gap: 1rem;\n}\n\n@media (min-width: 900px) {\n  .dash-progress-grid {\n    grid-template-columns: minmax(0, 0.95fr) minmax(0, 1.25fr);\n    align-items: stretch;\n  }\n}\n\n.dash-progress-panel,\n.dash-chart-panel {\n  display: grid;\n  gap: 0.9rem;\n  align-content: start;\n  padding: 1.05rem;\n  border: 1px solid var(--dash-border);\n  border-radius: var(--dash-radius-sm);\n  background: color-mix(in srgb, var(--surface) 92%, transparent);\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2);\n}\n\n.dash-position {\n  display: grid;\n  gap: 0.25rem;\n  padding-bottom: 0.85rem;\n  border-bottom: 1px solid color-mix(in srgb, var(--border) 80%, transparent);\n}\n\n.dash-position__kicker {\n  color: var(--text-muted);\n  font-size: 0.78rem;\n  font-weight: 750;\n  letter-spacing: 0.03em;\n  text-transform: uppercase;\n}\n\n.dash-position__surah {\n  color: var(--text);\n  font-size: 1.28rem;\n  font-weight: 740;\n  letter-spacing: -0.02em;\n  line-height: 1.25;\n}\n\n.dash-position__range {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.92rem;\n}\n\n.dash-progress-counts {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 0.65rem;\n}\n\n.dash-progress-count {\n  display: grid;\n  gap: 0.15rem;\n  padding: 0.75rem 0.85rem;\n  border-radius: 14px;\n  border: 1px solid color-mix(in srgb, var(--accent) 16%, transparent);\n  background: color-mix(in srgb, var(--accent-light) 62%, transparent);\n}\n\n.dash-progress-count strong {\n  color: var(--text);\n  font-size: 1.22rem;\n  font-weight: 760;\n  font-variant-numeric: tabular-nums;\n}\n\n.dash-progress-count span {\n  color: var(--text-muted);\n  font-size: 0.78rem;\n  line-height: 1.3;\n}\n\n.dash-completion {\n  display: grid;\n  gap: 0.45rem;\n}\n\n.dash-completion__row {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  gap: 0.75rem;\n  color: var(--text-muted);\n  font-size: 0.86rem;\n}\n\n.dash-completion__row strong {\n  color: var(--text);\n  font-variant-numeric: tabular-nums;\n}\n\n.dash-progress-bar {\n  height: 0.78rem;\n  border-radius: 999px;\n  background: color-mix(in srgb, var(--border) 68%, transparent);\n  overflow: hidden;\n  box-shadow: inset 0 1px 2px rgba(45, 32, 20, 0.08);\n}\n\n.dash-progress-bar > span {\n  display: block;\n  height: 100%;\n  border-radius: inherit;\n  background: linear-gradient(90deg, var(--accent), var(--accent-strong));\n  box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent) 20%, transparent);\n  transition: width 420ms var(--dash-ease);\n}\n\n.dash-progress-meta {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.4rem;\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.84rem;\n}\n\n.dash-progress-meta i {\n  color: var(--accent);\n}\n\n.dash-chart-panel__head {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: baseline;\n  justify-content: space-between;\n  gap: 0.5rem 0.85rem;\n}\n\n.dash-chart-panel__head h3 {\n  margin: 0;\n  font-size: 0.96rem;\n  font-weight: 700;\n  color: var(--text);\n}\n\n.dash-chart-totals {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.45rem;\n}\n\n.dash-chart-totals span {\n  display: inline-flex;\n  align-items: center;\n  min-height: 1.7rem;\n  padding: 0.15rem 0.6rem;\n  border-radius: 999px;\n  border: 1px solid color-mix(in srgb, var(--accent) 20%, transparent);\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  font-size: 0.75rem;\n  font-weight: 700;\n}\n\n.dash-chart-wrap {\n  position: relative;\n  min-height: 240px;\n  border-radius: 14px;\n  transition: opacity 180ms var(--dash-ease);\n}\n\n.dash-chart-wrap.is-loading {\n  opacity: 0.62;\n}\n\n.dash-chart-empty {\n  display: grid;\n  place-items: center;\n  gap: 0.45rem;\n  min-height: 240px;\n  padding: 1.25rem;\n  border: 1px dashed color-mix(in srgb, var(--border) 90%, var(--accent));\n  border-radius: var(--dash-radius-sm);\n  background: color-mix(in srgb, var(--surface) 80%, transparent);\n  color: var(--text-muted);\n  text-align: center;\n}\n\n.dash-chart-empty i {\n  font-size: 1.45rem;\n  color: var(--accent);\n}\n\n.dash-chart-summary {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.88rem;\n  line-height: 1.5;\n}\n\n.dash-weak-list {\n  display: grid;\n  gap: 0.85rem;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n@media (min-width: 900px) {\n  .dash-weak-list {\n    grid-template-columns: repeat(3, minmax(0, 1fr));\n  }\n}\n\n.dash-weak-item {\n  display: grid;\n  gap: 0.55rem;\n  padding: 1.05rem;\n  border: 1px solid var(--dash-border);\n  border-radius: var(--dash-radius-sm);\n  background: var(--surface);\n  box-shadow: 0 6px 16px rgba(45, 32, 20, 0.05);\n  height: 100%;\n  transition: transform 180ms var(--dash-ease), box-shadow 180ms var(--dash-ease), border-color 180ms var(--dash-ease);\n}\n\n.dash-weak-item:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 12px 24px rgba(45, 32, 20, 0.1);\n  border-color: color-mix(in srgb, var(--warning) 30%, var(--border));\n}\n\n.dash-weak-item__head {\n  display: flex;\n  gap: 0.7rem;\n  align-items: flex-start;\n}\n\n.dash-weak-item__index {\n  width: 1.75rem;\n  height: 1.75rem;\n  flex: 0 0 auto;\n  display: inline-grid;\n  place-items: center;\n  border-radius: 999px;\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  font-size: 0.8rem;\n  font-weight: 780;\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.28);\n}\n\n.dash-weak-item__titles {\n  display: grid;\n  gap: 0.35rem;\n  min-width: 0;\n}\n\n.dash-weak-item__title {\n  margin: 0;\n  font-size: 0.98rem;\n  font-weight: 700;\n  color: var(--text);\n  line-height: 1.3;\n}\n\n.dash-weak-item__phrase {\n  margin: 0;\n  padding: 0.7rem 0.85rem;\n  border-radius: 14px;\n  border: 1px solid color-mix(in srgb, var(--border) 80%, transparent);\n  background: color-mix(in srgb, var(--surface-strong) 70%, var(--accent-light));\n  font-family: var(--font-ar);\n  font-size: 1.12rem;\n  color: var(--text);\n  direction: rtl;\n  text-align: right;\n  line-height: 1.55;\n}\n\n.dash-weak-item__explain {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.9rem;\n  line-height: 1.45;\n}\n\n.dash-weak-item__foot {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.55rem;\n  margin-top: auto;\n  padding-top: 0.15rem;\n}\n\n.dash-weak-item__time {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n  color: var(--text-muted);\n  font-size: 0.8rem;\n}\n\n.dash-status {\n  display: inline-flex;\n  align-items: center;\n  width: -moz-fit-content;\n  width: fit-content;\n  gap: 0.3rem;\n  min-height: 1.55rem;\n  padding: 0.15rem 0.6rem;\n  border-radius: 999px;\n  border: 1px solid transparent;\n  background: var(--warning-soft);\n  color: var(--warning-strong);\n  font-size: 0.75rem;\n  font-weight: 750;\n}\n\n.dash-status--review {\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  border-color: color-mix(in srgb, var(--accent) 20%, transparent);\n}\n\n.dash-status--strengthen {\n  background: var(--warning-soft);\n  color: var(--warning-strong);\n  border-color: color-mix(in srgb, var(--warning) 22%, transparent);\n}\n\n.dash-activity-list {\n  display: grid;\n  gap: 0;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n\n.dash-activity-item {\n  display: grid;\n  grid-template-columns: 2.45rem minmax(0, 1fr);\n  gap: 0.85rem;\n  position: relative;\n  padding: 0.9rem 0.15rem 0.9rem 0;\n}\n\n.dash-activity-item:not(:last-child)::before {\n  content: '';\n  position: absolute;\n  left: 1.15rem;\n  top: 2.65rem;\n  bottom: 0;\n  width: 2px;\n  border-radius: 999px;\n  background: linear-gradient(\n    180deg,\n    color-mix(in srgb, var(--accent) 35%, transparent),\n    color-mix(in srgb, var(--border) 70%, transparent)\n  );\n}\n\n.dash-activity-item__icon {\n  width: 2.3rem;\n  height: 2.3rem;\n  display: inline-grid;\n  place-items: center;\n  border-radius: 999px;\n  border: 1px solid var(--dash-border);\n  background: var(--surface);\n  color: var(--accent-strong);\n  font-size: 1rem;\n  z-index: 1;\n  box-shadow: 0 4px 10px rgba(45, 32, 20, 0.06);\n}\n\n.dash-activity-item--session_completed .dash-activity-item__icon,\n.dash-activity-item--ayah_memorised .dash-activity-item__icon {\n  color: var(--success-strong);\n  background: var(--success-soft);\n  border-color: transparent;\n}\n\n.dash-activity-item--ai_recite .dash-activity-item__icon,\n.dash-activity-item--assessment .dash-activity-item__icon {\n  color: var(--accent-strong);\n  background: var(--accent-light);\n  border-color: transparent;\n}\n\n.dash-activity-item--session_ended_early .dash-activity-item__icon {\n  color: var(--warning-strong);\n  background: var(--warning-soft);\n  border-color: transparent;\n}\n\n.dash-activity-item__body {\n  display: grid;\n  gap: 0.25rem;\n  min-width: 0;\n}\n\n.dash-activity-item__row {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: baseline;\n  justify-content: space-between;\n  gap: 0.35rem 0.85rem;\n}\n\n.dash-activity-item__title {\n  margin: 0;\n  font-size: 0.97rem;\n  font-weight: 700;\n  color: var(--text);\n  line-height: 1.35;\n}\n\n.dash-activity-item__time {\n  color: var(--text-muted);\n  font-size: 0.8rem;\n  white-space: nowrap;\n}\n\n.dash-activity-item__context {\n  margin: 0;\n  color: var(--text-muted);\n  font-size: 0.88rem;\n  line-height: 1.4;\n}\n\n.dash-activity-item__link {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.2rem;\n  width: -moz-fit-content;\n  width: fit-content;\n  margin-top: 0.15rem;\n  color: var(--accent-strong);\n  font-size: 0.84rem;\n  font-weight: 720;\n  text-decoration: none;\n}\n\n.dash-activity-item__link:hover,\n.dash-activity-item__link:focus-visible {\n  text-decoration: underline;\n}\n\n.dash-empty {\n  display: grid;\n  gap: 0.45rem;\n  justify-items: center;\n  padding: 1.4rem 1.15rem;\n  border: 1px dashed color-mix(in srgb, var(--border) 90%, var(--accent));\n  border-radius: var(--dash-radius-sm);\n  background: color-mix(in srgb, var(--surface) 78%, transparent);\n  color: var(--text-muted);\n  text-align: center;\n}\n\n.dash-empty--action {\n  gap: 0.55rem;\n}\n\n.dash-empty__icon {\n  width: 2.55rem;\n  height: 2.55rem;\n  display: inline-grid;\n  place-items: center;\n  border-radius: 999px;\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  font-size: 1.15rem;\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.28);\n}\n\n.dash-empty strong {\n  color: var(--text);\n  font-weight: 700;\n}\n\n.dash-link {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.3rem;\n  color: var(--accent-strong);\n  font-weight: 700;\n  text-decoration: none;\n}\n\n.dash-link:hover,\n.dash-link:focus-visible {\n  text-decoration: underline;\n}\n\n.dash-range-toggle {\n  display: inline-flex;\n  gap: 0.3rem;\n  padding: 0.25rem;\n  border: 1px solid var(--dash-border);\n  border-radius: 14px;\n  background: color-mix(in srgb, var(--surface) 90%, transparent);\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2);\n}\n\n.dash-range-toggle .dash-btn {\n  border-color: transparent;\n}\n\n.dash-range-toggle .dash-btn.is-active {\n  background: var(--accent-light);\n  color: var(--accent-strong);\n  box-shadow: 0 2px 8px color-mix(in srgb, var(--accent) 16%, transparent);\n}\n\nhtml[data-theme=\"dark\"] .user-dashboard {\n  --dash-shadow: 0 14px 32px rgba(0, 0, 0, 0.35);\n  --dash-shadow-hover: 0 18px 40px rgba(0, 0, 0, 0.42);\n}\n\nhtml[data-theme=\"dark\"] .dash-card,\nhtml[data-theme=\"dark\"] .dash-metric,\nhtml[data-theme=\"dark\"] .dash-progress-panel,\nhtml[data-theme=\"dark\"] .dash-chart-panel,\nhtml[data-theme=\"dark\"] .dash-weak-item {\n  background: color-mix(in srgb, var(--surface) 92%, #000);\n}\n\nhtml[data-theme=\"dark\"] .dash-activity-item:not(:last-child)::before {\n  background: linear-gradient(180deg, rgba(212, 165, 116, 0.35), rgba(255, 255, 255, 0.12));\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .dash-reveal,\n  .dash-spinner,\n  .is-spinning,\n  .dash-progress-bar > span,\n  .dash-btn,\n  .dash-metric,\n  .dash-weak-item,\n  .dash-card {\n    animation: none !important;\n    transition: none !important;\n  }\n}\n", ""]);
// Exports
