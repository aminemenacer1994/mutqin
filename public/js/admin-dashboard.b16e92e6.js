...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    topLearners: function topLearners() {
      var _this$data3;
      var rows = Array.isArray((_this$data3 = this.data) === null || _this$data3 === void 0 ? void 0 : _this$data3.top_learners) ? _toConsumableArray(this.data.top_learners) : [];
      if (this.topLearnersSort === 'accuracy') {
        rows.sort(function (a, b) {
          var av = a.avg_ai_accuracy == null ? -1 : Number(a.avg_ai_accuracy);
          var bv = b.avg_ai_accuracy == null ? -1 : Number(b.avg_ai_accuracy);
          if (bv !== av) return bv - av;
          return Number(b.sessions_completed || 0) - Number(a.sessions_completed || 0);
        });
      } else {
        rows.sort(function (a, b) {
          var diff = Number(b.sessions_completed || 0) - Number(a.sessions_completed || 0);
          if (diff !== 0) return diff;
          return Number(b.memorised_ayahs || 0) - Number(a.memorised_ayahs || 0);
        });
      }
    ...
    detailStats: function detailStats() {
      var _this$detail, _this$detail2, _ref, _ref2, _listRow$memorised_ay, _ref3, _ref4, _listRow$sessions_com, _ref5, _ref6, _listRow$ai_checks, _stats$notes, _ref7, _ref8, _listRow$avg_ai_accur;
      ...
      var notes = Number((_stats$notes = stats.notes) !== null && _stats$notes !== void 0 ? _stats$notes : 0);
      ...
      return [{
        ...
        key: 'n',
        value: notes,
        label: this.t('admin.user_notes')
      }];
    },
    detailSessions: function detailSessions() {
      var _this$detail3;
      return (((_this$detail3 = this.detail) === null || _this$detail3 === void 0 ? void 0 : _this$detail3.recent_sessions) || []).slice(0, 5);
    },
    detailAiChecks: function detailAiChecks() {
      var _this$detail4;
      return (((_this$detail4 = this.detail) === null || _this$detail4 === void 0 ? void 0 : _this$detail4.recent_ai_checks) || []).slice(0, 5);
    },
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              next = days === 7 ? 7 : 30;
              if (!(_this6.chartDays === next && (_this6$data = _this6.data) !== null && _this6$data !== void 0 && _this6$data.top_learners)) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              _this6.chartDays = next;
            ...
            case 3:
              payload = _context3.v;
              sanitized = _this6.sanitizePayload(payload);
              if (sanitized) _this6.data = sanitized;
            case 4:
              _context3.p = 4;
    ...
    activityStatusLabel: function activityStatusLabel(row) {
      var status = this.activityStatus(row);
      if (status === 'hot') return this.t('admin.status_active_7d');
      if (status === 'warm') return this.t('admin.status_active_30d');
      return this.t('admin.status_inactive');
    },
    ...
    exportVisibleUsersCsv: function exportVisibleUsersCsv() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var result, rows, headers, _escape, lines, blob, url, link, suffix, _t2;
          ...
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                page: 1,
                per_page: Math.min(500, Math.max(_this8.usersTotal || 25, 25)),
                q: _this8.filters.q,
                status: _this8.filters.status,
                activity: _this8.filters.activity,
                progress: _this8.filters.progress,
                sessions: _this8.filters.sessionsGt0 ? 'gt0' : '',
                sort: _this8.sortKey,
                dir: _this8.sortDir
              });
            case 1:
              ...
              suffix = _this8.filtersActive ? 'filtered' : 'all';
              link.href = url;
            ...
            case 2:
              _context4.p = 2;
              _t2 = _context4.v;
              _this8.showToast(_this8.formErrorFrom(_t2));
            case 3:
    ...
    runConfirmAction: function runConfirmAction() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var _this9$confirmRow;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              if (!(!((_this9$confirmRow = _this9.confirmRow) !== null && _this9$confirmRow !== void 0 && _this9$confirmRow.id) || !_this9.confirmKind)) {
                _context5.n = 1;
                break;
              }
              return _context5.a(2);
            case 1:
              _this9.confirmBusy = true;
              _context5.p = 2;
              if (!(_this9.confirmKind === 'reset')) {
                _context5.n = 4;
                break;
              }
              _context5.n = 3;
              return _this9.resetPassword(_this9.confirmRow);
            case 3:
              _context5.n = 5;
              break;
            case 4:
              if (!(_this9.confirmKind === 'deactivate')) {
                _context5.n = 5;
                break;
              }
              _context5.n = 5;
              return _this9.deactivateAccount(_this9.confirmRow);
            case 5:
              _this9.confirmOpen = false;
              _this9.confirmKind = '';
              _this9.confirmRow = null;
            case 6:
              _context5.p = 6;
              _this9.confirmBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              password = _this0.generateTempPassword();
              _context6.p = 2;
              _context6.n = 3;
            ...
            case 3:
              _this0.showToast(_this0.t('admin.action_reset_password_done', {
                password: password
              }));
              _context6.n = 5;
              break;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              if (!(!(row !== null && row !== void 0 && row.id) || Number(row.id) === _this1.ownerId)) {
                _context7.n = 1;
                break;
              }
            ...
            case 3:
              if (!(_this1.selectedUserId === row.id)) {
                _context7.n = 4;
                break;
              }
              delete _this1.detailCache[row.id];
              _context7.n = 4;
              return _this1.loadDetail(row.id);
            case 4:
              _this1.showToast(_this1.t('admin.toast_saved'));
              _context7.n = 6;
              break;
            case 5:
              _context7.p = 5;
              _t4 = _context7.v;
              _this1.showToast(_this1.formErrorFrom(_t4));
            case 6:
              return _context7.a(2);
          }
        }, _callee7, null, [[1, 5]]);
    ...
    sessionOutcomeLabel: function sessionOutcomeLabel(row) {
      if ((row === null || row === void 0 ? void 0 : row.status) === 'ended_early') return this.t('admin.outcome_session_ended_early');
      if ((row === null || row === void 0 ? void 0 : row.status) === 'paused') return this.t('admin.outcome_session_paused');
      return this.t('admin.outcome_session_completed');
    },
    ...
    reloadUsers: function reloadUsers() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        var requestId, result, _t5;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              requestId = ++_this10.usersRequestId;
              _this10.usersLoading = true;
              _this10.usersError = false;
              _context8.p = 1;
              _context8.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                page: _this10.usersPage,
                per_page: _this10.usersPerPage,
                limit: _this10.usersPerPage,
                q: _this10.filters.q,
                status: _this10.filters.status,
                activity: _this10.filters.activity,
                progress: _this10.filters.progress,
                sessions: _this10.filters.sessionsGt0 ? 'gt0' : '',
                sort: _this10.sortKey,
                dir: _this10.sortDir
              });
            case 2:
              result = _context8.v;
              if (!(requestId !== _this10.usersRequestId)) {
                _context8.n = 3;
                break;
              }
              return _context8.a(2);
            case 3:
              _this10.users = result.users;
              _this10.usersTotal = result.total;
              _this10.usersPage = result.page || _this10.usersPage;
              _this10.usersPerPage = result.per_page || _this10.usersPerPage;
              _this10.usersTotalPages = result.total_pages || 1;
              _this10.selectedIds = _this10.selectedIds.filter(function (id) {
                return _this10.users.some(function (row) {
                  return row.id === id;
                });
              });
              _this10.syncDetailStatsFromList();
              _context8.n = 6;
              break;
            case 4:
              _context8.p = 4;
              ...
              return _context8.a(2);
            case 5:
              _this10.usersError = true;
            case 6:
              _context8.p = 6;
              if (requestId === _this10.usersRequestId) _this10.usersLoading = false;
              return _context8.f(6);
            case 7:
              return _context8.a(2);
          }
        }, _callee8, null, [[1, 4, 6, 7]]);
      }))();
    },
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              if (_this11.selectedIds.length) {
                _context9.n = 1;
                break;
              }
              return _context9.a(2);
            case 1:
              _this11.bulkBusy = true;
              _context9.p = 2;
              _context9.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                action: 'update_status',
                user_ids: _this11.selectedIds,
                subscription_status: _this11.bulkStatus
              });
            case 3:
              _this11.selectedIds = [];
              _context9.n = 4;
            ...
            case 4:
              _this11.refreshSnapshotQuiet();
              if (!_this11.selectedUserId) {
                _context9.n = 5;
                break;
              }
              delete _this11.detailCache[_this11.selectedUserId];
              _context9.n = 5;
              return _this11.loadDetail(_this11.selectedUserId);
            case 5:
              _this11.showToast(_this11.t('admin.toast_saved'));
            case 6:
              _context9.p = 6;
              _this11.bulkBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        ...
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            case 0:
              if (_this12.selectedIds.length) {
                _context0.n = 1;
                break;
              }
              return _context0.a(2);
            case 1:
              ids = _this12.selectedIds.filter(function (id) {
                return Number(id) !== _this12.ownerId;
              });
              if (ids.length) {
                _context0.n = 2;
                break;
              }
              _this12.showToast(_this12.t('admin.bulk_deactivate_self_blocked'));
              return _context0.a(2);
            case 2:
              if (window.confirm(_this12.t('admin.bulk_deactivate_confirm', {
                n: ids.length
              }))) {
                _context0.n = 3;
                break;
            ...
            case 6:
              _this12.refreshSnapshotQuiet();
              if (!_this12.selectedUserId) {
                _context0.n = 7;
                break;
              }
              delete _this12.detailCache[_this12.selectedUserId];
              _context0.n = 7;
              return _this12.loadDetail(_this12.selectedUserId);
            case 7:
              _this12.showToast(_this12.t('admin.toast_saved'));
            case 8:
              _context0.p = 8;
              _this12.bulkBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 1:
              payload = _context1.v;
              sanitized = _this13.sanitizePayload(payload);
              if (sanitized) _this13.data = sanitized;
              _context1.n = 3;
              break;
            case 2:
              _context1.p = 2;
    ...
    loadDetail: function loadDetail(id) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        var requestId, detail, _t7;
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            case 0:
              if (!_this14.detailCache[id]) {
                _context10.n = 1;
                break;
              }
              _this14.detail = _this14.detailCache[id];
              _this14.hydrateEditForm(_this14.detail.user);
              _this14.syncDetailStatsFromList();
              _this14.detailLoading = false;
              _this14.detailError = false;
              return _context10.a(2);
            case 1:
              requestId = ++_this14.detailRequestId;
              _this14.detailLoading = true;
              _this14.detailError = false;
              _context10.p = 2;
              _context10.n = 3;
            ...
            case 3:
              detail = _context10.v;
              if (!(requestId !== _this14.detailRequestId)) {
                _context10.n = 4;
                break;
              }
              return _context10.a(2);
            case 4:
              _this14.detail = detail;
              _this14.detailCache[id] = detail;
              _this14.hydrateEditForm(detail === null || detail === void 0 ? void 0 : detail.user);
              _this14.syncDetailStatsFromList();
              _context10.n = 7;
              break;
            case 5:
              ...
              return _context10.a(2);
            case 6:
              _this14.detailError = true;
              _this14.detail = null;
            case 7:
              _context10.p = 7;
              if (requestId === _this14.detailRequestId) _this14.detailLoading = false;
              return _context10.f(7);
            case 8:
              return _context10.a(2);
          }
        }, _callee10, null, [[2, 5, 7, 8]]);
      }))();
    },
    ...
    saveUser: function saveUser() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        var payload, result, _t8;
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.p = _context11.n) {
            case 0:
              if (!(!_this15.selectedUserId || !_this15.editFormDirty)) {
                _context11.n = 1;
                break;
              }
              return _context11.a(2);
            case 1:
              _this15.formSaving = true;
              _this15.formError = '';
              _context11.p = 2;
              payload = {
                name: _this15.editForm.name,
                email: _this15.editForm.email,
                subscription_status: _this15.editForm.subscription_status
              };
              _context11.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.updateUser(_this15.selectedUserId, payload);
            case 3:
              result = _context11.v;
              if (result !== null && result !== void 0 && result.detail) {
                _this15.detail = result.detail;
                _this15.detailCache[_this15.selectedUserId] = result.detail;
                _this15.hydrateEditForm(result.detail.user);
              }
              _context11.n = 4;
            ...
            case 5:
              _context11.p = 5;
              _t8 = _context11.v;
              _this15.formError = _this15.formErrorFrom(_t8);
            case 6:
              _context11.p = 6;
              _this15.formSaving = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        ...
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.p = _context12.n) {
            case 0:
              if (!(!_this16.selectedUserId || !_this16.deleteConfirmReady)) {
                _context12.n = 1;
                break;
              }
              return _context12.a(2);
            case 1:
              _this16.deletingUser = true;
              _this16.formError = '';
              _context12.p = 2;
              _context12.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteUser(_this16.selectedUserId);
            case 3:
              delete _this16.detailCache[_this16.selectedUserId];
              _this16.selectedUserId = null;
              _this16.detail = null;
              _this16.drawerOpen = false;
              _this16.closeDeleteModal();
              _context12.n = 4;
              return _this16.reloadUsers();
            case 4:
              _this16.refreshSnapshotQuiet();
              _this16.showToast(_this16.t('admin.toast_deleted'));
              _context12.n = 6;
              break;
            case 5:
              _context12.p = 5;
              _t9 = _context12.v;
              _this16.formError = _this16.formErrorFrom(_t9);
            case 6:
              _context12.p = 6;
              _this16.deletingUser = false;
    ...
    deleteNote: function deleteNote(row) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        var _this17$detail, _this17$detail2;
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.n) {
            ...
            case 1:
              if (window.confirm(_this17.t('admin.delete_note_confirm'))) {
                _context13.n = 2;
                break;
              }
              return _context13.a(2);
            ...
            case 3:
              if ((_this17$detail = _this17.detail) !== null && _this17$detail !== void 0 && _this17$detail.recent_notes) {
                _this17.detail.recent_notes = _this17.detail.recent_notes.filter(function (n) {
                  return n.id !== row.id;
                });
              }
              if ((_this17$detail2 = _this17.detail) !== null && _this17$detail2 !== void 0 && _this17$detail2.stats) {
                _this17.detail.stats.notes = Math.max(0, Number(_this17.detail.stats.notes || 1) - 1);
              }
              if (_this17.selectedUserId) _this17.detailCache[_this17.selectedUserId] = _this17.detail;
            case 4:
              return _context13.a(2);
          }
        }, _callee13);
    ...
    createUser: function createUser() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        var password, tier, subscriptionStatus, subscriptionTier, created, _t0;
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.p = _context14.n) {
            case 0:
              _this18.createSaving = true;
              _this18.createError = '';
              password = _this18.generateTempPassword();
              tier = String(_this18.createForm.subscription_tier || 'none').toLowerCase();
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.createUser({
                name: _this18.createForm.name,
                email: _this18.createForm.email,
            ...
            case 2:
              ...
              _this18.createOpen = false;
              _this18.usersPage = 1;
              _context14.n = 3;
              return _this18.reloadUsers();
            case 3:
              if (created !== null && created !== void 0 && created.id) {
                _this18.users = [created].concat(_toConsumableArray(_this18.users.filter(function (row) {
                  return Number(row.id) !== Number(created.id);
                }))).slice(0, _this18.usersPerPage);
                _this18.selectUser(created.id);
              }
              _this18.refreshSnapshotQuiet();
              _this18.showToast(_this18.t('admin.toast_created', {
                password: password
              }));
              _context14.n = 5;
              break;
            case 4:
              _context14.p = 4;
              _t0 = _context14.v;
              _this18.createError = _this18.formErrorFrom(_t0);
            case 5:
              _context14.p = 5;
              _this18.createSaving = false;
    ...
    onConsoleKeydown: function onConsoleKeydown(event) {
      ...
      var index = this.users.findIndex(function (row) {
        return row.id === _this19.selectedUserId;
      });
    ...
    subscriptionPillClass: function subscriptionPillClass(rowOrKey) {
      if (rowOrKey && _typeof(rowOrKey) === 'object') {
        ...
        if (_status === 'active' || _status === 'pro' || _status === 'trialing' || tier === 'pro') {
          return 'admin-pill--pro';
        }
        if (_status === 'free' || tier === 'free') return 'admin-pill--free';
        return 'admin-pill--none';
      }
      var status = String(rowOrKey || '').toLowerCase();
      if (status === 'active' || status === 'pro' || status === 'trialing') return 'admin-pill--pro';
...
var _hoisted_11 = ["data-dir"];
var _hoisted_12 = ["aria-label"];
var _hoisted_13 = {
  "class": "admin-top-learners__head"
};
...
var _hoisted_16 = {
  key: 1,
  "class": "admin-top-learners__list"
};
var _hoisted_17 = ["onClick"];
var _hoisted_18 = {
  "class": "admin-top-learners__name"
};
var _hoisted_19 = {
  "class": "admin-top-learners__meta"
};
...
var _hoisted_64 = ["onClick", "onKeydown"];
...
var _hoisted_79 = ["data-status", "title", "aria-label"];
var _hoisted_80 = ["aria-label", "aria-expanded", "onClick"];
var _hoisted_81 = {
  key: 0,
...
var _hoisted_102 = ["data-status", "title", "aria-label"];
var _hoisted_103 = {
...
var _hoisted_116 = ["open"];
var _hoisted_117 = {
  "class": "admin-collapse__body"
};
var _hoisted_118 = {
  key: 0,
  "class": "admin-muted"
...
var _hoisted_123 = ["aria-valuenow", "aria-label"];
var _hoisted_124 = ["open"];
var _hoisted_125 = {
  "class": "admin-collapse__body"
};
var _hoisted_126 = {
...
var _hoisted_131 = ["data-outcome"];
var _hoisted_132 = ["open"];
var _hoisted_133 = {
  "class": "admin-collapse__body"
};
var _hoisted_134 = {
...
var _hoisted_150 = ["title"];
var _hoisted_151 = ["value"];
var _hoisted_152 = {
  "class": "admin-account-info__id"
};
var _hoisted_153 = ["title"];
var _hoisted_154 = ["aria-label"];
var _hoisted_155 = ["open"];
var _hoisted_156 = {
  "class": "admin-collapse__body admin-danger"
};
var _hoisted_157 = {
  "class": "admin-danger__warn"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _$data$detail, _$options$selectedLis, _$data$detail2, _$data$detail3, _$data$detail4, _$data$detail5, _$data$detail6, _$data$detail7, _$data$detail$user, _$options$selectedLis2, _ref, _$data$detail$surah_p, _$data$detail$stats, _$data$detail$stats2, _$data$detail$recent_, _$data$detail$recent_2, _$data$detail$user2, _$data$detail$user3, _$data$detail$user4, _$data$detail$user5, _$data$detail$user6, _$data$detail$user7;
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", {
    id: "mainContent",
    "class": "admin-console",
    tabindex: "-1",
    onKeydown: _cache[75] || (_cache[75] = function () {
      return $options.onConsoleKeydown && $options.onConsoleKeydown.apply($options, arguments);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [$data.bootLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_2, [_cache[76] || (_cache[76] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-spinner",
    "aria-hidden": "true"
    ...
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.console_title')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-range",
    role: "group",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.days_30')), 3 /* TEXT, CLASS */)], 8 /* PROPS */, _hoisted_7), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: metric.key,
      type: "button",
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-kpi", metric.toneClass]),
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.trendLabel), 9 /* TEXT, PROPS */, _hoisted_11)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_10);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_9), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
    "class": "admin-top-learners",
    "aria-label": _ctx.t('admin.top_learners_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-range",
    role: "group",
    "aria-label": _ctx.t('admin.top_learners_sort')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-btn admin-btn--ghost admin-btn--sm", {
      'is-active': $data.topLearnersSort === 'sessions'
    }]),
    onClick: _cache[4] || (_cache[4] = function ($event) {
      return $data.topLearnersSort = 'sessions';
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_sort_sessions')), 3 /* TEXT, CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-btn admin-btn--ghost admin-btn--sm", {
      'is-active': $data.topLearnersSort === 'accuracy'
    }]),
    onClick: _cache[5] || (_cache[5] = function ($event) {
      return $data.topLearnersSort = 'accuracy';
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_sort_accuracy')), 3 /* TEXT, CLASS */)], 8 /* PROPS */, _hoisted_14)]), !$options.topLearners.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_15, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ol", _hoisted_16, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.topLearners, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-top-learners__row",
      onClick: function onClick($event) {
        return $options.jumpToUser(row.id);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || row.email || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_sessions', {
      n: row.sessions_completed
    })) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.top_learners_memorised', {
      n: row.memorised_ayahs
    })) + " ", 1 /* TEXT */), row.avg_ai_accuracy != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: 0
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.accuracy', {
      n: row.avg_ai_accuracy
    })), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 8 /* PROPS */, _hoisted_17)]);
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_21, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_24, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_25, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.usersTotal), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_26, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_subtitle')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_27, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "class": "bi bi-plus-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.add_user')), 1 /* TEXT */)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_29, [_cache[79] || (_cache[79] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_30), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.filters.q, void 0, {
    trim: true
  }]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[10] || (_cache[10] = function ($event) {
      return $data.filters.status = $event;
    }),
    "class": "admin-toolbar__select admin-toolbar__select--subs",
    onChange: _cache[11] || (_cache[11] = function () {
      return $options.onFilterChange && $options.onFilterChange.apply($options, arguments);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_status_all')), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.subscriptionOptions, function (status) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_33);
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_34, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_all_time')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_35, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_active_today')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_active_7d')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_37, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_active_30d')), 1 /* TEXT */)], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.filters.activity]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.sortDir === 'asc' ? _ctx.t('admin.sort_asc') : _ctx.t('admin.sort_desc')), 9 /* TEXT, PROPS */, _hoisted_43), _ctx.activeFilterCount > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 0,
    type: "button",
    ...
    n: _ctx.activeFilterCount
  })), 1 /* TEXT */), _cache[80] || (_cache[80] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-x",
    "aria-hidden": "true"
    ...
    role: "listbox",
    "aria-label": _ctx.t('admin.users_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_55, [_cache[83] || (_cache[83] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("colgroup", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("col", {
    "class": "admin-col-check"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("col", {
    "class": "admin-col-learner"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("col", {
    "class": "admin-col-subscription admin-col--desktop"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("col", {
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_57)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_learner')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", _hoisted_58, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_subscription')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_sessions')), 3 /* TEXT, CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-th-sort", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_accuracy')), 3 /* TEXT, CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", _hoisted_61, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_last_ai')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_status')), 1 /* TEXT */), _cache[81] || (_cache[81] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    "class": "admin-table__actions"
  }, null, -1 /* CACHED */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [!$data.users.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", _hoisted_62, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_63, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_empty')), 1 /* TEXT */), $options.filtersActive ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 0,
    type: "button",
    "class": "admin-link",
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
      ...
      "class": "admin-table__check",
      onClick: _cache[31] || (_cache[31] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {}, ["stop"]))
    ...
    }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_65)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_66, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_67, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", {
      title: row.name || _ctx.t('admin.unnamed')
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || _ctx.t('admin.unnamed')), 9 /* TEXT, PROPS */, _hoisted_68), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": "admin-table__email",
      title: row.email
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.email), 9 /* TEXT, PROPS */, _hoisted_69)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-pill", $options.subscriptionPillClass(row)])
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionBadgeLabel(row)), 3 /* TEXT, CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_71, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.memorised_ayahs), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_72, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.sessions_completed), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_73, [row.avg_ai_accuracy != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      key: 0,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(_ctx.accuracyToneClass(row.avg_ai_accuracy))
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.accuracy', {
      n: row.avg_ai_accuracy
    })), 3 /* TEXT, CLASS */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_74, "—"))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_75, [row.last_ai_check_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_76, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatDateShort(row.last_ai_check_at)), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_77, "—"))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_78, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    ...
    }, null, 8 /* PROPS */, _hoisted_79)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", {
      "class": "admin-table__actions",
    ...
    }, _toConsumableArray(_cache[82] || (_cache[82] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "aria-hidden": "true"
    }, "⋮", -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_80), $data.rowMenuId === row.id ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_81, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      role: "menuitem",
      onClick: function onClick($event) {
        return $options.askResetPassword(row);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_reset_password')), 9 /* TEXT, PROPS */, _hoisted_82), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
      role: "menuitem",
      href: "mailto:".concat(row.email),
      onClick: _cache[32] || (_cache[32] = function ($event) {
        return $data.rowMenuId = null;
      })
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_send_email')), 9 /* TEXT, PROPS */, _hoisted_83), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      role: "menuitem",
      "class": "is-danger",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_deactivate')), 9 /* TEXT, PROPS */, _hoisted_84), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      role: "menuitem",
      onClick: _cache[33] || (_cache[33] = function () {
        return $options.viewAsLearner && $options.viewAsLearner.apply($options, arguments);
      })
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_view_as_learner')), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */)])], 42 /* CLASS, PROPS, NEED_HYDRATION */, _hoisted_64);
  }), 128 /* KEYED_FRAGMENT */))])])], 8 /* PROPS */, _hoisted_54)), $data.usersTotal > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_85, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_86, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.pagination_prev')), 9 /* TEXT, PROPS */, _hoisted_87), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.pageNumbers, function (page) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: page,
      type: "button",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(page), 11 /* TEXT, CLASS, PROPS */, _hoisted_88);
  ...
  }, null, 8 /* PROPS */, _hoisted_91), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_92, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_93, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_94, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_95, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.userInitials(((_$data$detail = $data.detail) === null || _$data$detail === void 0 || (_$data$detail = _$data$detail.user) === null || _$data$detail === void 0 ? void 0 : _$data$detail.name) || ((_$options$selectedLis = $options.selectedListRow) === null || _$options$selectedLis === void 0 ? void 0 : _$options$selectedLis.name))), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_96, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-inline-field", {
      'is-dirty': $options.editFieldDirty('name')
    }])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_97, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_98, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_name')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_99, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_100, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_email')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    ...
    onBlur: _cache[41] || (_cache[41] = function () {
      return $options.onEditBlur && $options.onEditBlur.apply($options, arguments);
    })
    ...
    "class": "bi bi-pencil admin-inline-field__icon",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))])], 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_101, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "admin-status-dot",
  ...
  }, null, 8 /* PROPS */, _hoisted_102), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_103, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityStatusLabel(((_$data$detail5 = $data.detail) === null || _$data$detail5 === void 0 ? void 0 : _$data$detail5.user) || $options.selectedListRow || {})), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["admin-pill", $options.subscriptionPillClass(((_$data$detail6 = $data.detail) === null || _$data$detail6 === void 0 ? void 0 : _$data$detail6.user) || $options.selectedListRow)])
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionBadgeLabel(((_$data$detail7 = $data.detail) === null || _$data$detail7 === void 0 ? void 0 : _$data$detail7.user) || $options.selectedListRow)), 3 /* TEXT, CLASS */), $options.editFormDirty ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 0,
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formSaving ? _ctx.t('admin.saving') : _ctx.t('admin.save_user')), 9 /* TEXT, PROPS */, _hoisted_104)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $data.formError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_105, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_106)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_107, [$data.detailLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_108, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.detailError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_109, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : $data.detail ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_110, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_send_email')), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_112), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.action_deactivate')), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_113), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-quick-btn admin-quick-btn--danger",
    ...
    "class": "bi bi-trash",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user')), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_114)], 8 /* PROPS */, _hoisted_111), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_115, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.detailStats, function (stat) {
  ...
  }), 128 /* KEYED_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.surahs,
    onToggle: _cache[47] || (_cache[47] = function ($event) {
      return _ctx.onDrawerSectionToggle('surahs', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs')), 1 /* TEXT */), _cache[91] || (_cache[91] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_117, [!((_$data$detail$surah_p = $data.detail.surah_progress) !== null && _$data$detail$surah_p !== void 0 && _$data$detail$surah_p.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_118, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs_empty_soft')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_119, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.surah_progress, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.surah_number,
      "class": "admin-surah-progress"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_120, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_121, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.surah_name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_122, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surah_fraction', {
    ...
    }, null, 6 /* CLASS, STYLE */)], 8 /* PROPS */, _hoisted_123)]);
  }), 128 /* KEYED_FRAGMENT */))]))])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_116), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.sessions,
    onToggle: _cache[48] || (_cache[48] = function ($event) {
      return _ctx.onDrawerSectionToggle('sessions', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions')), 1 /* TEXT */), _cache[92] || (_cache[92] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_125, [!$options.detailSessions.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_126, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_127, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.detailSessions, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_128, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.surah_name || _ctx.t('admin.activity_type_session')), 1 /* TEXT */), $options.formatItemRange(row) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_129, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatItemRange(row)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_130, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": "admin-outcome",
      "data-outcome": _ctx.sessionOutcomeKey(row)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.sessionOutcomeLabel(row)), 9 /* TEXT, PROPS */, _hoisted_131), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatDateShort(row.occurred_at) || $options.formatRelative(row.occurred_at)), 1 /* TEXT */)])]);
  }), 128 /* KEYED_FRAGMENT */))]))])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_124), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.ai,
    onToggle: _cache[49] || (_cache[49] = function ($event) {
      return _ctx.onDrawerSectionToggle('ai', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai')), 1 /* TEXT */), _cache[93] || (_cache[93] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_133, [!$options.detailAiChecks.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_134, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_135, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.detailAiChecks, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_136, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.surah_name || _ctx.t('admin.activity_type_ai')), 1 /* TEXT */), $options.formatItemRange(row) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_137, "· " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatItemRange(row)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_138, [row.accuracy_percent != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      key: 0,
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(_ctx.accuracyToneClass(row.accuracy_percent))
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.accuracy', {
  ...
  }), 128 /* KEYED_FRAGMENT */))]))])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_132), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.notes,
    onToggle: _cache[51] || (_cache[51] = function ($event) {
      return _ctx.onDrawerSectionToggle('notes', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes')), 1 /* TEXT */), _cache[94] || (_cache[94] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_140, [!Number(((_$data$detail$stats = $data.detail.stats) === null || _$data$detail$stats === void 0 ? void 0 : _$data$detail$stats.notes) || 0) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_141, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.notes_none')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_142, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.notes_written', {
    n: Number(((_$data$detail$stats2 = $data.detail.stats) === null || _$data$detail$stats2 === void 0 ? void 0 : _$data$detail$stats2.notes) || 0)
  })) + " ", 1 /* TEXT */), (_$data$detail$recent_ = $data.detail.recent_notes) !== null && _$data$detail$recent_ !== void 0 && _$data$detail$recent_.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 0,
    type: "button",
    "class": "admin-link",
    onClick: _cache[50] || (_cache[50] = function ($event) {
      return $data.notesExpanded = !$data.notesExpanded;
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_notes_short')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])), $data.notesExpanded && (_$data$detail$recent_2 = $data.detail.recent_notes) !== null && _$data$detail$recent_2 !== void 0 && _$data$detail$recent_2.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_143, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.recent_notes, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id,
      "class": "admin-mini--stack"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_144, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-link",
      onClick: function onClick($event) {
        return $options.deleteNote(row);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_145)]), row.snippet ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_146, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.snippet), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
  }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_139), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.account,
    onToggle: _cache[55] || (_cache[55] = function ($event) {
      return _ctx.onDrawerSectionToggle('account', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.account_info')), 1 /* TEXT */), _cache[95] || (_cache[95] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_148, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dl", _hoisted_149, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dt", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_created_at')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dd", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatDateShort((_$data$detail$user2 = $data.detail.user) === null || _$data$detail$user2 === void 0 ? void 0 : _$data$detail$user2.created_at) || '—'), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dt", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_active')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dd", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative((_$data$detail$user4 = $data.detail.user) === null || _$data$detail$user4 === void 0 ? void 0 : _$data$detail$user4.last_activity_at) || '—'), 9 /* TEXT, PROPS */, _hoisted_150)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dt", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_subscription')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dd", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionBadgeLabel($data.detail.user)) + " ", 1 /* TEXT */), (_$data$detail$user5 = $data.detail.user) !== null && _$data$detail$user5 !== void 0 && _$data$detail$user5.subscription_current_period_ends_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatDateShort($data.detail.user.subscription_current_period_ends_at)), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_151);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.editForm.subscription_status]])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dt", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_user_id')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("dd", _hoisted_152, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    title: String(((_$data$detail$user6 = $data.detail.user) === null || _$data$detail$user6 === void 0 ? void 0 : _$data$detail$user6.id) || $data.selectedUserId)
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.truncateId(((_$data$detail$user7 = $data.detail.user) === null || _$data$detail$user7 === void 0 ? void 0 : _$data$detail$user7.id) || $data.selectedUserId)), 9 /* TEXT, PROPS */, _hoisted_153), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-icon-btn admin-icon-btn--sm",
    "aria-label": _ctx.t('admin.copy_user_id'),
    onClick: _cache[54] || (_cache[54] = function ($event) {
      var _$data$detail$user8;
      return _ctx.copyUserId(((_$data$detail$user8 = $data.detail.user) === null || _$data$detail$user8 === void 0 ? void 0 : _$data$detail$user8.id) || $data.selectedUserId);
    })
  }, _toConsumableArray(_cache[96] || (_cache[96] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-clipboard",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_154)])])])])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_147), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", {
    "class": "admin-collapse",
    open: _ctx.drawerSections.danger,
    onToggle: _cache[57] || (_cache[57] = function ($event) {
      return _ctx.onDrawerSectionToggle('danger', $event);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.danger_zone')), 1 /* TEXT */), _cache[97] || (_cache[97] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-chevron-down admin-collapse__chevron",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_156, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_157, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user_warning')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--danger admin-danger__btn",
    disabled: $data.deletingUser || $options.isSelfSelected,
    onClick: _cache[56] || (_cache[56] = function () {
      return $options.openDeleteModal && $options.openDeleteModal.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_account')), 9 /* TEXT, PROPS */, _hoisted_158), $options.isSelfSelected ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_159, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_self_blocked')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_155)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])], 8 /* PROPS */, _hoisted_90)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Create modal "), $data.createOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
  ...
  }, _toConsumableArray(_cache[98] || (_cache[98] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_164)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
    "class": "admin-form",
    onSubmit: _cache[65] || (_cache[65] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: tier,
      value: tier
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.tierLabel(tier)), 9 /* TEXT, PROPS */, _hoisted_165);
    ...
    trim: true
  }]])]), $data.createError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_166, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.createError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_167, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, _toConsumableArray(_cache[99] || (_cache[99] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_173)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_174, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user_prompt', {
    ...
    trim: true
  }]])]), $data.formError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_175, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_176, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--ghost",
    onClick: _cache[69] || (_cache[69] = function () {
      return $options.closeDeleteModal && $options.closeDeleteModal.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.cancel')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    onClick: _cache[70] || (_cache[70] = function () {
      return $options.confirmDeleteUser && $options.confirmDeleteUser.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.deletingUser ? _ctx.t('admin.saving') : _ctx.t('admin.delete_user')), 9 /* TEXT, PROPS */, _hoisted_177)])])], 8 /* PROPS */, _hoisted_169)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Action confirm modal (reset / deactivate) "), $data.confirmOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 2,
    "class": "admin-modal-root",
    role: "dialog",
    "aria-modal": "true",
  ...
  }, null, 8 /* PROPS */, _hoisted_179), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_180, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_181, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.confirmTitle), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-icon-btn",
    "aria-label": _ctx.t('admin.drawer_close'),
  ...
  }, _toConsumableArray(_cache[100] || (_cache[100] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_182)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_183, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.confirmMessage), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_184, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--ghost",
    onClick: _cache[73] || (_cache[73] = function () {
      return $options.closeConfirmModal && $options.closeConfirmModal.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.cancel')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    onClick: _cache[74] || (_cache[74] = function () {
      return $options.runConfirmAction && $options.runConfirmAction.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.confirmBusy ? _ctx.t('admin.saving') : $options.confirmTitle), 11 /* TEXT, CLASS, PROPS */, _hoisted_185)])])], 8 /* PROPS */, _hoisted_178)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Toast "), $data.toastMessage ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_186, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.toastMessage), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 32 /* NEED_HYDRATION */);
}
