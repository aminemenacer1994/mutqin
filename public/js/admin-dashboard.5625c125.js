  ...
  methods: {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            ...
            case 3:
              ...
              if (_this9.selectedUserId && !_this9.users.some(function (row) {
                return row.id === _this9.selectedUserId;
              })) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 1:
              if (window.confirm(_this1.t('admin.bulk_delete_confirm', {
                n: _this1.selectedIds.length
              }))) {
                _context7.n = 2;
                break;
              }
            ...
            case 2:
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                action: 'delete',
                user_ids: _this1.selectedIds
              });
            case 4:
              deletedSelected = _this1.selectedIds.includes(_this1.selectedUserId);
              _this1.selectedIds = [];
              if (deletedSelected) {
    ...
    selectUser: function selectUser(id) {
      var _ref7 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref7$silentMobile = _ref7.silentMobile,
        silentMobile = _ref7$silentMobile === void 0 ? false : _ref7$silentMobile;
      var num = Number(id);
      if (!num) return;
