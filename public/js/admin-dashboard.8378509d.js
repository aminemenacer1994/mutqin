  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 1:
              if (window.confirm(_this6.t('admin.action_reset_password_confirm', {
                email: row.email
              }))) {
                _context3.n = 2;
                break;
              ...
              return _context3.a(2);
            case 2:
              password = _this6.generateTempPassword();
              _context3.p = 3;
              _context3.n = 4;
            ...
            case 4:
              window.alert(_this6.t('admin.action_reset_password_done', {
                password: password
              }));
              _context3.n = 6;
              break;
            case 5:
              _context3.p = 5;
              _t2 = _context3.v;
              window.alert(_this6.formErrorFrom(_t2));
            case 6:
              return _context3.a(2);
          }
        }, _callee3, null, [[3, 5]]);
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              ...
              if (!(!(row !== null && row !== void 0 && row.id) || Number(row.id) === _this7.ownerId)) {
                _context4.n = 1;
                break;
              }
              return _context4.a(2);
            case 1:
              if (window.confirm(_this7.t('admin.action_deactivate_confirm', {
                email: row.email
              }))) {
                _context4.n = 2;
                break;
            ...
            case 4:
              if (!(_this7.selectedUserId === row.id)) {
                _context4.n = 5;
                break;
              }
              delete _this7.detailCache[row.id];
              _context4.n = 5;
              return _this7.loadDetail(row.id);
            case 5:
              _context4.n = 7;
              break;
            case 6:
              _context4.p = 6;
              _t3 = _context4.v;
              window.alert(_this7.formErrorFrom(_t3));
            case 7:
              return _context4.a(2);
          }
        }, _callee4, null, [[2, 6]]);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              requestId = ++_this8.usersRequestId;
              _this8.usersLoading = true;
              _this8.usersError = false;
              _context5.p = 1;
              _context5.n = 2;
            ...
            case 2:
              result = _context5.v;
              if (!(requestId !== _this8.usersRequestId)) {
                _context5.n = 3;
                break;
              }
              return _context5.a(2);
            case 3:
              _this8.users = result.users;
              _this8.usersTotal = result.total;
              _this8.selectedIds = _this8.selectedIds.filter(function (id) {
                return _this8.users.some(function (row) {
                  return row.id === id;
                });
              });
              if (_this8.selectedUserId && !_this8.users.some(function (row) {
                return row.id === _this8.selectedUserId;
              })) {
            ...
            case 4:
              ...
              return _context5.a(2);
            case 5:
              _this8.usersError = true;
            case 6:
              _context5.p = 6;
              if (requestId === _this8.usersRequestId) _this8.usersLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              if (_this9.selectedIds.length) {
                _context6.n = 1;
                break;
              }
              return _context6.a(2);
            case 1:
              _this9.bulkBusy = true;
              _context6.p = 2;
              _context6.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                action: 'update_status',
                user_ids: _this9.selectedIds,
                subscription_status: _this9.bulkStatus
              });
            case 3:
              _this9.selectedIds = [];
              _context6.n = 4;
              return _this9.reloadUsers();
            case 4:
              if (!_this9.selectedUserId) {
                _context6.n = 5;
                break;
              }
              delete _this9.detailCache[_this9.selectedUserId];
              _context6.n = 5;
              return _this9.loadDetail(_this9.selectedUserId);
            case 5:
              _context6.p = 5;
              _this9.bulkBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 1:
              if (window.confirm(_this0.t('admin.bulk_delete_confirm', {
                n: _this0.selectedIds.length
              }))) {
                _context7.n = 2;
                break;
              }
            ...
            case 4:
              deletedSelected = _this0.selectedIds.includes(_this0.selectedUserId);
              _this0.selectedIds = [];
              if (deletedSelected) {
                _this0.selectedUserId = null;
                _this0.detail = null;
                _this0.mobileDetailOpen = false;
              }
              _context7.n = 5;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        ...
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 1:
              payload = _context8.v;
              sanitized = _this1.sanitizePayload(payload);
              if (sanitized) _this1.data = sanitized;
              _context8.n = 3;
              break;
            case 2:
              _context8.p = 2;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              if (!_this10.detailCache[id]) {
                _context9.n = 1;
                break;
              }
              _this10.detail = _this10.detailCache[id];
              _this10.hydrateEditForm(_this10.detail.user);
              _this10.detailLoading = false;
              _this10.detailError = false;
              return _context9.a(2);
            case 1:
              requestId = ++_this10.detailRequestId;
              _this10.detailLoading = true;
              _this10.detailError = false;
              _context9.p = 2;
              _context9.n = 3;
            ...
            case 3:
              detail = _context9.v;
              if (!(requestId !== _this10.detailRequestId)) {
                _context9.n = 4;
                break;
              }
              return _context9.a(2);
            case 4:
              ...
              _this10.detailCache[id] = detail;
              _this10.hydrateEditForm(detail === null || detail === void 0 ? void 0 : detail.user);
              _context9.n = 7;
              break;
            case 5:
              _context9.p = 5;
              ...
              return _context9.a(2);
            case 6:
              _this10.detailError = true;
              _this10.detail = null;
            case 7:
              _context9.p = 7;
              if (requestId === _this10.detailRequestId) _this10.detailLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        ...
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            ...
            case 1:
              _this11.formSaving = true;
              _this11.formError = '';
              _this11.formSuccess = '';
              _context0.p = 2;
              payload = {
                name: _this11.editForm.name,
                email: _this11.editForm.email,
                locale: _this11.editForm.locale,
                subscription_status: _this11.editForm.subscription_status
              };
              if (_this11.editForm.password) payload.password = _this11.editForm.password;
              _context0.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.updateUser(_this11.selectedUserId, payload);
            case 3:
              result = _context0.v;
              if (result !== null && result !== void 0 && result.detail) {
                _this11.detail = result.detail;
                _this11.detailCache[_this11.selectedUserId] = result.detail;
                _this11.hydrateEditForm(result.detail.user);
              }
              _this11.formSuccess = _this11.t('admin.save_ok');
              _context0.n = 4;
            ...
            case 5:
              _context0.p = 5;
              _t7 = _context0.v;
              _this11.formError = _this11.formErrorFrom(_t7);
            case 6:
              _context0.p = 6;
              _this11.formSaving = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            case 0:
              if (!(!_this12.selectedUserId || _this12.isSelfSelected)) {
                _context1.n = 1;
                break;
              }
              return _context1.a(2);
            case 1:
              if (window.confirm(_this12.t('admin.delete_user_confirm'))) {
                _context1.n = 2;
                break;
              }
              return _context1.a(2);
            case 2:
              _this12.deletingUser = true;
              _context1.p = 3;
              _context1.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteUser(_this12.selectedUserId);
            case 4:
              delete _this12.detailCache[_this12.selectedUserId];
              _this12.selectedUserId = null;
              _this12.detail = null;
              _this12.mobileDetailOpen = false;
              _context1.n = 5;
              return _this12.reloadUsers();
            case 5:
              _this12.refreshSnapshotQuiet();
              if (_this12.users[0]) _this12.selectUser(_this12.users[0].id, {
                silentMobile: true
              });
              _context1.n = 7;
              break;
            case 6:
              _context1.p = 6;
              _t8 = _context1.v;
              _this12.formError = _this12.formErrorFrom(_t8);
            case 7:
              _context1.p = 7;
              _this12.deletingUser = false;
    ...
    deleteNote: function deleteNote(row) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        var _this13$detail, _this13$detail2;
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.n) {
            ...
            case 1:
              if (window.confirm(_this13.t('admin.delete_note_confirm'))) {
                _context10.n = 2;
                break;
              }
              return _context10.a(2);
            ...
            case 3:
              if ((_this13$detail = _this13.detail) !== null && _this13$detail !== void 0 && _this13$detail.recent_notes) {
                _this13.detail.recent_notes = _this13.detail.recent_notes.filter(function (n) {
                  return n.id !== row.id;
                });
              }
              if ((_this13$detail2 = _this13.detail) !== null && _this13$detail2 !== void 0 && _this13$detail2.stats) {
                _this13.detail.stats.notes = Math.max(0, Number(_this13.detail.stats.notes || 1) - 1);
              }
              if (_this13.selectedUserId) _this13.detailCache[_this13.selectedUserId] = _this13.detail;
            case 4:
              return _context10.a(2);
          }
        }, _callee10);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        ...
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.p = _context11.n) {
            case 0:
              _this14.createSaving = true;
              _this14.createError = '';
              _context11.p = 1;
              _context11.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.createUser(_objectSpread({}, _this14.createForm));
            case 2:
              created = _context11.v;
              _this14.createOpen = false;
              _context11.n = 3;
              return _this14.reloadUsers();
            case 3:
              _this14.refreshSnapshotQuiet();
              if (created !== null && created !== void 0 && created.id) {
                _this14.setTab('users');
                _this14.selectUser(created.id);
              }
              _context11.n = 5;
              break;
            case 4:
              _context11.p = 4;
              _t9 = _context11.v;
              _this14.createError = _this14.formErrorFrom(_t9);
            case 5:
              _context11.p = 5;
              _this14.createSaving = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.p = _context12.n) {
            ...
            case 2:
              _this15.inboxItems = _context12.v;
            case 3:
              _context12.p = 3;
              _this15.inboxLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.p = _context13.n) {
            ...
            case 2:
              _this16.activityItems = _context13.v;
            case 3:
              _context13.p = 3;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        ...
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.n) {
            ...
            case 2:
              _this17.inboxItems = _this17.inboxItems.filter(function (row) {
                return row.id !== item.id;
              });
              if ((_this17$data = _this17.data) !== null && _this17$data !== void 0 && (_this17$data = _this17$data.snapshot) !== null && _this17$data !== void 0 && _this17$data.pending_contacts) {
                _this17.data.snapshot.pending_contacts.value = Math.max(0, Number(_this17.data.snapshot.pending_contacts.value || 1) - 1);
              }
            case 3:
              return _context14.a(2);
          }
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15() {
        ...
        return _regenerator().w(function (_context15) {
          while (1) switch (_context15.n) {
            ...
            case 1:
              if (window.confirm(_this18.t('admin.delete_contact_confirm'))) {
                _context15.n = 2;
                break;
              }
              return _context15.a(2);
            ...
            case 3:
              ...
              if (item.status === 'pending' && (_this18$data = _this18.data) !== null && _this18$data !== void 0 && (_this18$data = _this18$data.snapshot) !== null && _this18$data !== void 0 && _this18$data.pending_contacts) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
      ...
      "aria-hidden": "true"
    }, "⋮", -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_57), $data.rowMenuId === row.id ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_58, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      role: "menuitem",
      onClick: function onClick($event) {
