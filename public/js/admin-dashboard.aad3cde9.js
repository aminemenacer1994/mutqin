  ...
  computed: {
    ...
    filteredActivity: function filteredActivity() {
      ...
      return this.activityItems.filter(function (item) {
        return item.type === _this2.activityFilter;
      });
    }
  },
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 4:
              _context.n = 5;
              return Promise.all([_this3.reloadUsers(), _this3.loadInbox(), _this3.loadActivity()]);
            case 5:
              if (!_this3.selectedUserId && _this3.users[0]) {
                _this3.selectUser(_this3.users[0].id, {
                  silentMobile: true
                });
              }
              _context.n = 7;
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 2:
              ...
              if (sanitized) _this4.data = sanitized;
              _context2.n = 3;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              requestId = ++_this6.usersRequestId;
              _this6.usersLoading = true;
              _this6.usersError = false;
              _context3.p = 1;
              _context3.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.getUsers({
                limit: 200,
                q: _this6.filters.q,
                status: _this6.filters.status,
                activity: _this6.filters.activity,
                progress: _this6.filters.progress,
                sort: _this6.sortKey,
                dir: _this6.sortDir
              });
            case 2:
              result = _context3.v;
              if (!(requestId !== _this6.usersRequestId)) {
                _context3.n = 3;
                break;
              }
              return _context3.a(2);
            case 3:
              _this6.users = result.users;
              _this6.usersTotal = result.total;
              _this6.selectedIds = _this6.selectedIds.filter(function (id) {
                return _this6.users.some(function (row) {
                  return row.id === id;
                });
              });
              if (_this6.selectedUserId && !_this6.users.some(function (row) {
                return row.id === _this6.selectedUserId;
              })) {
                // keep detail if filtered out, still ok
              }
              _context3.n = 6;
              break;
            case 4:
              ...
              return _context3.a(2);
            case 5:
              _this6.usersError = true;
            case 6:
              _context3.p = 6;
              if (requestId === _this6.usersRequestId) _this6.usersLoading = false;
          ...
          while (1) switch (_context4.p = _context4.n) {
            ...
            case 1:
              ...
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                ...
                subscription_status: _this7.bulkStatus
              });
            case 3:
              _this7.selectedIds = [];
              _context4.n = 4;
            ...
            case 4:
              if (!_this7.selectedUserId) {
                _context4.n = 5;
                break;
              }
              delete _this7.detailCache[_this7.selectedUserId];
              _context4.n = 5;
              return _this7.loadDetail(_this7.selectedUserId);
            case 5:
              _context4.p = 5;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              if (_this8.selectedIds.length) {
                _context5.n = 1;
                break;
              }
              return _context5.a(2);
            case 1:
              if (window.confirm(_this8.t('admin.bulk_delete_confirm', {
                n: _this8.selectedIds.length
              }))) {
                _context5.n = 2;
                break;
              }
              return _context5.a(2);
            case 2:
              _this8.bulkBusy = true;
              _context5.p = 3;
              _context5.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.bulkUsers({
                action: 'delete',
                user_ids: _this8.selectedIds
              });
            case 4:
              deletedSelected = _this8.selectedIds.includes(_this8.selectedUserId);
              _this8.selectedIds = [];
              if (deletedSelected) {
                _this8.selectedUserId = null;
                _this8.detail = null;
                _this8.mobileDetailOpen = false;
              }
              _context5.n = 5;
              return _this8.reloadUsers();
            case 5:
              _this8.refreshSnapshotQuiet();
            case 6:
              _context5.p = 6;
              _this8.bulkBusy = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              payload = _context6.v;
              sanitized = _this9.sanitizePayload(payload);
              if (sanitized) _this9.data = sanitized;
              _context6.n = 3;
              break;
            case 2:
              _context6.p = 2;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              if (!_this0.detailCache[id]) {
                _context7.n = 1;
                break;
              }
              _this0.detail = _this0.detailCache[id];
              _this0.hydrateEditForm(_this0.detail.user);
              _this0.detailLoading = false;
              _this0.detailError = false;
              return _context7.a(2);
            case 1:
              requestId = ++_this0.detailRequestId;
              _this0.detailLoading = true;
              _this0.detailError = false;
              _context7.p = 2;
              _context7.n = 3;
            ...
            case 3:
              detail = _context7.v;
              if (!(requestId !== _this0.detailRequestId)) {
                _context7.n = 4;
                break;
              }
              return _context7.a(2);
            case 4:
              _this0.detail = detail;
              _this0.detailCache[id] = detail;
              _this0.hydrateEditForm(detail === null || detail === void 0 ? void 0 : detail.user);
              _context7.n = 7;
              break;
            case 5:
              _context7.p = 5;
              ...
              return _context7.a(2);
            case 6:
              _this0.detailError = true;
              _this0.detail = null;
            case 7:
              _context7.p = 7;
              if (requestId === _this0.detailRequestId) _this0.detailLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        ...
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 1:
              _this1.formSaving = true;
              _this1.formError = '';
              _this1.formSuccess = '';
              _context8.p = 2;
              payload = {
                name: _this1.editForm.name,
                email: _this1.editForm.email,
                locale: _this1.editForm.locale,
                subscription_status: _this1.editForm.subscription_status
              };
              if (_this1.editForm.password) payload.password = _this1.editForm.password;
              _context8.n = 3;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.updateUser(_this1.selectedUserId, payload);
            case 3:
              result = _context8.v;
              if (result !== null && result !== void 0 && result.detail) {
                _this1.detail = result.detail;
                _this1.detailCache[_this1.selectedUserId] = result.detail;
                _this1.hydrateEditForm(result.detail.user);
              }
              _this1.formSuccess = _this1.t('admin.save_ok');
              _context8.n = 4;
            ...
            case 5:
              _context8.p = 5;
              _t5 = _context8.v;
              _this1.formError = _this1.formErrorFrom(_t5);
            case 6:
              _context8.p = 6;
              _this1.formSaving = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            case 0:
              if (!(!_this10.selectedUserId || _this10.isSelfSelected)) {
                _context9.n = 1;
                break;
              }
              return _context9.a(2);
            case 1:
              if (window.confirm(_this10.t('admin.delete_user_confirm'))) {
                _context9.n = 2;
                break;
              }
              return _context9.a(2);
            case 2:
              _this10.deletingUser = true;
              _context9.p = 3;
              _context9.n = 4;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.deleteUser(_this10.selectedUserId);
            case 4:
              delete _this10.detailCache[_this10.selectedUserId];
              _this10.selectedUserId = null;
              _this10.detail = null;
              _this10.mobileDetailOpen = false;
              _context9.n = 5;
              return _this10.reloadUsers();
            case 5:
              _this10.refreshSnapshotQuiet();
              if (_this10.users[0]) _this10.selectUser(_this10.users[0].id, {
                silentMobile: true
              });
              _context9.n = 7;
              break;
            case 6:
              _context9.p = 6;
              _t6 = _context9.v;
              _this10.formError = _this10.formErrorFrom(_t6);
            case 7:
              _context9.p = 7;
              _this10.deletingUser = false;
    ...
    deleteNote: function deleteNote(row) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var _this11$detail, _this11$detail2;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            ...
            case 1:
              if (window.confirm(_this11.t('admin.delete_note_confirm'))) {
                _context0.n = 2;
                break;
              }
              return _context0.a(2);
            ...
            case 3:
              if ((_this11$detail = _this11.detail) !== null && _this11$detail !== void 0 && _this11$detail.recent_notes) {
                _this11.detail.recent_notes = _this11.detail.recent_notes.filter(function (n) {
                  return n.id !== row.id;
                });
              }
              if ((_this11$detail2 = _this11.detail) !== null && _this11$detail2 !== void 0 && _this11$detail2.stats) {
                _this11.detail.stats.notes = Math.max(0, Number(_this11.detail.stats.notes || 1) - 1);
              }
              if (_this11.selectedUserId) _this11.detailCache[_this11.selectedUserId] = _this11.detail;
            case 4:
              return _context0.a(2);
          }
        }, _callee0);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            case 0:
              _this12.createSaving = true;
              _this12.createError = '';
              _context1.p = 1;
              _context1.n = 2;
              return _scripts_api_admin__WEBPACK_IMPORTED_MODULE_0__.adminApi.createUser(_objectSpread({}, _this12.createForm));
            case 2:
              created = _context1.v;
              _this12.createOpen = false;
              _context1.n = 3;
              return _this12.reloadUsers();
            case 3:
              _this12.refreshSnapshotQuiet();
              if (created !== null && created !== void 0 && created.id) {
                _this12.setTab('users');
                _this12.selectUser(created.id);
              }
              _context1.n = 5;
              break;
            case 4:
              _context1.p = 4;
              _t7 = _context1.v;
              _this12.createError = _this12.formErrorFrom(_t7);
            case 5:
              _context1.p = 5;
              _this12.createSaving = false;
              return _context1.f(5);
            case 6:
              return _context1.a(2);
          }
        }, _callee1, null, [[1, 4, 5, 6]]);
      }))();
    },
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            ...
            case 2:
              _this13.inboxItems = _context10.v;
            case 3:
              _context10.p = 3;
              _this13.inboxLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.p = _context11.n) {
            ...
            case 2:
              _this14.activityItems = _context11.v;
            case 3:
              _context11.p = 3;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
        ...
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.n) {
            ...
            case 2:
              _this15.inboxItems = _this15.inboxItems.filter(function (row) {
                return row.id !== item.id;
              });
              if ((_this15$data = _this15.data) !== null && _this15$data !== void 0 && (_this15$data = _this15$data.snapshot) !== null && _this15$data !== void 0 && _this15$data.pending_contacts) {
                _this15.data.snapshot.pending_contacts.value = Math.max(0, Number(_this15.data.snapshot.pending_contacts.value || 1) - 1);
              }
            case 3:
              return _context12.a(2);
          }
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
        ...
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.n) {
            ...
            case 1:
              if (window.confirm(_this16.t('admin.delete_contact_confirm'))) {
                _context13.n = 2;
                break;
              }
              return _context13.a(2);
            ...
            case 3:
              _this16.inboxItems = _this16.inboxItems.filter(function (row) {
                return row.id !== item.id;
              });
              if (item.status === 'pending' && (_this16$data = _this16.data) !== null && _this16$data !== void 0 && (_this16$data = _this16$data.snapshot) !== null && _this16$data !== void 0 && _this16$data.pending_contacts) {
                _this16.data.snapshot.pending_contacts.value = Math.max(0, Number(_this16.data.snapshot.pending_contacts.value || 1) - 1);
              }
            case 4:
              return _context13.a(2);
          }
    ...
    onConsoleKeydown: function onConsoleKeydown(event) {
      ...
      var index = this.users.findIndex(function (row) {
        return row.id === _this17.selectedUserId;
      });
...
var _hoisted_45 = ["onClick", "onKeydown"];
var _hoisted_46 = ["checked", "onChange"];
var _hoisted_47 = {
...
var _hoisted_103 = ["disabled", "onClick"];
var _hoisted_104 = ["data-type"];
var _hoisted_105 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", {
    ...
    "class": "admin-console",
    tabindex: "-1",
    onKeydown: _cache[37] || (_cache[37] = function () {
      return $options.onConsoleKeydown && $options.onConsoleKeydown.apply($options, arguments);
    })
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [$data.bootLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_2, [_cache[38] || (_cache[38] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "admin-spinner",
    "aria-hidden": "true"
    ...
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.eyebrow')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.console_title')), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.value), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(metric.label), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_11);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_10)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("nav", {
    "class": "admin-tabs",
    role: "tablist",
    ...
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.label) + " ", 1 /* TEXT */), item.badge != null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("em", _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.badge), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_13);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_12), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" USERS "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_18), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.filters.q, void 0, {
    trim: true
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_status_all')), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.subscriptionOptions, function (status) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_20);
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_activity_all')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_active_7d')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_23, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_inactive_30d')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_24, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_never')), 1 /* TEXT */)], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.filters.activity]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_25, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_progress_all')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_26, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_progress_has')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_27, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.filter_progress_none')), 1 /* TEXT */)], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.filters.progress]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_28, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.sort_created')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.sort_last_active')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.sort_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.sort_sessions')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.sort_name')), 1 /* TEXT */)], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.sortKey]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-btn admin-btn--ghost admin-btn--sm",
    onClick: _cache[13] || (_cache[13] = function () {
      return $options.toggleSortDir && $options.toggleSortDir.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.sortDir === 'asc' ? _ctx.t('admin.sort_asc') : _ctx.t('admin.sort_desc')), 1 /* TEXT */)]), $data.selectedIds.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.bulk_selected', {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.bulk_set_status')), 9 /* TEXT, PROPS */, _hoisted_35), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.bulk_delete')), 9 /* TEXT, PROPS */, _hoisted_36), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-link",
    onClick: _cache[17] || (_cache[17] = function ($event) {
      return $data.selectedIds = [];
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.bulk_clear')), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_37, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_showing', {
    n: $data.users.length,
    total: $data.usersTotal
  })), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "checkbox",
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_39), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.select_all')), 1 /* TEXT */)])]), $data.usersLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.usersError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_41, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : !$data.users.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_42, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.users_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 4,
    "class": "admin-table-wrap",
    role: "listbox",
    "aria-label": _ctx.t('admin.users_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_44, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [_cache[40] || (_cache[40] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    "class": "admin-table__check"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_learner')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_subscription')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_memorised')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_sessions')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.ai_avg')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.col_active')), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.users, function (row) {
    ...
    }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_46)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_47, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.name || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.email), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_48, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(row.subscription_status)), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_49, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.memorised_ayahs), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_50, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.sessions_completed), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_51, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.avg_ai_accuracy != null ? _ctx.t('admin.accuracy', {
      n: row.avg_ai_accuracy
    }) : '—'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_52, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(row.last_activity_at) || '—'), 1 /* TEXT */)], 42 /* CLASS, PROPS, NEED_HYDRATION */, _hoisted_45);
  }), 128 /* KEYED_FRAGMENT */))])])], 8 /* PROPS */, _hoisted_43))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", {
  ...
  }, [!$data.selectedUserId ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_53, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.detail_empty')), 1 /* TEXT */)])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_54, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.back_to_list')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(((_$data$detail = $data.detail) === null || _$data$detail === void 0 || (_$data$detail = _$data$detail.user) === null || _$data$detail === void 0 ? void 0 : _$data$detail.name) || _ctx.t('admin.unnamed')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$data$detail2 = $data.detail) === null || _$data$detail2 === void 0 || (_$data$detail2 = _$data$detail2.user) === null || _$data$detail2 === void 0 ? void 0 : _$data$detail2.email), 1 /* TEXT */)])]), $data.detailLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_55, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : $data.detailError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_56, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_load_error')), 1 /* TEXT */)) : $data.detail ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_57, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_58, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.detailStats, function (stat) {
  ...
  }), 128 /* KEYED_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_59, [(_$data$detail$user = $data.detail.user) !== null && _$data$detail$user !== void 0 && _$data$detail$user.current_surah_name ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: loc,
      value: loc
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(loc), 9 /* TEXT, PROPS */, _hoisted_61);
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_62);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.editForm.subscription_status]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_63, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.field_password_optional')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.editForm.password]])])]), $data.formError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_64, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.formSuccess ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_65, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formSuccess), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_66, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "submit",
    "class": "admin-btn admin-btn--primary",
    disabled: $data.formSaving
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formSaving ? _ctx.t('admin.saving') : _ctx.t('admin.save_user')), 9 /* TEXT, PROPS */, _hoisted_67)])], 32 /* NEED_HYDRATION */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", _hoisted_68, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs')), 1 /* TEXT */), !((_$data$detail$surah_p = $data.detail.surah_progress) !== null && _$data$detail$surah_p !== void 0 && _$data$detail$surah_p.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_69, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_surahs_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_70, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.surah_progress, function (row) {
  ...
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", _hoisted_71, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions')), 1 /* TEXT */), !((_$data$detail$recent_ = $data.detail.recent_sessions) !== null && _$data$detail$recent_ !== void 0 && _$data$detail$recent_.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_72, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_sessions_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_73, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.recent_sessions, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
  ...
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", _hoisted_74, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai')), 1 /* TEXT */), !((_$data$detail$recent_2 = $data.detail.recent_ai_checks) !== null && _$data$detail$recent_2 !== void 0 && _$data$detail$recent_2.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_75, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_ai_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_76, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.recent_ai_checks, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id
  ...
  }), 128 /* KEYED_FRAGMENT */))]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("details", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("summary", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes')), 1 /* TEXT */), !((_$data$detail$recent_3 = $data.detail.recent_notes) !== null && _$data$detail$recent_3 !== void 0 && _$data$detail$recent_3.length) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_78, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.user_notes_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_79, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.detail.recent_notes, function (row) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: row.id,
      "class": "admin-mini--stack"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_80, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.noteLine(row)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-link",
      onClick: function onClick($event) {
        return $options.deleteNote(row);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_81)]), row.snippet ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_82, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(row.snippet), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_user')), 9 /* TEXT, PROPS */, _hoisted_84), $options.isSelfSelected ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_85, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete_self_blocked')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */))], 2 /* CLASS */)], 8 /* PROPS */, _hoisted_15), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.tab === 'users']]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" INBOX "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
    "class": "admin-panel",
    "aria-label": _ctx.t('admin.contacts_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_87, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_title')), 1 /* TEXT */), $options.contactInboxUrl ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 0,
    "class": "admin-link",
    href: $options.contactInboxUrl
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.view_all_contacts')), 9 /* TEXT, PROPS */, _hoisted_88)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $data.inboxLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_89, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : !$data.inboxItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_90, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.contacts_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_91, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.inboxItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id,
      "class": "admin-feed-card"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.subject || _ctx.t('admin.contact_no_subject')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name) + " · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.email), 1 /* TEXT */), item.message ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_92, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.message), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_93, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.created_at)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-btn admin-btn--ghost admin-btn--sm",
      onClick: function onClick($event) {
        return $options.resolveContact(item);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.resolve')), 9 /* TEXT, PROPS */, _hoisted_94), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      type: "button",
      "class": "admin-btn admin-btn--danger admin-btn--sm",
      onClick: function onClick($event) {
        return $options.deleteContact(item);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.delete')), 9 /* TEXT, PROPS */, _hoisted_95)])]);
  }), 128 /* KEYED_FRAGMENT */))]))], 8 /* PROPS */, _hoisted_86), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.tab === 'inbox']]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ACTIVITY "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", {
    "class": "admin-panel",
    "aria-label": _ctx.t('admin.activity_title')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_97, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_98, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.activityFilters, function (filter) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: filter.key,
      type: "button",
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_99);
  }), 128 /* KEYED_FRAGMENT */))])]), $data.activityLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_100, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_loading')), 1 /* TEXT */)) : !$options.filteredActivity.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_101, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.activity_empty')), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_102, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.filteredActivity, function (item, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: item.id || index
      ...
      "class": "admin-type",
      "data-type": item.type
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTypeLabel(item)), 9 /* TEXT, PROPS */, _hoisted_104), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_105, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityTitle(item)), 1 /* TEXT */), $options.activityOutcome(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_106, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.activityOutcome(item)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("time", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative(item.occurred_at)), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_103)]);
  }), 128 /* KEYED_FRAGMENT */))]))], 8 /* PROPS */, _hoisted_96), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.tab === 'activity']])], 64 /* STABLE_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Create modal "), $data.createOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
  ...
  }, null, 8 /* PROPS */, _hoisted_108), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_109, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_110, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.t('admin.drawer_create_title')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "admin-icon-btn",
    "aria-label": _ctx.t('admin.drawer_close'),
    ...
    "class": "bi bi-x-lg",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_111)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
    "class": "admin-form",
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: loc,
      value: loc
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(loc), 9 /* TEXT, PROPS */, _hoisted_112);
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: status,
      value: status
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.subscriptionLabel(status)), 9 /* TEXT, PROPS */, _hoisted_113);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.createForm.subscription_status]])]), $data.createError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_114, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.createError), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_115, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.createSaving ? _ctx.t('admin.saving') : _ctx.t('admin.create_user')), 9 /* TEXT, PROPS */, _hoisted_116)])], 32 /* NEED_HYDRATION */)])], 8 /* PROPS */, _hoisted_107)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 32 /* NEED_HYDRATION */);
}
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Super Admin ops console */\n.admin-console {\n  --ac-bg: #f2ebe3;\n  --ac-sand: #e8ded1;\n  --ac-ink: #3c3530;\n  --ac-muted: #6d6258;\n  --ac-line: rgba(60, 53, 48, 0.14);\n  --ac-soft: #faf6f1;\n  --ac-card: #fffdfb;\n  --ac-accent: #5c6b4a;\n  --ac-danger: #8b4a3c;\n  --ac-shadow: 0 1px 2px rgba(60, 53, 48, 0.05), 0 8px 20px rgba(60, 53, 48, 0.06);\n  --ac-radius: 14px;\n  --ac-font: var(--font-ui, \"Avenir Next\", \"Segoe UI\", sans-serif);\n  --ac-serif: \"Iowan Old Style\", \"Palatino Linotype\", Palatino, Georgia, serif;\n  --ac-ease: cubic-bezier(0.22, 1, 0.36, 1);\n  min-height: calc(100vh - 4.5rem);\n  padding: 0.85rem 0 1.5rem;\n  color: var(--ac-ink);\n  font-family: var(--ac-font);\n  font-size: 0.9rem;\n  background:\n    radial-gradient(70% 35% at 90% 0%, color-mix(in srgb, var(--ac-accent) 10%, transparent), transparent 60%),\n    var(--ac-bg);\n}\n\nhtml[data-theme=\"dark\"] .admin-console {\n  --ac-bg: #171411;\n  --ac-sand: #2a241f;\n  --ac-ink: #f0e7dc;\n  --ac-muted: #b7a99a;\n  --ac-line: rgba(240, 231, 220, 0.12);\n  --ac-soft: #1e1a16;\n  --ac-card: #221e1a;\n  --ac-accent: #8fa37a;\n  --ac-danger: #e0a090;\n  --ac-shadow: 0 1px 2px rgba(0, 0, 0, 0.3), 0 10px 24px rgba(0, 0, 0, 0.25);\n}\n\n.admin-console__shell {\n  width: 100%;\n  max-width: 1280px;\n  margin-inline: auto;\n  padding-inline: clamp(0.85rem, 2.5vw, 1.25rem);\n  display: grid;\n  gap: 0.75rem;\n}\n\n.admin-console__state {\n  display: grid;\n  place-items: center;\n  gap: 0.55rem;\n  min-height: 12rem;\n  padding: 1.5rem;\n  border: 1px solid var(--ac-line);\n  border-radius: var(--ac-radius);\n  background: var(--ac-card);\n  color: var(--ac-muted);\n  text-align: center;\n}\n\n.admin-console__state--error { color: var(--ac-danger); }\n\n.admin-spinner {\n  width: 1.15rem;\n  height: 1.15rem;\n  border-radius: 50%;\n  border: 2px solid color-mix(in srgb, var(--ac-sand) 80%, transparent);\n  border-top-color: var(--ac-ink);\n  animation: admin-spin 0.7s linear infinite;\n}\n\n.is-spinning { display: inline-block; animation: admin-spin 0.8s linear infinite; }\n\n@keyframes admin-spin { to { transform: rotate(360deg); } }\n\n.admin-console__top {\n  display: grid;\n  gap: 0.75rem;\n  padding: 0.9rem 1rem;\n  border: 1px solid var(--ac-line);\n  border-radius: var(--ac-radius);\n  background: linear-gradient(150deg, color-mix(in srgb, var(--ac-accent) 12%, var(--ac-card)), var(--ac-card) 55%);\n  box-shadow: var(--ac-shadow);\n}\n\n@media (min-width: 900px) {\n  .admin-console__top {\n    grid-template-columns: minmax(10rem, 0.9fr) minmax(0, 2fr) auto;\n    align-items: center;\n  }\n}\n\n.admin-console__eyebrow {\n  display: block;\n  font-size: 0.68rem;\n  font-weight: 650;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: var(--ac-accent);\n}\n\n.admin-console__brand h1 {\n  margin: 0.2rem 0 0;\n  font-family: var(--ac-serif);\n  font-size: clamp(1.25rem, 2.4vw, 1.55rem);\n  font-weight: 500;\n  letter-spacing: -0.02em;\n}\n\n.admin-console__top-actions {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.4rem;\n  justify-self: start;\n}\n\n@media (min-width: 900px) {\n  .admin-console__top-actions { justify-self: end; }\n}\n\n.admin-kpis {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 0.4rem;\n}\n\n@media (min-width: 640px) {\n  .admin-kpis { grid-template-columns: repeat(5, minmax(0, 1fr)); }\n}\n\n.admin-kpi {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n  background: var(--ac-soft);\n  padding: 0.55rem 0.6rem;\n  text-align: left;\n  cursor: pointer;\n  color: inherit;\n  font: inherit;\n  display: grid;\n  gap: 0.1rem;\n}\n\n.admin-kpi:hover,\n.admin-kpi:focus-visible {\n  border-color: color-mix(in srgb, var(--ac-accent) 45%, var(--ac-line));\n  background: var(--ac-card);\n}\n\n.admin-kpi strong {\n  font-size: 1.1rem;\n  font-variant-numeric: tabular-nums;\n  line-height: 1.1;\n}\n\n.admin-kpi span {\n  color: var(--ac-muted);\n  font-size: 0.68rem;\n  font-weight: 500;\n}\n\n.admin-tabs {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.3rem;\n  padding: 0.25rem;\n  border: 1px solid var(--ac-line);\n  border-radius: 999px;\n  background: var(--ac-soft);\n  width: -moz-fit-content;\n  width: fit-content;\n  max-width: 100%;\n}\n\n.admin-tabs__btn {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 0;\n  background: transparent;\n  color: var(--ac-muted);\n  border-radius: 999px;\n  padding: 0.4rem 0.85rem;\n  font: inherit;\n  font-size: 0.8rem;\n  font-weight: 550;\n  cursor: pointer;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n\n.admin-tabs__btn em {\n  font-style: normal;\n  font-size: 0.7rem;\n  padding: 0.05rem 0.4rem;\n  border-radius: 999px;\n  background: color-mix(in srgb, var(--ac-accent) 16%, var(--ac-card));\n  color: var(--ac-ink);\n}\n\n.admin-tabs__btn.is-active {\n  background: var(--ac-card);\n  color: var(--ac-ink);\n  box-shadow: var(--ac-shadow);\n}\n\n.admin-workspace {\n  display: grid;\n  gap: 0.75rem;\n  min-height: min(70vh, 44rem);\n}\n\n@media (min-width: 960px) {\n  .admin-workspace {\n    grid-template-columns: minmax(0, 1.05fr) minmax(0, 0.95fr);\n    align-items: stretch;\n  }\n}\n\n.admin-list-pane,\n.admin-detail-pane,\n.admin-panel {\n  border: 1px solid var(--ac-line);\n  border-radius: var(--ac-radius);\n  background: var(--ac-card);\n  box-shadow: var(--ac-shadow);\n  padding: 0.85rem;\n  min-width: 0;\n}\n\n.admin-list-pane {\n  display: grid;\n  grid-template-rows: auto auto auto 1fr;\n  gap: 0.55rem;\n  min-height: 22rem;\n}\n\n.admin-toolbar {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.4rem;\n}\n\n.admin-toolbar__search,\n.admin-toolbar__select,\n.admin-form input,\n.admin-form select {\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n  background: var(--ac-soft);\n  color: var(--ac-ink);\n  font: inherit;\n  font-size: 0.84rem;\n  padding: 0.45rem 0.65rem;\n}\n\n.admin-toolbar__search { flex: 1 1 10rem; min-width: 0; }\n.admin-toolbar__select { flex: 0 1 auto; max-width: 100%; }\n\n.admin-bulkbar {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 0.45rem;\n  padding: 0.55rem 0.65rem;\n  border-radius: 10px;\n  border: 1px solid color-mix(in srgb, var(--ac-accent) 35%, var(--ac-line));\n  background: color-mix(in srgb, var(--ac-accent) 10%, var(--ac-soft));\n  font-size: 0.8rem;\n}\n\n.admin-table-meta {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  gap: 0.75rem;\n  color: var(--ac-muted);\n  font-size: 0.76rem;\n}\n\n.admin-check {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n  cursor: pointer;\n}\n\n.admin-table-wrap {\n  overflow: auto;\n  min-height: 0;\n  max-height: min(58vh, 36rem);\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n}\n\n.admin-table {\n  width: 100%;\n  border-collapse: collapse;\n  min-width: 640px;\n}\n\n.admin-table th,\n.admin-table td {\n  padding: 0.55rem 0.5rem;\n  border-bottom: 1px solid var(--ac-line);\n  text-align: left;\n  vertical-align: top;\n}\n\n.admin-table th {\n  position: sticky;\n  top: 0;\n  z-index: 1;\n  background: var(--ac-soft);\n  color: var(--ac-muted);\n  font-size: 0.66rem;\n  font-weight: 650;\n  letter-spacing: 0.04em;\n  text-transform: uppercase;\n}\n\n.admin-table tbody tr {\n  cursor: pointer;\n}\n\n.admin-table tbody tr:hover,\n.admin-table tbody tr.is-selected {\n  background: color-mix(in srgb, var(--ac-accent) 8%, var(--ac-soft));\n}\n\n.admin-table__check { width: 2rem; }\n.admin-table__who { display: grid; gap: 0.1rem; }\n.admin-table__who strong { font-size: 0.86rem; font-weight: 550; }\n.admin-table__who span { color: var(--ac-muted); font-size: 0.72rem; word-break: break-word; }\n.admin-num { font-variant-numeric: tabular-nums; white-space: nowrap; font-size: 0.8rem; }\n\n.admin-pill {\n  display: inline-flex;\n  padding: 0.14rem 0.42rem;\n  border-radius: 999px;\n  border: 1px solid var(--ac-line);\n  background: var(--ac-soft);\n  color: var(--ac-muted);\n  font-size: 0.68rem;\n  font-weight: 550;\n}\n\n.admin-detail-pane {\n  display: none;\n  overflow: auto;\n  max-height: min(70vh, 44rem);\n}\n\n@media (min-width: 960px) {\n  .admin-detail-pane { display: block; }\n}\n\n.admin-detail-pane.is-open {\n  display: block;\n  position: fixed;\n  inset: 0;\n  z-index: 70;\n  max-height: none;\n  border-radius: 0;\n  padding: 1rem;\n}\n\n@media (min-width: 960px) {\n  .admin-detail-pane.is-open {\n    position: static;\n    border-radius: var(--ac-radius);\n    padding: 0.85rem;\n  }\n  .admin-detail__back { display: none; }\n}\n\n.admin-detail-empty {\n  display: grid;\n  place-items: center;\n  min-height: 14rem;\n  color: var(--ac-muted);\n  text-align: center;\n}\n\n.admin-detail__head {\n  display: grid;\n  gap: 0.35rem;\n  margin-bottom: 0.75rem;\n}\n\n.admin-detail__head h2 {\n  margin: 0;\n  font-family: var(--ac-serif);\n  font-size: 1.2rem;\n  font-weight: 500;\n}\n\n.admin-detail__head p {\n  margin: 0;\n  color: var(--ac-muted);\n  font-size: 0.82rem;\n  word-break: break-word;\n}\n\n.admin-detail__body { display: grid; gap: 0.85rem; }\n\n.admin-statstrip {\n  display: grid;\n  grid-template-columns: repeat(3, minmax(0, 1fr));\n  gap: 0.4rem;\n}\n\n.admin-statstrip > div {\n  padding: 0.5rem 0.55rem;\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n  background: var(--ac-soft);\n  display: grid;\n  gap: 0.1rem;\n}\n\n.admin-statstrip strong {\n  font-size: 0.98rem;\n  font-variant-numeric: tabular-nums;\n}\n\n.admin-statstrip span {\n  color: var(--ac-muted);\n  font-size: 0.66rem;\n  font-weight: 550;\n}\n\n.admin-detail__position {\n  margin: 0;\n  color: var(--ac-muted);\n  font-size: 0.82rem;\n}\n\n.admin-form { display: grid; gap: 0.65rem; }\n.admin-form__grid {\n  display: grid;\n  gap: 0.55rem;\n}\n\n@media (min-width: 520px) {\n  .admin-form__grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }\n  .admin-form__full { grid-column: 1 / -1; }\n}\n\n.admin-form label { display: grid; gap: 0.25rem; }\n.admin-form label > span {\n  color: var(--ac-muted);\n  font-size: 0.7rem;\n  font-weight: 650;\n}\n\n.admin-form__actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.4rem;\n}\n\n.admin-form__error { margin: 0; color: var(--ac-danger); font-size: 0.8rem; }\n.admin-form__ok { margin: 0; color: var(--ac-accent); font-size: 0.8rem; }\n\n.admin-block {\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n  background: var(--ac-soft);\n  padding: 0.55rem 0.7rem;\n}\n\n.admin-block summary {\n  cursor: pointer;\n  font-size: 0.72rem;\n  font-weight: 650;\n  letter-spacing: 0.04em;\n  text-transform: uppercase;\n  color: var(--ac-muted);\n}\n\n.admin-mini {\n  list-style: none;\n  margin: 0.5rem 0 0;\n  padding: 0;\n  display: grid;\n  gap: 0.35rem;\n}\n\n.admin-mini > li,\n.admin-mini__row {\n  display: flex;\n  justify-content: space-between;\n  gap: 0.55rem;\n  font-size: 0.78rem;\n}\n\n.admin-mini--stack { flex-direction: column; }\n.admin-muted { color: var(--ac-muted); font-size: 0.78rem; margin: 0.35rem 0 0; }\n\n.admin-danger {\n  padding: 0.75rem;\n  border-radius: 10px;\n  border: 1px solid color-mix(in srgb, var(--ac-danger) 35%, var(--ac-line));\n  background: color-mix(in srgb, var(--ac-danger) 8%, var(--ac-soft));\n}\n\n.admin-danger h3 {\n  margin: 0 0 0.3rem;\n  font-size: 0.76rem;\n  color: var(--ac-danger);\n}\n\n.admin-danger p { margin: 0 0 0.55rem; color: var(--ac-muted); font-size: 0.78rem; }\n\n.admin-panel__head {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.55rem;\n  margin-bottom: 0.7rem;\n}\n\n.admin-panel__head h2 {\n  margin: 0;\n  font-family: var(--ac-serif);\n  font-size: 1.15rem;\n  font-weight: 500;\n}\n\n.admin-feed-list {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  display: grid;\n  gap: 0.45rem;\n}\n\n.admin-feed-card {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  gap: 0.65rem;\n  padding: 0.75rem 0.8rem;\n  border: 1px solid var(--ac-line);\n  border-radius: 10px;\n  background: var(--ac-soft);\n}\n\n.admin-feed-card strong { display: block; font-size: 0.9rem; }\n.admin-feed-card p { margin: 0.2rem 0 0; font-size: 0.8rem; color: var(--ac-muted); }\n.admin-feed-card__actions {\n  display: inline-flex;\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 0.35rem;\n}\n\n.admin-feed-card--button {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  width: 100%;\n  border: 1px solid var(--ac-line);\n  background: var(--ac-soft);\n  color: inherit;\n  font: inherit;\n  text-align: left;\n  cursor: pointer;\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr) auto;\n  align-items: start;\n  gap: 0.55rem;\n}\n\n.admin-feed-card--button:hover:not(:disabled) {\n  border-color: color-mix(in srgb, var(--ac-accent) 40%, var(--ac-line));\n  background: var(--ac-card);\n}\n\n.admin-feed-card__main { display: grid; gap: 0.15rem; min-width: 0; }\n\n.admin-type {\n  display: inline-flex;\n  align-items: center;\n  padding: 0.14rem 0.4rem;\n  border-radius: 999px;\n  border: 1px solid var(--ac-line);\n  background: var(--ac-card);\n  color: var(--ac-muted);\n  font-size: 0.62rem;\n  font-weight: 650;\n  text-transform: uppercase;\n  white-space: nowrap;\n}\n\n.admin-type[data-type=\"session\"] { color: var(--ac-accent); }\n.admin-type[data-type=\"ai_check\"] { color: var(--ac-danger); }\n\n.admin-filters { display: flex; flex-wrap: wrap; gap: 0.3rem; }\n\n.admin-empty {\n  margin: 0;\n  padding: 1.4rem 0.5rem;\n  text-align: center;\n  color: var(--ac-muted);\n  font-size: 0.84rem;\n}\n\n.admin-btn,\n.admin-icon-btn {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 1px solid var(--ac-line);\n  background: var(--ac-soft);\n  color: var(--ac-ink);\n  border-radius: 999px;\n  font: inherit;\n  cursor: pointer;\n  transition: background 140ms var(--ac-ease), border-color 140ms var(--ac-ease);\n}\n\n.admin-btn {\n  min-height: 2rem;\n  padding: 0.35rem 0.8rem;\n  font-size: 0.78rem;\n  font-weight: 550;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.3rem;\n}\n\n.admin-btn--sm { min-height: 1.75rem; padding: 0.25rem 0.65rem; font-size: 0.74rem; }\n.admin-btn--ghost { background: transparent; }\n.admin-btn--primary {\n  background: var(--ac-accent);\n  border-color: color-mix(in srgb, var(--ac-accent) 70%, var(--ac-ink));\n  color: #fffdf8;\n}\n.admin-btn--danger {\n  background: transparent;\n  border-color: color-mix(in srgb, var(--ac-danger) 45%, var(--ac-line));\n  color: var(--ac-danger);\n}\n.admin-btn.is-active {\n  background: var(--ac-card);\n  box-shadow: var(--ac-shadow);\n}\n\n.admin-icon-btn {\n  width: 2.2rem;\n  height: 2.2rem;\n  display: inline-grid;\n  place-items: center;\n}\n\n.admin-btn:disabled,\n.admin-icon-btn:disabled { opacity: 0.55; cursor: not-allowed; }\n\n.admin-link {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  border: 0;\n  background: transparent;\n  color: var(--ac-muted);\n  font: inherit;\n  font-size: 0.78rem;\n  font-weight: 550;\n  cursor: pointer;\n  text-decoration: none;\n}\n\n.admin-link:hover { color: var(--ac-ink); text-decoration: underline; }\n\n.admin-modal-root {\n  position: fixed;\n  inset: 0;\n  z-index: 90;\n  display: grid;\n  place-items: center;\n  padding: 1rem;\n}\n\n.admin-modal__backdrop {\n  position: absolute;\n  inset: 0;\n  border: 0;\n  background: rgba(30, 24, 18, 0.45);\n  cursor: pointer;\n}\n\nhtml[data-theme=\"dark\"] .admin-modal__backdrop { background: rgba(0, 0, 0, 0.55); }\n\n.admin-modal {\n  position: relative;\n  z-index: 1;\n  width: min(28rem, 100%);\n  max-height: min(90vh, 40rem);\n  overflow: auto;\n  border: 1px solid var(--ac-line);\n  border-radius: var(--ac-radius);\n  background: var(--ac-card);\n  box-shadow: var(--ac-shadow);\n  padding: 1rem;\n  display: grid;\n  gap: 0.85rem;\n}\n\n.admin-modal__head {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.75rem;\n}\n\n.admin-modal__head h2 {\n  margin: 0;\n  font-family: var(--ac-serif);\n  font-size: 1.15rem;\n  font-weight: 500;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .admin-spinner,\n  .is-spinning,\n  .admin-btn,\n  .admin-icon-btn {\n    animation: none !important;\n    transition: none !important;\n  }\n}\n", ""]);
// Exports
