          ...
          tooltip: {
            ...
            callbacks: {
              title: function title(items) {
                var _points, _items$0$dataIndex, _items$;
                return ((_points = points[(_items$0$dataIndex = items === null || items === void 0 || (_items$ = items[0]) === null || _items$ === void 0 ? void 0 : _items$.dataIndex) !== null && _items$0$dataIndex !== void 0 ? _items$0$dataIndex : 0]) === null || _points === void 0 ? void 0 : _points.date) || '';
              }
            }
          }
        },
  ...
  mounted: function mounted() {
    ...
    this.visibilityHandler = function () {
      if (document.visibilityState === 'visible') {
        _this3.fetchDashboard(_this3.chartDays, {
          quiet: true
        });
      }
    };
    this.focusHandler = function () {
      return _this3.fetchDashboard(_this3.chartDays, {
        quiet: true
      });
    };
    this.escapeHandler = function (event) {
      if (event.key === 'Escape' && _this3.drawerOpen) _this3.closeDrawer();
    };
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              return _context.a(2);
            case 1:
              _this4.drawerMode = mode;
              _this4.drawerItems = [];
              _this4.drawerError = false;
              _this4.drawerLoading = true;
              requestId = ++_this4.drawerRequestId;
              _context.p = 2;
              items = [];
              if (!(mode === 'sessions')) {
                _context.n = 4;
            ...
            case 9:
              progress = _context.v;
              items = _this4.groupHifzProgress(progress);
            case 10:
              if (!(requestId !== _this4.drawerRequestId)) {
                _context.n = 11;
                break;
              }
              return _context.a(2);
            case 11:
              _this4.drawerItems = Array.isArray(items) ? items : [];
              _context.n = 14;
              break;
            case 12:
              _context.p = 12;
              ...
              return _context.a(2);
            case 13:
              _this4.drawerError = true;
              _this4.drawerItems = [];
            case 14:
              _context.p = 14;
              if (requestId === _this4.drawerRequestId) _this4.drawerLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              days = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this5.chartDays;
            ...
            case 3:
              ...
              _this5.error = false;
              _this5.lastSyncedAt = (sanitized === null || sanitized === void 0 || (_sanitized$meta = sanitized.meta) === null || _sanitized$meta === void 0 ? void 0 : _sanitized$meta.generated_at) || new Date().toISOString();
              _this5.syncState = 'ready';
              if ((sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30) {
                _this5.chartDays = sanitized.chart.days;
              }
            ...
            case 4:
              ...
              if (initial || force || !_this5.data) {
                _this5.error = true;
                _this5.data = null;
              }
              _this5.syncState = 'error';
            case 5:
              _context2.p = 5;
