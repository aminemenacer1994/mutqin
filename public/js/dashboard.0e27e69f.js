  ...
  mounted: function mounted() {
    ...
    if (typeof MutationObserver !== 'undefined' && typeof document !== 'undefined') {
      this.themeObserver = new MutationObserver(function () {
        _this4.syncTheme();
        _this4.chartReady = false;
        _this4.$nextTick(function () {
          _this4.chartReady = true;
        });
      });
    ...
    this.visibilityHandler = function () {
      if (document.visibilityState === 'visible') {
        _this4.fetchDashboard(_this4.chartDays, {
          quiet: true
        });
      }
    };
    this.focusHandler = function () {
      return _this4.fetchDashboard(_this4.chartDays, {
        quiet: true
      });
    };
    this.escapeHandler = function (event) {
      if (event.key === 'Escape' && _this4.drawerOpen) _this4.closeDrawer();
    };
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              return _context.a(2);
            case 1:
              _this5.drawerMode = mode;
              _this5.drawerItems = [];
              _this5.drawerError = false;
              _this5.drawerLoading = true;
              requestId = ++_this5.drawerRequestId;
              _context.p = 2;
              items = [];
              if (!(mode === 'activity')) {
                _context.n = 4;
            ...
            case 11:
              progress = _context.v;
              items = _this5.groupHifzProgress(progress);
            case 12:
              if (!(requestId !== _this5.drawerRequestId)) {
                _context.n = 13;
                break;
              }
              return _context.a(2);
            case 13:
              _this5.drawerItems = Array.isArray(items) ? items : [];
              _context.n = 16;
              break;
            case 14:
              _context.p = 14;
              ...
              return _context.a(2);
            case 15:
              _this5.drawerError = true;
              _this5.drawerItems = [];
            case 16:
              _context.p = 16;
              if (requestId === _this5.drawerRequestId) _this5.drawerLoading = false;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              days = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this6.chartDays;
              ...
              requestId = ++_this6.dashboardRequestId;
              if (!quiet) {
                _this6.loading = true;
                _this6.syncState = 'loading';
              }
              _context2.p = 1;
              _context2.n = 2;
            ...
            case 2:
              payload = _context2.v;
              if (!(requestId !== _this6.dashboardRequestId)) {
                _context2.n = 3;
                break;
              }
            ...
            case 4:
              _this6.data = sanitized;
              _this6.error = false;
              _this6.lastSyncedAt = (sanitized === null || sanitized === void 0 || (_sanitized$meta = sanitized.meta) === null || _sanitized$meta === void 0 ? void 0 : _sanitized$meta.generated_at) || new Date().toISOString();
              _this6.syncState = 'ready';
              if ((sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30) {
                _this6.chartDays = sanitized.chart.days;
              } else {
                _this6.chartDays = safeDays;
              }
              // Remount Chart.js so labels/datasets fully refresh for the new range.
              _this6.chartReady = false;
              _context2.n = 5;
              return _this6.$nextTick();
            case 5:
              if (requestId === _this6.dashboardRequestId) {
                _this6.chartReady = true;
              }
              _context2.n = 8;
              break;
            case 6:
              ...
              return _context2.a(2);
            case 7:
              if (initial || force || !_this6.data) {
                _this6.error = true;
                _this6.data = null;
              }
              _this6.syncState = 'error';
              _this6.chartReady = true;
            case 8:
              _context2.p = 8;
              if (requestId === _this6.dashboardRequestId) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.activityFilters, function (filter) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: filter.key,
      type: "button",
      role: "tab",
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-drawer__filter", {
        'is-active': _ctx.activityFilter === filter.key
      }]),
      "aria-selected": _ctx.activityFilter === filter.key ? 'true' : 'false',
      onClick: function onClick($event) {
        return _ctx.activityFilter = filter.key;
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(filter.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_96);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_95)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.drawerLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_97, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.drawer_loading')), 1 /* TEXT */)) : $data.drawerError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_98, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.drawer_load_error')), 1 /* TEXT */)) : !_ctx.visibleDrawerItems.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_99, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.drawerEmptyMessage), 1 /* TEXT */)) : $data.drawerMode === 'activity' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_100, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
  ...
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'sessions' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_107, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
  ...
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'ai_checks' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_112, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
  ...
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'notes' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_117, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.visibleDrawerItems, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
  ...
  }), 128 /* KEYED_FRAGMENT */))])) : $data.drawerMode === 'hifz' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_122, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.visibleDrawerItems, function (group) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
