...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return {
      ...
      returnCountdownTotal: 12,
      returnCountdownTimer: null,
      returnCountdownDismissed: false,
  ...
  computed: {
    ...
    returnCountdownActive: function returnCountdownActive() {
      return !!this.liveReturnSession && this.returnCountdownSeconds > 0 && !this.returnCountdownDismissed;
    },
    returnCountdownProgress: function returnCountdownProgress() {
      if (!this.returnCountdownTotal) return '0';
      var done = this.returnCountdownTotal - this.returnCountdownSeconds;
      return String(Math.max(0, Math.min(1, done / this.returnCountdownTotal)));
    },
  ...
  mounted: function mounted() {
    ...
    if (!this.data) {
      ...
      this.maybeStartReturnCountdown();
    }
    ...
    this.focusHandler = function () {
      return _this5.fetchDashboard(_this5.chartDays, {
        quiet: true
      });
    };
  ...
  beforeUnmount: function beforeUnmount() {
    this.clearReturnCountdownTimer();
  ...
  methods: {
    ...
    clearReturnCountdownTimer: function clearReturnCountdownTimer() {
      if (this.returnCountdownTimer) {
        window.clearInterval(this.returnCountdownTimer);
        this.returnCountdownTimer = null;
      }
    },
    maybeStartReturnCountdown: function maybeStartReturnCountdown() {
      var _this6 = this;
      if (this.returnCountdownDismissed || this.reduceMotion || !this.liveReturnSession) {
        if (!this.liveReturnSession) {
          this.clearReturnCountdownTimer();
          this.returnCountdownSeconds = 0;
        }
        return;
      }
      if (this.returnCountdownTimer || this.returnCountdownSeconds > 0) return;
      this.returnCountdownSeconds = this.returnCountdownTotal;
      this.returnCountdownTimer = window.setInterval(function () {
        if (_this6.returnCountdownSeconds <= 1) {
          _this6.clearReturnCountdownTimer();
          _this6.returnCountdownSeconds = 0;
          _this6.goToLiveSession();
          return;
        }
        _this6.returnCountdownSeconds -= 1;
      }, 1000);
    },
    cancelReturnCountdown: function cancelReturnCountdown() {
      this.returnCountdownDismissed = true;
      this.clearReturnCountdownTimer();
      this.returnCountdownSeconds = 0;
    },
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              return _context.a(2);
            case 1:
              _this7.drawerMode = mode;
              _this7.drawerItems = [];
              _this7.drawerError = false;
              _this7.drawerLoading = true;
              _this7.activityFilter = 'all';
              requestId = ++_this7.drawerRequestId;
              _context.p = 2;
              items = [];
              if (!(mode === 'activity')) {
                _context.n = 4;
            ...
            case 11:
              progress = _context.v;
              items = _this7.groupHifzProgress(progress);
            case 12:
              if (!(requestId !== _this7.drawerRequestId)) {
                _context.n = 13;
                break;
              }
              return _context.a(2);
            case 13:
              _this7.drawerItems = Array.isArray(items) ? items : [];
              _context.n = 16;
              break;
            case 14:
              _context.p = 14;
              ...
              return _context.a(2);
            case 15:
              _this7.drawerError = true;
              _this7.drawerItems = [];
            case 16:
              _context.p = 16;
              if (requestId === _this7.drawerRequestId) _this7.drawerLoading = false;
    ...
    fetchDashboard: function fetchDashboard() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var days, options, _options$quiet, quiet, _options$initial, initial, _options$force, force, safeDays, requestId, _sanitized$meta, _sanitized$chart, _sanitized$chart2, payload, sanitized, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              days = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this8.chartDays;
              ...
              requestId = ++_this8.dashboardRequestId;
              if (!quiet) {
                _this8.loading = true;
                _this8.syncState = 'loading';
              }
              _context2.p = 1;
              _context2.n = 2;
            ...
            case 2:
              payload = _context2.v;
              if (!(requestId !== _this8.dashboardRequestId)) {
                _context2.n = 3;
                break;
              }
            ...
            case 4:
              _this8.data = sanitized;
              _this8.error = false;
              _this8.lastSyncedAt = (sanitized === null || sanitized === void 0 || (_sanitized$meta = sanitized.meta) === null || _sanitized$meta === void 0 ? void 0 : _sanitized$meta.generated_at) || new Date().toISOString();
              _this8.syncState = 'ready';
              if ((sanitized === null || sanitized === void 0 || (_sanitized$chart = sanitized.chart) === null || _sanitized$chart === void 0 ? void 0 : _sanitized$chart.days) === 7 || (sanitized === null || sanitized === void 0 || (_sanitized$chart2 = sanitized.chart) === null || _sanitized$chart2 === void 0 ? void 0 : _sanitized$chart2.days) === 30) {
                _this8.chartDays = sanitized.chart.days;
              } else {
                _this8.chartDays = safeDays;
              }
              // Remount Chart.js so labels/datasets fully refresh for the new range.
              _this8.chartReady = false;
              _context2.n = 5;
              return _this8.$nextTick();
            case 5:
              if (requestId === _this8.dashboardRequestId) {
                _this8.chartReady = true;
                _this8.refreshActiveSessionSnapshot();
                _this8.maybeStartReturnCountdown();
              }
              _context2.n = 8;
              break;
            case 6:
              ...
              return _context2.a(2);
            case 7:
              if (initial || force || !_this8.data) {
                _this8.error = true;
                _this8.data = null;
              }
              _this8.syncState = 'error';
              _this8.chartReady = true;
            case 8:
              _context2.p = 8;
              if (requestId === _this8.dashboardRequestId) {
...
var _hoisted_21 = {
  key: 0,
  "class": "dash-return-session__timer",
  "aria-live": "polite"
};
var _hoisted_22 = {
  key: 1,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [$data.loading && !$data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [_cache[9] || (_cache[9] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.retry')), 1 /* TEXT */)])) : $data.data ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 2
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("header", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.next_step')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.greetingText), 1 /* TEXT */), _cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "dash-rule",
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), $options.retentionChips.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_10, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.retentionChips, function (chip) {
    ...
    key: 0,
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["dash-return-session", {
      'is-counting': $options.returnCountdownActive
    }]),
    role: "region",
    "aria-label": $options.t('dashboard.return_session_aria')
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_15, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_label')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.liveReturnSession.surah_name || $options.t('dashboard.start_session')), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [$options.ayahRangeLabel($options.liveReturnSession) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.current_range')) + ": " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.ayahRangeLabel($options.liveReturnSession)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.liveReturnSession.last_ayah ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.last_ayah', {
    n: $options.liveReturnSession.last_ayah
  })), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.liveReturnSession.last_activity_at ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.formatRelative($options.liveReturnSession.last_activity_at)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $options.returnCountdownActive ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_countdown', {
    n: $data.returnCountdownSeconds
  })), 1 /* TEXT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_hint')), 1 /* TEXT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [$options.returnCountdownActive ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    "class": "dash-return-session__ring",
    style: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeStyle)({
      '--dash-return-progress': $options.returnCountdownProgress
    }),
    "aria-hidden": "true"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.returnCountdownSeconds), 1 /* TEXT */)], 4 /* STYLE */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    "aria-hidden": "true"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_now')), 1 /* TEXT */)]), $options.returnCountdownActive ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 1,
    type: "button",
    "class": "dash-btn dash-btn--ghost dash-return-session__stay",
    onClick: _cache[3] || (_cache[3] = function () {
      return $options.cancelReturnCountdown && $options.cancelReturnCountdown.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.t('dashboard.return_session_stay')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 10 /* CLASS, PROPS */, _hoisted_13)) : $data.data["continue"] ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
    key: 1,
    "class": "dash-continue",
  ...
  }), 128 /* KEYED_FRAGMENT */))]))])])], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $options.drawerOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
