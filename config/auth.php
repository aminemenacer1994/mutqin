...
return [
    ...
    */
    ...
    | Set AUTH_REQUIRE_EMAIL_VERIFICATION=true to require the verification gate.
    |
    */

    'require_email_verification' => filter_var(env('AUTH_REQUIRE_EMAIL_VERIFICATION', false), FILTER_VALIDATE_BOOL),
