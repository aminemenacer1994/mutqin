...

{
  ...
  assert.match(amdVue, /tajweed:\s*\{\s*type:\s*Boolean,\s*default:\s*true\s*\}/)
  assert.match(amdCss, /\.amd-mushaf-ayah\.tajweed-enabled/)
  assert.match(source, /amdTajweedEnabled:\s*true/)
  assert.match(source, /this\.amdTajweedEnabled\s*=\s*true/)
