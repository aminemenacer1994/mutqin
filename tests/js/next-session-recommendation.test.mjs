...

{
  ...
  assert.match(vue, /practiceSetup|Practice setup/)
  ...
  assert.match(js, /correctSimilarity\s*=\s*0\.74/)
  assert.match(js, /partialSimilarity\s*=\s*0\.40/)
  ...
  assert.match(vue, /post-session-simple__flow-guide/)
