...

{
  ...
  assert.match(vue, /postSessionAiResultLine/)
  assert.match(vue, /ai-hint--result/)
  ...
  assert.match(vue, /whyThisPlanToggle/)
  assert.match(vue, /post-session-simple__why-toggle/)
  assert.match(vue, /postSessionWhyExpanded/)
  ...
  assert.match(css, /post-session-simple__why-disclosure/)
